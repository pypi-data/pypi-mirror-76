...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'hcloud', '0.0.4-alpha.1597440635+5d38f315'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource hcloud 0.0.4-alpha.1597440635+5d38f315`
                """)
            else:
                raise
