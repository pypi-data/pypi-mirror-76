...
from mastapy.system_model.part_model.couplings import _2157, _2159
...
class SynchroniserHalf(_2159.SynchroniserPart):
    '''SynchroniserHalf
    ...
    @property
    def cones(self) -> 'List[_2157.SynchroniserCone]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_2157.SynchroniserCone))
        return value
