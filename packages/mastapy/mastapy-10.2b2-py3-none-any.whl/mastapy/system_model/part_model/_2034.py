...
from mastapy.system_model.part_model import _2042, _2040
...
class PowerLoad(_2040.VirtualComponent):
    '''PowerLoad
    ...
    @property
    def single_blade_details(self) -> '_2042.WindTurbineSingleBladeDetails':
        ...
        return constructor.new(_2042.WindTurbineSingleBladeDetails)(self.wrapped.SingleBladeDetails) if self.wrapped.SingleBladeDetails else None

    @property
    def electric_machine_detail(self) -> '_6125.ElectricMachineDetail':
        ...
        return constructor.new(_6125.ElectricMachineDetail)(self.wrapped.ElectricMachineDetail) if self.wrapped.ElectricMachineDetail else None
