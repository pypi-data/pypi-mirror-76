...
from mastapy.system_model.part_model.gears import _2105, _2080
...
class StraightBevelDiffGearSet(_2080.BevelGearSet):
    '''StraightBevelDiffGearSet
    ...
    @property
    def straight_bevel_diff_gears(self) -> 'List[_2105.StraightBevelDiffGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGears, constructor.new(_2105.StraightBevelDiffGear))
        return value
