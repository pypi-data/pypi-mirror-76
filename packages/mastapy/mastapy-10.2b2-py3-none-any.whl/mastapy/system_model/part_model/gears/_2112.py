...
from mastapy.system_model.part_model.gears import _2111, _2092
...
class WormGearSet(_2092.GearSet):
    '''WormGearSet
    ...
    @property
    def worm_gears(self) -> 'List[_2111.WormGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGears, constructor.new(_2111.WormGear))
        return value
