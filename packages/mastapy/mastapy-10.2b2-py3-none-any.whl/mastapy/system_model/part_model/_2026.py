...
class MountableComponent(_2008.Component):
    '''MountableComponent
    ...
    def mount_on(self, shaft: '_2043.Shaft', offset: Optional['float'] = float('nan')) -> '_1852.CoaxialConnection':
        ...
        return constructor.new(_1852.CoaxialConnection)(method_result) if method_result else None
