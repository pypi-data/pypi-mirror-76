...
from mastapy.system_model.imported_fes import _1952
...
class FEComponentWithBatchOptions(_0.APIBase):
    ...
    @property
    def fes(self) -> 'List[_1952.FEWithBatchOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FEs, constructor.new(_1952.FEWithBatchOptions))
        return value

    @property
    def fes_with_external_files(self) -> 'List[_1952.FEWithBatchOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FEsWithExternalFiles, constructor.new(_1952.FEWithBatchOptions))
        return value
