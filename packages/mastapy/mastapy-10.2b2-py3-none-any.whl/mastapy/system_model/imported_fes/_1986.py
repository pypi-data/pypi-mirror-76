...
from mastapy.system_model.imported_fes import _1984, _1932
...
class RaceBearingFEWithSelection(_1932.BaseFEWithSelection):
    ...
    @property
    def race_bearing(self) -> '_1984.RaceBearingFE':
        ...
        return constructor.new(_1984.RaceBearingFE)(self.wrapped.RaceBearing) if self.wrapped.RaceBearing else None
