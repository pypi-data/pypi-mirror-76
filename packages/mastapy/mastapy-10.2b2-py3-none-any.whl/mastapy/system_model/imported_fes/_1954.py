...
from mastapy.system_model.imported_fes import (
    _1934, _1967, _1991, _1928,
    _1930, _1992, _1987, _1966,
    _1926, _1950, _1953, _1973,
    _1972, _1969, _1970, _1971
)
from mastapy._internal.python_net import python_net_import
from mastapy.system_model.part_model import _2012, _2008, _2020
...
class ImportedFE(_1378.FEStiffness):
    ...
    @property
    def alignment_to_component(self) -> '_1827.RelativeComponentAlignment[_2008.Component]':
        ...
        return constructor.new(_1827.RelativeComponentAlignment)[_2008.Component](self.wrapped.AlignmentToComponent) if self.wrapped.AlignmentToComponent else None
    ...
    @property
    def export(self) -> '_1992.UsedForExportingAnImportedFEsSetupOrSubstructuringStepToAnFEFile':
        ...
        return constructor.new(_1992.UsedForExportingAnImportedFEsSetupOrSubstructuringStepToAnFEFile)(self.wrapped.Export) if self.wrapped.Export else None
    ...
    @property
    def shafts_that_can_be_replaced(self) -> 'List[_1987.ReplacedShaftSelectionHelper]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftsThatCanBeReplaced, constructor.new(_1987.ReplacedShaftSelectionHelper))
        return value
    ...
    @property
    def replaced_shafts(self) -> 'List[_2043.Shaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ReplacedShafts, constructor.new(_2043.Shaft))
        return value
    ...
    @property
    def geometries(self) -> 'List[_1950.FEStiffnessGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Geometries, constructor.new(_1950.FEStiffnessGeometry))
        return value

    @property
    def gear_meshing_options(self) -> 'List[_1953.GearMeshingOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshingOptions, constructor.new(_1953.GearMeshingOptions))
        return value

    @property
    def independent_masta_created_condensation_nodes(self) -> 'List[_1973.IndependentMastaCreatedCondensationNode]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.IndependentMastaCreatedCondensationNodes, constructor.new(_1973.IndependentMastaCreatedCondensationNode))
        return value

    @property
    def imported_fe_component(self) -> '_2020.ImportedFEComponent':
        ...
        return constructor.new(_2020.ImportedFEComponent)(self.wrapped.ImportedFEComponent) if self.wrapped.ImportedFEComponent else None
    ...
    def load_existing_masta_fe_file_with_progress(self, file_name: 'str', progress: '_6526.TaskProgress'):
        ''' 'LoadExistingMastaFEFile' is the original name of this method.
    ...
    def create_imported_fe_with_selection_static_analysis(self) -> '_1972.ImportedFEWithSelectionStaticAnalysis':
        ...
        return constructor.new(_1972.ImportedFEWithSelectionStaticAnalysis)(method_result) if method_result else None

    def create_imported_fe_with_selection_components(self) -> '_1969.ImportedFEWithSelectionComponents':
        ...
        return constructor.new(_1969.ImportedFEWithSelectionComponents)(method_result) if method_result else None

    def create_imported_fe_with_selection_for_harmonic_analysis(self) -> '_1970.ImportedFEWithSelectionForHarmonicAnalysis':
        ...
        return constructor.new(_1970.ImportedFEWithSelectionForHarmonicAnalysis)(method_result) if method_result else None

    def create_imported_fe_with_selection_modal_analysis(self) -> '_1971.ImportedFEWithSelectionModalAnalysis':
        ...
        return constructor.new(_1971.ImportedFEWithSelectionModalAnalysis)(method_result) if method_result else None

    def links_for(self, node: '_1966.ImportedFEStiffnessNode') -> 'List[_1926.ImportedFELink]':
