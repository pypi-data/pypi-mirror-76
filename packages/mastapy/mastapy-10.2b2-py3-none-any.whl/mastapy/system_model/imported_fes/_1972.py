...
from mastapy.system_model.imported_fes import _1978, _1968
...
class ImportedFEWithSelectionStaticAnalysis(_1968.ImportedFEWithSelection):
    '''ImportedFEWithSelectionStaticAnalysis
    ...
    @property
    def boundary_conditions_selected_nodes(self) -> 'List[_1978.NodeBoundaryConditionStaticAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoundaryConditionsSelectedNodes, constructor.new(_1978.NodeBoundaryConditionStaticAnalysis))
        return value

    @property
    def boundary_conditions_all_nodes(self) -> 'List[_1978.NodeBoundaryConditionStaticAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoundaryConditionsAllNodes, constructor.new(_1978.NodeBoundaryConditionStaticAnalysis))
        return value
