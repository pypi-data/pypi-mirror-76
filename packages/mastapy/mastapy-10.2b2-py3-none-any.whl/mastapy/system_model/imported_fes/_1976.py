...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _1492
...
class MaterialPropertiesWithSelection(_0.APIBase):
    ...
    @property
    def material_properties(self) -> '_1492.MaterialPropertiesReporting':
        ...
        return constructor.new(_1492.MaterialPropertiesReporting)(self.wrapped.MaterialProperties) if self.wrapped.MaterialProperties else None
