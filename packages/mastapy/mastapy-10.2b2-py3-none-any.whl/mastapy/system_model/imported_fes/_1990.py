...
from mastapy.system_model.imported_fes import _1983, _1982
...
class SystemDeflectionFEExportOptions(_0.APIBase):
    ...
    @property
    def nodes(self) -> 'List[_1983.PerNodeExportOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Nodes, constructor.new(_1983.PerNodeExportOptions))
        return value

    @property
    def links(self) -> 'List[_1982.PerLinkExportOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_1982.PerLinkExportOptions))
        return value
