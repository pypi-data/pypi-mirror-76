...
class IndependentMastaCreatedCondensationNode(_0.APIBase):
    ...
    @property
    def imported_fe_node(self) -> '_1966.ImportedFEStiffnessNode':
        ...
        return constructor.new(_1966.ImportedFEStiffnessNode)(self.wrapped.ImportedFENode) if self.wrapped.ImportedFENode else None
