...
class NodeBoundaryConditionStaticAnalysis(_0.APIBase):
    ...
    @property
    def boundary_conditions_linear(self) -> 'List[_1942.DegreeOfFreedomBoundaryConditionLinear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoundaryConditionsLinear, constructor.new(_1942.DegreeOfFreedomBoundaryConditionLinear))
        return value

    @property
    def boundary_conditions_angular(self) -> 'List[_1941.DegreeOfFreedomBoundaryConditionAngular]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoundaryConditionsAngular, constructor.new(_1941.DegreeOfFreedomBoundaryConditionAngular))
        return value
