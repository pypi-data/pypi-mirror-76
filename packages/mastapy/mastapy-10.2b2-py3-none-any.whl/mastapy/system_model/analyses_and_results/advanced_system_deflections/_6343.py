...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6375, _6378
...
class PowerLoadAdvancedSystemDeflection(_6378.VirtualComponentAdvancedSystemDeflection):
    '''PowerLoadAdvancedSystemDeflection
    ...
    @property
    def transmission_error_to_other_power_loads(self) -> 'List[_6375.TransmissionErrorToOtherPowerLoad]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TransmissionErrorToOtherPowerLoads, constructor.new(_6375.TransmissionErrorToOtherPowerLoad))
        return value

    @property
    def component_system_deflection_results(self) -> 'List[_2321.PowerLoadSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2321.PowerLoadSystemDeflection))
        return value
