...
class WormGearAdvancedSystemDeflection(_6312.GearAdvancedSystemDeflection):
    '''WormGearAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2364.WormGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2364.WormGearSystemDeflection))
        return value
