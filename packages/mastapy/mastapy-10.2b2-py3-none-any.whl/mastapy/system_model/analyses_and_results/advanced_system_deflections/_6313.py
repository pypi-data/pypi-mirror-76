...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6294, _6320
...
class GearMeshAdvancedSystemDeflection(_6320.InterMountableComponentConnectionAdvancedSystemDeflection):
    '''GearMeshAdvancedSystemDeflection
    ...
    @property
    def max_pressure_contact_chart_for_each_tooth_pass_for_gear_a(self) -> 'List[_6294.ContactChartPerToothPass]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MaxPressureContactChartForEachToothPassForGearA, constructor.new(_6294.ContactChartPerToothPass))
        return value
