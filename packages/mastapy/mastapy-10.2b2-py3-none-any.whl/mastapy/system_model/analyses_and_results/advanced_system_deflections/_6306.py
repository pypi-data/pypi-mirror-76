...
class DatumAdvancedSystemDeflection(_6282.ComponentAdvancedSystemDeflection):
    '''DatumAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2282.DatumSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2282.DatumSystemDeflection))
        return value
