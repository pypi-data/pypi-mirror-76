...
class CylindricalMeshedGearAdvancedSystemDeflection(_0.APIBase):
    ...
    @property
    def cylindrical_gear_advanced_system_deflection(self) -> '_6301.CylindricalGearAdvancedSystemDeflection':
        ...
        return constructor.new(_6301.CylindricalGearAdvancedSystemDeflection)(self.wrapped.CylindricalGearAdvancedSystemDeflection) if self.wrapped.CylindricalGearAdvancedSystemDeflection else None

    @property
    def other_cylindrical_gear_advanced_system_deflection(self) -> '_6301.CylindricalGearAdvancedSystemDeflection':
        ...
        return constructor.new(_6301.CylindricalGearAdvancedSystemDeflection)(self.wrapped.OtherCylindricalGearAdvancedSystemDeflection) if self.wrapped.OtherCylindricalGearAdvancedSystemDeflection else None
