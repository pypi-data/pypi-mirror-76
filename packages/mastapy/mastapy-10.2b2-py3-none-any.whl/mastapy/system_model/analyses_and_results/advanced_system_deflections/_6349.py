...
class ShaftAdvancedSystemDeflection(_6257.AbstractShaftOrHousingAdvancedSystemDeflection):
    '''ShaftAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2330.ShaftSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2330.ShaftSystemDeflection))
        return value
