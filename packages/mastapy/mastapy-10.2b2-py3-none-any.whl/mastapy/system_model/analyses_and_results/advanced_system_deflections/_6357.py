...
class SpringDamperConnectionAdvancedSystemDeflection(_6296.CouplingConnectionAdvancedSystemDeflection):
    '''SpringDamperConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_6205.SpringDamperConnectionLoadCase':
        ...
        return constructor.new(_6205.SpringDamperConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def connection_system_deflection_results(self) -> 'List[_2336.SpringDamperConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2336.SpringDamperConnectionSystemDeflection))
        return value
