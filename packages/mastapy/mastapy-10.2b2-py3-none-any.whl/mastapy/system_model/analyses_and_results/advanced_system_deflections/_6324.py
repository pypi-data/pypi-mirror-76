...
class KlingelnbergCycloPalloidHypoidGearAdvancedSystemDeflection(_6321.KlingelnbergCycloPalloidConicalGearAdvancedSystemDeflection):
    '''KlingelnbergCycloPalloidHypoidGearAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_6166.KlingelnbergCycloPalloidHypoidGearLoadCase':
        ...
        return constructor.new(_6166.KlingelnbergCycloPalloidHypoidGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2303.KlingelnbergCycloPalloidHypoidGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2303.KlingelnbergCycloPalloidHypoidGearSystemDeflection))
        return value
