...
class UnbalancedMassAdvancedSystemDeflection(_6378.VirtualComponentAdvancedSystemDeflection):
    '''UnbalancedMassAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2360.UnbalancedMassSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2360.UnbalancedMassSystemDeflection))
        return value
