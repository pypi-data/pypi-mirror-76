...
class PointLoadAdvancedSystemDeflection(_6378.VirtualComponentAdvancedSystemDeflection):
    '''PointLoadAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2320.PointLoadSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2320.PointLoadSystemDeflection))
        return value
