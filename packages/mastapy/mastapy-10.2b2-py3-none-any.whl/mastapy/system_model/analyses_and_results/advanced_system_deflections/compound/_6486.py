...
class StraightBevelGearMeshCompoundAdvancedSystemDeflection(_6400.BevelGearMeshCompoundAdvancedSystemDeflection):
    '''StraightBevelGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_6363.StraightBevelGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_6363.StraightBevelGearMeshAdvancedSystemDeflection))
        return value

    @property
    def connection_advanced_system_deflection_load_cases(self) -> 'List[_6363.StraightBevelGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAdvancedSystemDeflectionLoadCases, constructor.new(_6363.StraightBevelGearMeshAdvancedSystemDeflection))
        return value
