...
class SpiralBevelGearAdvancedSystemDeflection(_6273.BevelGearAdvancedSystemDeflection):
    '''SpiralBevelGearAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_6202.SpiralBevelGearLoadCase':
        ...
        return constructor.new(_6202.SpiralBevelGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2335.SpiralBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2335.SpiralBevelGearSystemDeflection))
        return value
