...
class SpiralBevelGearMeshAdvancedSystemDeflection(_6274.BevelGearMeshAdvancedSystemDeflection):
    '''SpiralBevelGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_6203.SpiralBevelGearMeshLoadCase':
        ...
        return constructor.new(_6203.SpiralBevelGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2333.SpiralBevelGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2333.SpiralBevelGearMeshSystemDeflection))
        return value
