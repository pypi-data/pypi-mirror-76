...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6379, _6380, _6314
...
class WormGearSetAdvancedSystemDeflection(_6314.GearSetAdvancedSystemDeflection):
    '''WormGearSetAdvancedSystemDeflection
    ...
    @property
    def worm_gears_advanced_system_deflection(self) -> 'List[_6379.WormGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsAdvancedSystemDeflection, constructor.new(_6379.WormGearAdvancedSystemDeflection))
        return value

    @property
    def worm_meshes_advanced_system_deflection(self) -> 'List[_6380.WormGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesAdvancedSystemDeflection, constructor.new(_6380.WormGearMeshAdvancedSystemDeflection))
        return value

    @property
    def assembly_system_deflection_results(self) -> 'List[_2363.WormGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2363.WormGearSetSystemDeflection))
        return value
