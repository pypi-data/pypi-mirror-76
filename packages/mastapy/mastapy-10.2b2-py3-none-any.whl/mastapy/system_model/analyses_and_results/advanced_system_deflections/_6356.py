...
class SpringDamperAdvancedSystemDeflection(_6295.CouplingAdvancedSystemDeflection):
    '''SpringDamperAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2338.SpringDamperSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2338.SpringDamperSystemDeflection))
        return value
