...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5887, _5888, _5883
...
class KlingelnbergCycloPalloidSpiralBevelGearSetDynamicAnalysis(_5883.KlingelnbergCycloPalloidConicalGearSetDynamicAnalysis):
    '''KlingelnbergCycloPalloidSpiralBevelGearSetDynamicAnalysis
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_dynamic_analysis(self) -> 'List[_5887.KlingelnbergCycloPalloidSpiralBevelGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidSpiralBevelGearsDynamicAnalysis, constructor.new(_5887.KlingelnbergCycloPalloidSpiralBevelGearDynamicAnalysis))
        return value

    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_dynamic_analysis(self) -> 'List[_5888.KlingelnbergCycloPalloidSpiralBevelGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidSpiralBevelMeshesDynamicAnalysis, constructor.new(_5888.KlingelnbergCycloPalloidSpiralBevelGearMeshDynamicAnalysis))
        return value
