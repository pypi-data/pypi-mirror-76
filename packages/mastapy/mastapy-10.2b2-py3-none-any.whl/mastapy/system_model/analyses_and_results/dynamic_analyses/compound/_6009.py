...
class KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundDynamicAnalysis(_6003.KlingelnbergCycloPalloidConicalGearMeshCompoundDynamicAnalysis):
    '''KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundDynamicAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5888.KlingelnbergCycloPalloidSpiralBevelGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5888.KlingelnbergCycloPalloidSpiralBevelGearMeshDynamicAnalysis))
        return value

    @property
    def connection_dynamic_analysis_load_cases(self) -> 'List[_5888.KlingelnbergCycloPalloidSpiralBevelGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionDynamicAnalysisLoadCases, constructor.new(_5888.KlingelnbergCycloPalloidSpiralBevelGearMeshDynamicAnalysis))
        return value
