...
class ZerolBevelGearMeshCompoundDynamicAnalysis(_5957.BevelGearMeshCompoundDynamicAnalysis):
    '''ZerolBevelGearMeshCompoundDynamicAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5940.ZerolBevelGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5940.ZerolBevelGearMeshDynamicAnalysis))
        return value

    @property
    def connection_dynamic_analysis_load_cases(self) -> 'List[_5940.ZerolBevelGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionDynamicAnalysisLoadCases, constructor.new(_5940.ZerolBevelGearMeshDynamicAnalysis))
        return value
