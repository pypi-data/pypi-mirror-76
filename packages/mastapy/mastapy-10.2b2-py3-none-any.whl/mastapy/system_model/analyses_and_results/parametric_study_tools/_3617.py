...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3616, _3615, _3543
...
class WormGearSetParametricStudyTool(_3543.GearSetParametricStudyTool):
    '''WormGearSetParametricStudyTool
    ...
    @property
    def worm_gears_parametric_study_tool(self) -> 'List[_3616.WormGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsParametricStudyTool, constructor.new(_3616.WormGearParametricStudyTool))
        return value

    @property
    def worm_meshes_parametric_study_tool(self) -> 'List[_3615.WormGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesParametricStudyTool, constructor.new(_3615.WormGearMeshParametricStudyTool))
        return value
