...
from mastapy.system_model.analyses_and_results.static_loads import _6076, _6178
from mastapy.system_model import _1818
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3571, _3572
...
class ParametricStudyToolOptions(_0.APIBase):
    ...
    @property
    def parametric_study_type(self) -> '_6178.ParametricStudyType':
        ...
        return constructor.new(_6178.ParametricStudyType)(value) if value else None

    @parametric_study_type.setter
    def parametric_study_type(self, value: '_6178.ParametricStudyType'):
    ...
    @property
    def step_results(self) -> 'List[_3571.ParametricStudyToolStepResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StepResults, constructor.new(_3571.ParametricStudyToolStepResult))
        return value

    @property
    def study_variables(self) -> 'List[_3572.ParametricStudyVariable]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StudyVariables, constructor.new(_3572.ParametricStudyVariable))
        return value
