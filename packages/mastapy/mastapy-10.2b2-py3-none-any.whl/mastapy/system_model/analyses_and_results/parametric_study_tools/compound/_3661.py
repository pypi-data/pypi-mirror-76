...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _3703
...
class CVTPulleyCompoundParametricStudyTool(_3703.PulleyCompoundParametricStudyTool):
    '''CVTPulleyCompoundParametricStudyTool
