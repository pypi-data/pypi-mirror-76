...
class ConceptCouplingHalfCompoundParametricStudyTool(_3658.CouplingHalfCompoundParametricStudyTool):
    '''ConceptCouplingHalfCompoundParametricStudyTool
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3509.ConceptCouplingHalfParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3509.ConceptCouplingHalfParametricStudyTool))
        return value

    @property
    def component_parametric_study_tool_load_cases(self) -> 'List[_3509.ConceptCouplingHalfParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentParametricStudyToolLoadCases, constructor.new(_3509.ConceptCouplingHalfParametricStudyTool))
        return value
