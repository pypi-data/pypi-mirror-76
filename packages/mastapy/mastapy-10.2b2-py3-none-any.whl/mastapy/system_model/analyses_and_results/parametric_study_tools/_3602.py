...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3601, _3600, _3500
...
class StraightBevelGearSetParametricStudyTool(_3500.BevelGearSetParametricStudyTool):
    '''StraightBevelGearSetParametricStudyTool
    ...
    @property
    def straight_bevel_gears_parametric_study_tool(self) -> 'List[_3601.StraightBevelGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsParametricStudyTool, constructor.new(_3601.StraightBevelGearParametricStudyTool))
        return value

    @property
    def straight_bevel_meshes_parametric_study_tool(self) -> 'List[_3600.StraightBevelGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesParametricStudyTool, constructor.new(_3600.StraightBevelGearMeshParametricStudyTool))
        return value
