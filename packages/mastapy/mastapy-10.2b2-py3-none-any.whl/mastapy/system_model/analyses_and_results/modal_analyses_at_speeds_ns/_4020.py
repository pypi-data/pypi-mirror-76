...
class ConnectionModalAnalysesAtSpeeds(_6512.ConnectionStaticLoadAnalysisCase):
    '''ConnectionModalAnalysesAtSpeeds
    ...
    @property
    def modal_analyses_at_speeds(self) -> '_4087.StabilityAnalysis':
        ...
        return constructor.new(_4087.StabilityAnalysis)(self.wrapped.ModalAnalysesAtSpeeds) if self.wrapped.ModalAnalysesAtSpeeds else None
