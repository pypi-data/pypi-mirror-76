...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _4029, _4028, _4041
...
class CylindricalGearSetModalAnalysesAtSpeeds(_4041.GearSetModalAnalysesAtSpeeds):
    '''CylindricalGearSetModalAnalysesAtSpeeds
    ...
    @property
    def cylindrical_gears_modal_analyses_at_speeds(self) -> 'List[_4029.CylindricalGearModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsModalAnalysesAtSpeeds, constructor.new(_4029.CylindricalGearModalAnalysesAtSpeeds))
        return value

    @property
    def cylindrical_meshes_modal_analyses_at_speeds(self) -> 'List[_4028.CylindricalGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesModalAnalysesAtSpeeds, constructor.new(_4028.CylindricalGearMeshModalAnalysesAtSpeeds))
        return value
