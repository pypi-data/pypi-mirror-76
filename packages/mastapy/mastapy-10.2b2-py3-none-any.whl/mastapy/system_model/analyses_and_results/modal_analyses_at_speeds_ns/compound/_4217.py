...
class SynchroniserCompoundModalAnalysesAtSpeeds(_4202.SpecialisedAssemblyCompoundModalAnalysesAtSpeeds):
    '''SynchroniserCompoundModalAnalysesAtSpeeds
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4097.SynchroniserModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4097.SynchroniserModalAnalysesAtSpeeds))
        return value

    @property
    def assembly_modal_analyses_at_speeds_load_cases(self) -> 'List[_4097.SynchroniserModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyModalAnalysesAtSpeedsLoadCases, constructor.new(_4097.SynchroniserModalAnalysesAtSpeeds))
        return value
