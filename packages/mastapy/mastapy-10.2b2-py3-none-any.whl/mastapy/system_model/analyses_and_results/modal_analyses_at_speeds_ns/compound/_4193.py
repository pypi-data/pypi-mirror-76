...
class PowerLoadCompoundModalAnalysesAtSpeeds(_4226.VirtualComponentCompoundModalAnalysesAtSpeeds):
    '''PowerLoadCompoundModalAnalysesAtSpeeds
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4071.PowerLoadModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4071.PowerLoadModalAnalysesAtSpeeds))
        return value

    @property
    def component_modal_analyses_at_speeds_load_cases(self) -> 'List[_4071.PowerLoadModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysesAtSpeedsLoadCases, constructor.new(_4071.PowerLoadModalAnalysesAtSpeeds))
        return value
