...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _2861, _2859, _2795
...
class WormGearSetSteadyStateSynchronousResponseAtASpeed(_2795.GearSetSteadyStateSynchronousResponseAtASpeed):
    '''WormGearSetSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def worm_gears_steady_state_synchronous_response_at_a_speed(self) -> 'List[_2861.WormGearSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsSteadyStateSynchronousResponseAtASpeed, constructor.new(_2861.WormGearSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def worm_meshes_steady_state_synchronous_response_at_a_speed(self) -> 'List[_2859.WormGearMeshSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesSteadyStateSynchronousResponseAtASpeed, constructor.new(_2859.WormGearMeshSteadyStateSynchronousResponseAtASpeed))
        return value
