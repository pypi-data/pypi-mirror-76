...
class PlanetaryGearSetSteadyStateSynchronousResponseAtASpeed(_2785.CylindricalGearSetSteadyStateSynchronousResponseAtASpeed):
    '''PlanetaryGearSetSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_design(self) -> '_2102.PlanetaryGearSet':
