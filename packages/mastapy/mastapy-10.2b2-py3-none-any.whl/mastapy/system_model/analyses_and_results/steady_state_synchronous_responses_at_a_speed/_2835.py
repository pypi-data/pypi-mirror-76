...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _2836, _2834, _2758
...
class SpiralBevelGearSetSteadyStateSynchronousResponseAtASpeed(_2758.BevelGearSetSteadyStateSynchronousResponseAtASpeed):
    '''SpiralBevelGearSetSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def spiral_bevel_gears_steady_state_synchronous_response_at_a_speed(self) -> 'List[_2836.SpiralBevelGearSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsSteadyStateSynchronousResponseAtASpeed, constructor.new(_2836.SpiralBevelGearSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def spiral_bevel_meshes_steady_state_synchronous_response_at_a_speed(self) -> 'List[_2834.SpiralBevelGearMeshSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesSteadyStateSynchronousResponseAtASpeed, constructor.new(_2834.SpiralBevelGearMeshSteadyStateSynchronousResponseAtASpeed))
        return value
