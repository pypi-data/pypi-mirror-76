...
class ConceptGearMeshCompoundSteadyStateSynchronousResponseAtASpeed(_2917.GearMeshCompoundSteadyStateSynchronousResponseAtASpeed):
    '''ConceptGearMeshCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2770.ConceptGearMeshSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2770.ConceptGearMeshSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def connection_steady_state_synchronous_response_at_a_speed_load_cases(self) -> 'List[_2770.ConceptGearMeshSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSteadyStateSynchronousResponseAtASpeedLoadCases, constructor.new(_2770.ConceptGearMeshSteadyStateSynchronousResponseAtASpeed))
        return value
