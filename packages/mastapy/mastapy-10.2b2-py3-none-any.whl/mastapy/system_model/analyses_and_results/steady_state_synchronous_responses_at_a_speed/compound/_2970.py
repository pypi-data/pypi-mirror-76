...
class SynchroniserCompoundSteadyStateSynchronousResponseAtASpeed(_2955.SpecialisedAssemblyCompoundSteadyStateSynchronousResponseAtASpeed):
    '''SynchroniserCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_design(self) -> '_2156.Synchroniser':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2852.SynchroniserSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2852.SynchroniserSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def assembly_steady_state_synchronous_response_at_a_speed_load_cases(self) -> 'List[_2852.SynchroniserSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySteadyStateSynchronousResponseAtASpeedLoadCases, constructor.new(_2852.SynchroniserSteadyStateSynchronousResponseAtASpeed))
        return value
