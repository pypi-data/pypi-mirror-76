...
class RollingRingConnectionCompoundModalAnalysisAtASpeed(_4658.InterMountableComponentConnectionCompoundModalAnalysisAtASpeed):
    '''RollingRingConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4562.RollingRingConnectionModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4562.RollingRingConnectionModalAnalysisAtASpeed))
        return value

    @property
    def connection_modal_analysis_at_a_speed_load_cases(self) -> 'List[_4562.RollingRingConnectionModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionModalAnalysisAtASpeedLoadCases, constructor.new(_4562.RollingRingConnectionModalAnalysisAtASpeed))
        return value
