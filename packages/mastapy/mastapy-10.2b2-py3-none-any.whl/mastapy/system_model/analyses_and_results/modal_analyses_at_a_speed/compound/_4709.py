...
class TorqueConverterConnectionCompoundModalAnalysisAtASpeed(_4635.CouplingConnectionCompoundModalAnalysisAtASpeed):
    '''TorqueConverterConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4587.TorqueConverterConnectionModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4587.TorqueConverterConnectionModalAnalysisAtASpeed))
        return value

    @property
    def connection_modal_analysis_at_a_speed_load_cases(self) -> 'List[_4587.TorqueConverterConnectionModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionModalAnalysisAtASpeedLoadCases, constructor.new(_4587.TorqueConverterConnectionModalAnalysisAtASpeed))
        return value
