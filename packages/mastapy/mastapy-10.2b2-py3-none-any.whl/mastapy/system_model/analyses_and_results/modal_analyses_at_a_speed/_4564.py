...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4548, _4482
...
class RootAssemblyModalAnalysisAtASpeed(_4482.AssemblyModalAnalysisAtASpeed):
    '''RootAssemblyModalAnalysisAtASpeed
    ...
    @property
    def modal_analysis_at_a_speed_inputs(self) -> '_4548.ModalAnalysisAtASpeed':
        ...
        return constructor.new(_4548.ModalAnalysisAtASpeed)(self.wrapped.ModalAnalysisAtASpeedInputs) if self.wrapped.ModalAnalysisAtASpeedInputs else None
