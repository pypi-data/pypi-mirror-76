...
class DesignEntityAnalysis(_0.APIBase):
    ...
    def component_design(self) -> '_1814.DesignEntity':
        ...
        return constructor.new(_1814.DesignEntity)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None
    ...
    @property
    def component_design_of_type_part(self) -> '_2030.Part':
        ...
        if _2030.Part.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
