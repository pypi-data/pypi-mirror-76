...
class PartToPartShearCouplingConnectionSystemDeflection(_2266.CouplingConnectionSystemDeflection):
    '''PartToPartShearCouplingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3313.PartToPartShearCouplingConnectionPowerFlow':
