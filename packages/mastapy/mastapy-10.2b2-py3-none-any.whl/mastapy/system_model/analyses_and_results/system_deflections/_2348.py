...
from mastapy.system_model.analyses_and_results.power_flows import _3347, _3346, _3349
...
class SynchroniserPartSystemDeflection(_2267.CouplingHalfSystemDeflection):
    '''SynchroniserPartSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3347.SynchroniserPartPowerFlow':
