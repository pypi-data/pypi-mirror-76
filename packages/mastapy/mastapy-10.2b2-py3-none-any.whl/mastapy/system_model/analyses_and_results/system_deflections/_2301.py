...
class KlingelnbergCycloPalloidHypoidGearMeshSystemDeflection(_2298.KlingelnbergCycloPalloidConicalGearMeshSystemDeflection):
    '''KlingelnbergCycloPalloidHypoidGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3302.KlingelnbergCycloPalloidHypoidGearMeshPowerFlow':
