...
from mastapy.system_model.analyses_and_results.system_deflections import _2287, _2285, _2290
...
class FaceGearSetSystemDeflection(_2290.GearSetSystemDeflection):
    '''FaceGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3288.FaceGearSetPowerFlow':
    ...
    @property
    def face_gears_system_deflection(self) -> 'List[_2287.FaceGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsSystemDeflection, constructor.new(_2287.FaceGearSystemDeflection))
        return value

    @property
    def face_meshes_system_deflection(self) -> 'List[_2285.FaceGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesSystemDeflection, constructor.new(_2285.FaceGearMeshSystemDeflection))
        return value
