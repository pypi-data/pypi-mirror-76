...
from mastapy.system_model.analyses_and_results.system_deflections import _2347, _2332
...
class SynchroniserSystemDeflection(_2332.SpecialisedAssemblySystemDeflection):
    '''SynchroniserSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3348.SynchroniserPowerFlow':
    ...
    @property
    def cones(self) -> 'List[_2347.SynchroniserHalfSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_2347.SynchroniserHalfSystemDeflection))
        return value
