...
class SpringDamperConnectionSystemDeflection(_2266.CouplingConnectionSystemDeflection):
    '''SpringDamperConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3335.SpringDamperConnectionPowerFlow':
