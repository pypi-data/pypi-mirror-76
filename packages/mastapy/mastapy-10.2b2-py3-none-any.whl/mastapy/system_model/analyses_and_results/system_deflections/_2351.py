...
class SystemDeflection(_6515.FEAnalysis):
    '''SystemDeflection
    ...
    @property
    def analysis_options(self) -> '_2353.SystemDeflectionOptions':
        ...
        return constructor.new(_2353.SystemDeflectionOptions)(self.wrapped.AnalysisOptions) if self.wrapped.AnalysisOptions else None
