...
class PartToPartShearCouplingHalfSystemDeflection(_2267.CouplingHalfSystemDeflection):
    '''PartToPartShearCouplingHalfSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3314.PartToPartShearCouplingHalfPowerFlow':
