...
class RollingRingConnectionSystemDeflection(_2297.InterMountableComponentConnectionSystemDeflection):
    '''RollingRingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3325.RollingRingConnectionPowerFlow':
