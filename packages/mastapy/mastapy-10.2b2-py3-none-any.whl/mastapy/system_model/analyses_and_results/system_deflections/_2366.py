...
from mastapy.system_model.analyses_and_results.system_deflections import _2367, _2365, _2244
...
class ZerolBevelGearSetSystemDeflection(_2244.BevelGearSetSystemDeflection):
    '''ZerolBevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3362.ZerolBevelGearSetPowerFlow':
    ...
    @property
    def zerol_bevel_gears_system_deflection(self) -> 'List[_2367.ZerolBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsSystemDeflection, constructor.new(_2367.ZerolBevelGearSystemDeflection))
        return value

    @property
    def zerol_bevel_meshes_system_deflection(self) -> 'List[_2365.ZerolBevelGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesSystemDeflection, constructor.new(_2365.ZerolBevelGearMeshSystemDeflection))
        return value
