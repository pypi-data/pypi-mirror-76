...
from mastapy.system_model.analyses_and_results.system_deflections import _2248, _2348
...
class SynchroniserHalfSystemDeflection(_2348.SynchroniserPartSystemDeflection):
    '''SynchroniserHalfSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3346.SynchroniserHalfPowerFlow':
