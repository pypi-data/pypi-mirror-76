...
class ConceptCouplingConnectionSystemDeflection(_2266.CouplingConnectionSystemDeflection):
    '''ConceptCouplingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3262.ConceptCouplingConnectionPowerFlow':
