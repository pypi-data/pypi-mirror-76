...
from mastapy.system_model.analyses_and_results.system_deflections import _2306, _2304, _2299
...
class KlingelnbergCycloPalloidSpiralBevelGearSetSystemDeflection(_2299.KlingelnbergCycloPalloidConicalGearSetSystemDeflection):
    '''KlingelnbergCycloPalloidSpiralBevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3307.KlingelnbergCycloPalloidSpiralBevelGearSetPowerFlow':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_system_deflection(self) -> 'List[_2306.KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidSpiralBevelGearsSystemDeflection, constructor.new(_2306.KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection))
        return value

    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_system_deflection(self) -> 'List[_2304.KlingelnbergCycloPalloidSpiralBevelGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidSpiralBevelMeshesSystemDeflection, constructor.new(_2304.KlingelnbergCycloPalloidSpiralBevelGearMeshSystemDeflection))
        return value
