...
from mastapy.system_model.analyses_and_results.system_deflections import _2259, _2257, _2290
...
class ConceptGearSetSystemDeflection(_2290.GearSetSystemDeflection):
    '''ConceptGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3267.ConceptGearSetPowerFlow':
    ...
    @property
    def concept_gears_system_deflection(self) -> 'List[_2259.ConceptGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsSystemDeflection, constructor.new(_2259.ConceptGearSystemDeflection))
        return value

    @property
    def concept_meshes_system_deflection(self) -> 'List[_2257.ConceptGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesSystemDeflection, constructor.new(_2257.ConceptGearMeshSystemDeflection))
        return value
