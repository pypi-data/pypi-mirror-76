...
from mastapy.system_model.analyses_and_results.power_flows import _3301, _3304, _3307
...
class KlingelnbergCycloPalloidConicalGearSetSystemDeflection(_2262.ConicalGearSetSystemDeflection):
    '''KlingelnbergCycloPalloidConicalGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3301.KlingelnbergCycloPalloidConicalGearSetPowerFlow':
