...
from mastapy.system_model.analyses_and_results.system_deflections import _2335, _2333, _2244
...
class SpiralBevelGearSetSystemDeflection(_2244.BevelGearSetSystemDeflection):
    '''SpiralBevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3334.SpiralBevelGearSetPowerFlow':
    ...
    @property
    def spiral_bevel_gears_system_deflection(self) -> 'List[_2335.SpiralBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsSystemDeflection, constructor.new(_2335.SpiralBevelGearSystemDeflection))
        return value

    @property
    def spiral_bevel_meshes_system_deflection(self) -> 'List[_2333.SpiralBevelGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesSystemDeflection, constructor.new(_2333.SpiralBevelGearMeshSystemDeflection))
        return value
