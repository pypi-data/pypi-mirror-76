...
class TorqueConverterCompoundSystemDeflection(_2412.CouplingCompoundSystemDeflection):
    '''TorqueConverterCompoundSystemDeflection
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2356.TorqueConverterSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2356.TorqueConverterSystemDeflection))
        return value

    @property
    def assembly_system_deflection_load_cases(self) -> 'List[_2356.TorqueConverterSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionLoadCases, constructor.new(_2356.TorqueConverterSystemDeflection))
        return value
