...
class ConicalGearMeshCompoundSystemDeflection(_2429.GearMeshCompoundSystemDeflection):
    '''ConicalGearMeshCompoundSystemDeflection
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2261.ConicalGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2261.ConicalGearMeshSystemDeflection))
        return value
