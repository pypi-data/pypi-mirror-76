...
class KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundSystemDeflection(_2438.KlingelnbergCycloPalloidConicalGearMeshCompoundSystemDeflection):
    '''KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundSystemDeflection
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2304.KlingelnbergCycloPalloidSpiralBevelGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2304.KlingelnbergCycloPalloidSpiralBevelGearMeshSystemDeflection))
        return value

    @property
    def connection_system_deflection_load_cases(self) -> 'List[_2304.KlingelnbergCycloPalloidSpiralBevelGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionLoadCases, constructor.new(_2304.KlingelnbergCycloPalloidSpiralBevelGearMeshSystemDeflection))
        return value
