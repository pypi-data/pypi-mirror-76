...
class FlexiblePinAssemblyCompoundSystemDeflection(_2468.SpecialisedAssemblyCompoundSystemDeflection):
    '''FlexiblePinAssemblyCompoundSystemDeflection
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2288.FlexiblePinAssemblySystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2288.FlexiblePinAssemblySystemDeflection))
        return value

    @property
    def assembly_system_deflection_load_cases(self) -> 'List[_2288.FlexiblePinAssemblySystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionLoadCases, constructor.new(_2288.FlexiblePinAssemblySystemDeflection))
        return value
