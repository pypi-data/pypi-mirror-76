...
class StraightBevelGearMeshCompoundSystemDeflection(_2392.BevelGearMeshCompoundSystemDeflection):
    '''StraightBevelGearMeshCompoundSystemDeflection
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2342.StraightBevelGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2342.StraightBevelGearMeshSystemDeflection))
        return value

    @property
    def connection_system_deflection_load_cases(self) -> 'List[_2342.StraightBevelGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionLoadCases, constructor.new(_2342.StraightBevelGearMeshSystemDeflection))
        return value
