...
class KlingelnbergCycloPalloidHypoidGearCompoundSystemDeflection(_2437.KlingelnbergCycloPalloidConicalGearCompoundSystemDeflection):
    '''KlingelnbergCycloPalloidHypoidGearCompoundSystemDeflection
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2303.KlingelnbergCycloPalloidHypoidGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2303.KlingelnbergCycloPalloidHypoidGearSystemDeflection))
        return value

    @property
    def component_system_deflection_load_cases(self) -> 'List[_2303.KlingelnbergCycloPalloidHypoidGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionLoadCases, constructor.new(_2303.KlingelnbergCycloPalloidHypoidGearSystemDeflection))
        return value
