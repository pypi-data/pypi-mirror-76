...
class TorqueConverterConnectionSystemDeflection(_2266.CouplingConnectionSystemDeflection):
    '''TorqueConverterConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3351.TorqueConverterConnectionPowerFlow':
