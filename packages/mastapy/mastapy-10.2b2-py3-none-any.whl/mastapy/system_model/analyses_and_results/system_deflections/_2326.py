...
from mastapy.system_model.analyses_and_results.system_deflections import _2351, _2253, _2234
...
class RootAssemblySystemDeflection(_2234.AssemblySystemDeflection):
    '''RootAssemblySystemDeflection
    ...
    @property
    def system_deflection_inputs(self) -> '_2351.SystemDeflection':
        ...
        return constructor.new(_2351.SystemDeflection)(self.wrapped.SystemDeflectionInputs) if self.wrapped.SystemDeflectionInputs else None

    @property
    def power_flow_results(self) -> '_3327.RootAssemblyPowerFlow':
    ...
    @property
    def shaft_deflection_results(self) -> 'List[_2253.ConcentricPartGroupCombinationSystemDeflectionResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftDeflectionResults, constructor.new(_2253.ConcentricPartGroupCombinationSystemDeflectionResults))
        return value
