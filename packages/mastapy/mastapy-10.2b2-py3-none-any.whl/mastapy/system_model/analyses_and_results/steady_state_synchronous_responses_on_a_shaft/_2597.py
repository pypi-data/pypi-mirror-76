...
class SteadyStateSynchronousResponseOnAShaft(_6521.StaticLoadAnalysisCase):
    '''SteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def options(self) -> '_3086.SteadyStateSynchronousResponseOptions':
        ...
        return constructor.new(_3086.SteadyStateSynchronousResponseOptions)(self.wrapped.Options) if self.wrapped.Options else None
