...
class SpringDamperCompoundModalAnalysis(_4901.CouplingCompoundModalAnalysis):
    '''SpringDamperCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4824.SpringDamperModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4824.SpringDamperModalAnalysis))
        return value

    @property
    def assembly_modal_analysis_load_cases(self) -> 'List[_4824.SpringDamperModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyModalAnalysisLoadCases, constructor.new(_4824.SpringDamperModalAnalysis))
        return value
