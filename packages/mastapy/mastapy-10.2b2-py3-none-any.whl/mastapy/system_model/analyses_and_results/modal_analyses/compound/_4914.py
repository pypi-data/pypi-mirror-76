...
class FaceGearMeshCompoundModalAnalysis(_4918.GearMeshCompoundModalAnalysis):
    '''FaceGearMeshCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4768.FaceGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4768.FaceGearMeshModalAnalysis))
        return value

    @property
    def connection_modal_analysis_load_cases(self) -> 'List[_4768.FaceGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionModalAnalysisLoadCases, constructor.new(_4768.FaceGearMeshModalAnalysis))
        return value
