...
class PlanetCarrierCompoundModalAnalysis(_4937.MountableComponentCompoundModalAnalysis):
    '''PlanetCarrierCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4806.PlanetCarrierModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4806.PlanetCarrierModalAnalysis))
        return value

    @property
    def component_modal_analysis_load_cases(self) -> 'List[_4806.PlanetCarrierModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysisLoadCases, constructor.new(_4806.PlanetCarrierModalAnalysis))
        return value
