...
class KlingelnbergCycloPalloidHypoidGearMeshCompoundModalAnalysis(_4927.KlingelnbergCycloPalloidConicalGearMeshCompoundModalAnalysis):
    '''KlingelnbergCycloPalloidHypoidGearMeshCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4785.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4785.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysis))
        return value

    @property
    def connection_modal_analysis_load_cases(self) -> 'List[_4785.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionModalAnalysisLoadCases, constructor.new(_4785.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysis))
        return value
