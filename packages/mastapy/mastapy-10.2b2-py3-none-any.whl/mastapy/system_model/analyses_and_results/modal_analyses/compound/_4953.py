...
class ShaftCompoundModalAnalysis(_4867.AbstractShaftOrHousingCompoundModalAnalysis):
    '''ShaftCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4815.ShaftModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4815.ShaftModalAnalysis))
        return value

    @property
    def component_modal_analysis_load_cases(self) -> 'List[_4815.ShaftModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysisLoadCases, constructor.new(_4815.ShaftModalAnalysis))
        return value
