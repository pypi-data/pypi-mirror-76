...
class StraightBevelDiffGearCompoundModalAnalysis(_4880.BevelGearCompoundModalAnalysis):
    '''StraightBevelDiffGearCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4826.StraightBevelDiffGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4826.StraightBevelDiffGearModalAnalysis))
        return value

    @property
    def component_modal_analysis_load_cases(self) -> 'List[_4826.StraightBevelDiffGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysisLoadCases, constructor.new(_4826.StraightBevelDiffGearModalAnalysis))
        return value
