...
class TorqueConverterConnectionCompoundModalAnalysis(_4902.CouplingConnectionCompoundModalAnalysis):
    '''TorqueConverterConnectionCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4837.TorqueConverterConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4837.TorqueConverterConnectionModalAnalysis))
        return value

    @property
    def connection_modal_analysis_load_cases(self) -> 'List[_4837.TorqueConverterConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionModalAnalysisLoadCases, constructor.new(_4837.TorqueConverterConnectionModalAnalysis))
        return value
