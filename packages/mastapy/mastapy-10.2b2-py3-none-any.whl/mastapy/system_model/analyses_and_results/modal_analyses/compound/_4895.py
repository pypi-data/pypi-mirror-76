...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4893, _4894, _4919
...
class ConceptGearSetCompoundModalAnalysis(_4919.GearSetCompoundModalAnalysis):
    '''ConceptGearSetCompoundModalAnalysis
    ...
    @property
    def concept_gears_compound_modal_analysis(self) -> 'List[_4893.ConceptGearCompoundModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsCompoundModalAnalysis, constructor.new(_4893.ConceptGearCompoundModalAnalysis))
        return value

    @property
    def concept_meshes_compound_modal_analysis(self) -> 'List[_4894.ConceptGearMeshCompoundModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesCompoundModalAnalysis, constructor.new(_4894.ConceptGearMeshCompoundModalAnalysis))
        return value
