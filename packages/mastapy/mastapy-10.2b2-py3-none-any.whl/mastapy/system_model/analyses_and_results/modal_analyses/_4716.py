...
from mastapy.system_model.analyses_and_results.modal_analyses import _4739, _4769, _4796
...
class AbstractAssemblyModalAnalysis(_4796.PartModalAnalysis):
    '''AbstractAssemblyModalAnalysis
    ...
    @property
    def rigidly_connected_groups(self) -> 'List[_4739.ComponentModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RigidlyConnectedGroups, constructor.new(_4739.ComponentModalAnalysis))
        return value

    @property
    def gear_meshes(self) -> 'List[_4769.GearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshes, constructor.new(_4769.GearMeshModalAnalysis))
        return value
