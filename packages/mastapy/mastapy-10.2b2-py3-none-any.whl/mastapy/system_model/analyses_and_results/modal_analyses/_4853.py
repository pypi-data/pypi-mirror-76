...
from mastapy.system_model.analyses_and_results.modal_analyses import _4852, _4851, _4736
...
class ZerolBevelGearSetModalAnalysis(_4736.BevelGearSetModalAnalysis):
    '''ZerolBevelGearSetModalAnalysis
    ...
    @property
    def zerol_bevel_gears_modal_analysis(self) -> 'List[_4852.ZerolBevelGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsModalAnalysis, constructor.new(_4852.ZerolBevelGearModalAnalysis))
        return value

    @property
    def zerol_bevel_meshes_modal_analysis(self) -> 'List[_4851.ZerolBevelGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesModalAnalysis, constructor.new(_4851.ZerolBevelGearMeshModalAnalysis))
        return value
