...
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4865, _4862, _4864
...
class PartModalAnalysis(_6519.PartStaticLoadAnalysisCase):
    '''PartModalAnalysis
    ...
    @property
    def results_for_modes(self) -> 'List[_4865.SingleModeResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ResultsForModes, constructor.new(_4865.SingleModeResults))
        return value

    @property
    def shaft_excitation_details(self) -> 'List[_4862.RigidlyConnectedDesignEntityGroupModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftExcitationDetails, constructor.new(_4862.RigidlyConnectedDesignEntityGroupModalAnalysis))
        return value

    @property
    def gear_mesh_excitation_details(self) -> 'List[_4862.RigidlyConnectedDesignEntityGroupModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshExcitationDetails, constructor.new(_4862.RigidlyConnectedDesignEntityGroupModalAnalysis))
        return value
