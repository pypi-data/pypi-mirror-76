...
from mastapy.system_model.analyses_and_results.modal_analyses import (
    _4755, _4844, _4843, _4799,
    _4845
)
from mastapy.system_model.analyses_and_results.gear_whine_analyses.whine_analyses_results import (
    _5422, _5425, _5430, _5431
)
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5338, _5389
...
class WhineWaterfallSettings(_0.APIBase):
    ...
    @property
    def connected_component_type(self) -> '_5422.ConnectedComponentType':
        ...
        return constructor.new(_5422.ConnectedComponentType)(value) if value else None

    @connected_component_type.setter
    def connected_component_type(self, value: '_5422.ConnectedComponentType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ConnectedComponentType = value

    @property
    def whine_waterfall_export_option(self) -> '_4844.WhineWaterfallExportOption':
        ...
        return constructor.new(_4844.WhineWaterfallExportOption)(value) if value else None

    @whine_waterfall_export_option.setter
    def whine_waterfall_export_option(self, value: '_4844.WhineWaterfallExportOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def selected_excitations(self) -> '_5425.ExcitationSourceSelectionGroup':
        ...
        return constructor.new(_5425.ExcitationSourceSelectionGroup)(self.wrapped.SelectedExcitations) if self.wrapped.SelectedExcitations else None

    @property
    def waterfall_chart_settings(self) -> '_4843.WaterfallChartSettings':
        ...
        return constructor.new(_4843.WaterfallChartSettings)(self.wrapped.WaterfallChartSettings) if self.wrapped.WaterfallChartSettings else None

    @property
    def order_cuts_chart_settings(self) -> '_4799.OrderCutsChartSettings':
        ...
        return constructor.new(_4799.OrderCutsChartSettings)(self.wrapped.OrderCutsChartSettings) if self.wrapped.OrderCutsChartSettings else None

    @property
    def frequency_options(self) -> '_5338.FrequencyOptionsForGearWhineAnalysisResults':
        ...
        return constructor.new(_5338.FrequencyOptionsForGearWhineAnalysisResults)(self.wrapped.FrequencyOptions) if self.wrapped.FrequencyOptions else None

    @property
    def reference_speed_options(self) -> '_5389.SpeedOptionsForGearWhineAnalysisResults':
        ...
        return constructor.new(_5389.SpeedOptionsForGearWhineAnalysisResults)(self.wrapped.ReferenceSpeedOptions) if self.wrapped.ReferenceSpeedOptions else None

    @property
    def very_short_length_reference_values(self) -> '_4845.WhineWaterfallReferenceValues[_1211.LengthVeryShort]':
        ...
        return constructor.new(_4845.WhineWaterfallReferenceValues)[_1211.LengthVeryShort](self.wrapped.VeryShortLengthReferenceValues) if self.wrapped.VeryShortLengthReferenceValues else None

    @property
    def small_angle_reference_values(self) -> '_4845.WhineWaterfallReferenceValues[_1165.AngleSmall]':
        ...
        return constructor.new(_4845.WhineWaterfallReferenceValues)[_1165.AngleSmall](self.wrapped.SmallAngleReferenceValues) if self.wrapped.SmallAngleReferenceValues else None

    @property
    def small_velocity_reference_values(self) -> '_4845.WhineWaterfallReferenceValues[_1263.VelocitySmall]':
        ...
        return constructor.new(_4845.WhineWaterfallReferenceValues)[_1263.VelocitySmall](self.wrapped.SmallVelocityReferenceValues) if self.wrapped.SmallVelocityReferenceValues else None

    @property
    def angular_velocity_reference_values(self) -> '_4845.WhineWaterfallReferenceValues[_1171.AngularVelocity]':
        ...
        return constructor.new(_4845.WhineWaterfallReferenceValues)[_1171.AngularVelocity](self.wrapped.AngularVelocityReferenceValues) if self.wrapped.AngularVelocityReferenceValues else None

    @property
    def acceleration_reference_values(self) -> '_4845.WhineWaterfallReferenceValues[_1162.Acceleration]':
        ...
        return constructor.new(_4845.WhineWaterfallReferenceValues)[_1162.Acceleration](self.wrapped.AccelerationReferenceValues) if self.wrapped.AccelerationReferenceValues else None

    @property
    def angular_acceleration_reference_values(self) -> '_4845.WhineWaterfallReferenceValues[_1167.AngularAcceleration]':
        ...
        return constructor.new(_4845.WhineWaterfallReferenceValues)[_1167.AngularAcceleration](self.wrapped.AngularAccelerationReferenceValues) if self.wrapped.AngularAccelerationReferenceValues else None

    @property
    def force_reference_values(self) -> '_4845.WhineWaterfallReferenceValues[_1185.Force]':
        ...
        return constructor.new(_4845.WhineWaterfallReferenceValues)[_1185.Force](self.wrapped.ForceReferenceValues) if self.wrapped.ForceReferenceValues else None

    @property
    def torque_reference_values(self) -> '_4845.WhineWaterfallReferenceValues[_1258.Torque]':
        ...
        return constructor.new(_4845.WhineWaterfallReferenceValues)[_1258.Torque](self.wrapped.TorqueReferenceValues) if self.wrapped.TorqueReferenceValues else None

    @property
    def energy_reference_values(self) -> '_4845.WhineWaterfallReferenceValues[_1179.Energy]':
        ...
        return constructor.new(_4845.WhineWaterfallReferenceValues)[_1179.Energy](self.wrapped.EnergyReferenceValues) if self.wrapped.EnergyReferenceValues else None

    @property
    def power_small_reference_values(self) -> '_4845.WhineWaterfallReferenceValues[_1229.PowerSmall]':
        ...
        return constructor.new(_4845.WhineWaterfallReferenceValues)[_1229.PowerSmall](self.wrapped.PowerSmallReferenceValues) if self.wrapped.PowerSmallReferenceValues else None

    @property
    def power_small_per_unit_area_reference_values(self) -> '_4845.WhineWaterfallReferenceValues[_1230.PowerSmallPerArea]':
        ...
        return constructor.new(_4845.WhineWaterfallReferenceValues)[_1230.PowerSmallPerArea](self.wrapped.PowerSmallPerUnitAreaReferenceValues) if self.wrapped.PowerSmallPerUnitAreaReferenceValues else None

    @property
    def pressure_reference_values(self) -> '_4845.WhineWaterfallReferenceValues[_1233.Pressure]':
        ...
        return constructor.new(_4845.WhineWaterfallReferenceValues)[_1233.Pressure](self.wrapped.PressureReferenceValues) if self.wrapped.PressureReferenceValues else None

    @property
    def result_location_selection_groups(self) -> '_5430.ResultLocationSelectionGroups':
        ...
        return constructor.new(_5430.ResultLocationSelectionGroups)(self.wrapped.ResultLocationSelectionGroups) if self.wrapped.ResultLocationSelectionGroups else None

    @property
    def active_result_locations(self) -> 'List[_5431.ResultNodeSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ActiveResultLocations, constructor.new(_5431.ResultNodeSelection))
        return value
