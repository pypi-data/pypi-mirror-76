...
class PowerFlow(_6521.StaticLoadAnalysisCase):
    '''PowerFlow
    ...
    @property
    def torsional_system_deflection(self) -> '_2358.TorsionalSystemDeflection':
        ...
        return constructor.new(_2358.TorsionalSystemDeflection)(self.wrapped.TorsionalSystemDeflection) if self.wrapped.TorsionalSystemDeflection else None
