...
from mastapy.system_model.analyses_and_results.power_flows import _3320, _3243
...
class RootAssemblyPowerFlow(_3243.AssemblyPowerFlow):
    '''RootAssemblyPowerFlow
    ...
    @property
    def power_flow_inputs(self) -> '_3320.PowerFlow':
        ...
        return constructor.new(_3320.PowerFlow)(self.wrapped.PowerFlowInputs) if self.wrapped.PowerFlowInputs else None
