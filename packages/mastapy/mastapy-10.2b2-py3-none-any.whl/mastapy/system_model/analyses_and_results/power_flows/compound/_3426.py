...
class KlingelnbergCycloPalloidHypoidGearCompoundPowerFlow(_3423.KlingelnbergCycloPalloidConicalGearCompoundPowerFlow):
    '''KlingelnbergCycloPalloidHypoidGearCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3303.KlingelnbergCycloPalloidHypoidGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3303.KlingelnbergCycloPalloidHypoidGearPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_3303.KlingelnbergCycloPalloidHypoidGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_3303.KlingelnbergCycloPalloidHypoidGearPowerFlow))
        return value
