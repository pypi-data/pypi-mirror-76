...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3470
...
class SynchroniserSleeveCompoundPowerFlow(_3470.SynchroniserPartCompoundPowerFlow):
    '''SynchroniserSleeveCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3349.SynchroniserSleevePowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3349.SynchroniserSleevePowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_3349.SynchroniserSleevePowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_3349.SynchroniserSleevePowerFlow))
        return value
