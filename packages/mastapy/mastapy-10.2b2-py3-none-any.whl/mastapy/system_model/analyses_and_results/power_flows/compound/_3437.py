...
class PartToPartShearCouplingCompoundPowerFlow(_3398.CouplingCompoundPowerFlow):
    '''PartToPartShearCouplingCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3315.PartToPartShearCouplingPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3315.PartToPartShearCouplingPowerFlow))
        return value

    @property
    def assembly_power_flow_load_cases(self) -> 'List[_3315.PartToPartShearCouplingPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyPowerFlowLoadCases, constructor.new(_3315.PartToPartShearCouplingPowerFlow))
        return value
