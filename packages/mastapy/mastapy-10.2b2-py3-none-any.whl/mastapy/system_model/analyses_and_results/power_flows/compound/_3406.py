...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3404, _3405, _3416
...
class CylindricalGearSetCompoundPowerFlow(_3416.GearSetCompoundPowerFlow):
    '''CylindricalGearSetCompoundPowerFlow
    ...
    @property
    def cylindrical_gears_compound_power_flow(self) -> 'List[_3404.CylindricalGearCompoundPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsCompoundPowerFlow, constructor.new(_3404.CylindricalGearCompoundPowerFlow))
        return value

    @property
    def cylindrical_meshes_compound_power_flow(self) -> 'List[_3405.CylindricalGearMeshCompoundPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesCompoundPowerFlow, constructor.new(_3405.CylindricalGearMeshCompoundPowerFlow))
        return value

    @property
    def load_case_analyses_ready(self) -> 'List[_3282.CylindricalGearSetPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3282.CylindricalGearSetPowerFlow))
        return value

    @property
    def assembly_power_flow_load_cases(self) -> 'List[_3282.CylindricalGearSetPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyPowerFlowLoadCases, constructor.new(_3282.CylindricalGearSetPowerFlow))
        return value
