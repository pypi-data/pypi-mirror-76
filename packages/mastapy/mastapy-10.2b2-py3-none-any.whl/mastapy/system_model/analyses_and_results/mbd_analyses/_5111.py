...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5115, _5025
...
class TorqueConverterConnectionMultiBodyDynamicsAnalysis(_5025.CouplingConnectionMultiBodyDynamicsAnalysis):
    '''TorqueConverterConnectionMultiBodyDynamicsAnalysis
    ...
    @property
    def locking_status(self) -> '_5115.TorqueConverterStatus':
        ...
        return constructor.new(_5115.TorqueConverterStatus)(value) if value else None
