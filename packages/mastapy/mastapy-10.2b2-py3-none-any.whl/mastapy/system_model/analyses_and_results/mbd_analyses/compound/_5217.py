...
class RollingRingConnectionCompoundMultiBodyDynamicsAnalysis(_5191.InterMountableComponentConnectionCompoundMultiBodyDynamicsAnalysis):
    '''RollingRingConnectionCompoundMultiBodyDynamicsAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5083.RollingRingConnectionMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5083.RollingRingConnectionMultiBodyDynamicsAnalysis))
        return value

    @property
    def connection_multi_body_dynamics_analysis_load_cases(self) -> 'List[_5083.RollingRingConnectionMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionMultiBodyDynamicsAnalysisLoadCases, constructor.new(_5083.RollingRingConnectionMultiBodyDynamicsAnalysis))
        return value
