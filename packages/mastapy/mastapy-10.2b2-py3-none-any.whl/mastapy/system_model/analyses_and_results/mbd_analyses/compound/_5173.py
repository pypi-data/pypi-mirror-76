...
class CylindricalGearCompoundMultiBodyDynamicsAnalysis(_5183.GearCompoundMultiBodyDynamicsAnalysis):
    '''CylindricalGearCompoundMultiBodyDynamicsAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5032.CylindricalGearMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5032.CylindricalGearMultiBodyDynamicsAnalysis))
        return value

    @property
    def component_multi_body_dynamics_analysis_load_cases(self) -> 'List[_5032.CylindricalGearMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentMultiBodyDynamicsAnalysisLoadCases, constructor.new(_5032.CylindricalGearMultiBodyDynamicsAnalysis))
        return value
