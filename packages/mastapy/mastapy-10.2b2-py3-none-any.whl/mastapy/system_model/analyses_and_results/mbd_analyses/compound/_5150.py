...
class BoltedJointCompoundMultiBodyDynamicsAnalysis(_5222.SpecialisedAssemblyCompoundMultiBodyDynamicsAnalysis):
    '''BoltedJointCompoundMultiBodyDynamicsAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5006.BoltedJointMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5006.BoltedJointMultiBodyDynamicsAnalysis))
        return value

    @property
    def assembly_multi_body_dynamics_analysis_load_cases(self) -> 'List[_5006.BoltedJointMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyMultiBodyDynamicsAnalysisLoadCases, constructor.new(_5006.BoltedJointMultiBodyDynamicsAnalysis))
        return value
