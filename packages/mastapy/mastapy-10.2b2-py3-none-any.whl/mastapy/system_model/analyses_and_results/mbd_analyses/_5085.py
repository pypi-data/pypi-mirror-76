...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5070, _4993
...
class RootAssemblyMultiBodyDynamicsAnalysis(_4993.AssemblyMultiBodyDynamicsAnalysis):
    '''RootAssemblyMultiBodyDynamicsAnalysis
    ...
    @property
    def multi_body_dynamics_analysis_inputs(self) -> '_5070.MultiBodyDynamicsAnalysis':
        ...
        return constructor.new(_5070.MultiBodyDynamicsAnalysis)(self.wrapped.MultiBodyDynamicsAnalysisInputs) if self.wrapped.MultiBodyDynamicsAnalysisInputs else None
