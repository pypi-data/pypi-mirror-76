...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5008, _5027
...
class ClutchMultiBodyDynamicsAnalysis(_5027.CouplingMultiBodyDynamicsAnalysis):
    '''ClutchMultiBodyDynamicsAnalysis
    ...
    @property
    def clutch_connection(self) -> '_5008.ClutchConnectionMultiBodyDynamicsAnalysis':
        ...
        return constructor.new(_5008.ClutchConnectionMultiBodyDynamicsAnalysis)(self.wrapped.ClutchConnection) if self.wrapped.ClutchConnection else None
