...
class GearMultiBodyDynamicsAnalysis(_5069.MountableComponentMultiBodyDynamicsAnalysis):
    '''GearMultiBodyDynamicsAnalysis
    ...
    @property
    def peak_gear_torque(self) -> 'List[_5129.DynamicTorqueResultAtTime]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PeakGearTorque, constructor.new(_5129.DynamicTorqueResultAtTime))
        return value
