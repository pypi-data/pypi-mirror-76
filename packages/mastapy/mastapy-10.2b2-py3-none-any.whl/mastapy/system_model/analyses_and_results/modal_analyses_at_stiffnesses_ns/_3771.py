...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _3770, _3769, _3796
...
class ConceptGearSetModalAnalysesAtStiffnesses(_3796.GearSetModalAnalysesAtStiffnesses):
    '''ConceptGearSetModalAnalysesAtStiffnesses
    ...
    @property
    def concept_gears_modal_analyses_at_stiffnesses(self) -> 'List[_3770.ConceptGearModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsModalAnalysesAtStiffnesses, constructor.new(_3770.ConceptGearModalAnalysesAtStiffnesses))
        return value

    @property
    def concept_meshes_modal_analyses_at_stiffnesses(self) -> 'List[_3769.ConceptGearMeshModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesModalAnalysesAtStiffnesses, constructor.new(_3769.ConceptGearMeshModalAnalysesAtStiffnesses))
        return value
