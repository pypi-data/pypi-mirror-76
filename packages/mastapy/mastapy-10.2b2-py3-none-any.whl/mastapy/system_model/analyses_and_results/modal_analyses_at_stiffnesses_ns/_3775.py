...
class ConnectionModalAnalysesAtStiffnesses(_6512.ConnectionStaticLoadAnalysisCase):
    '''ConnectionModalAnalysesAtStiffnesses
    ...
    @property
    def modal_analyses_at_stiffnesses(self) -> '_3780.CriticalSpeedAnalysis':
        ...
        return constructor.new(_3780.CriticalSpeedAnalysis)(self.wrapped.ModalAnalysesAtStiffnesses) if self.wrapped.ModalAnalysesAtStiffnesses else None
