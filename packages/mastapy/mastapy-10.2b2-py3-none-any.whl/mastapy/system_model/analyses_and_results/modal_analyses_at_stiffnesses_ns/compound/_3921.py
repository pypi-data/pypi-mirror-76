...
class HypoidGearCompoundModalAnalysesAtStiffnesses(_3868.AGMAGleasonConicalGearCompoundModalAnalysesAtStiffnesses):
    '''HypoidGearCompoundModalAnalysesAtStiffnesses
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3799.HypoidGearModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3799.HypoidGearModalAnalysesAtStiffnesses))
        return value

    @property
    def component_modal_analyses_at_stiffnesses_load_cases(self) -> 'List[_3799.HypoidGearModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysesAtStiffnessesLoadCases, constructor.new(_3799.HypoidGearModalAnalysesAtStiffnesses))
        return value
