...
class CylindricalGearMeshCompoundModalAnalysesAtStiffnesses(_3918.GearMeshCompoundModalAnalysesAtStiffnesses):
    '''CylindricalGearMeshCompoundModalAnalysesAtStiffnesses
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3784.CylindricalGearMeshModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3784.CylindricalGearMeshModalAnalysesAtStiffnesses))
        return value

    @property
    def connection_modal_analyses_at_stiffnesses_load_cases(self) -> 'List[_3784.CylindricalGearMeshModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionModalAnalysesAtStiffnessesLoadCases, constructor.new(_3784.CylindricalGearMeshModalAnalysesAtStiffnesses))
        return value
