...
class FlexiblePinAssemblyCompoundModalAnalysesAtStiffnesses(_3956.SpecialisedAssemblyCompoundModalAnalysesAtStiffnesses):
    '''FlexiblePinAssemblyCompoundModalAnalysesAtStiffnesses
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3793.FlexiblePinAssemblyModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3793.FlexiblePinAssemblyModalAnalysesAtStiffnesses))
        return value

    @property
    def assembly_modal_analyses_at_stiffnesses_load_cases(self) -> 'List[_3793.FlexiblePinAssemblyModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyModalAnalysesAtStiffnessesLoadCases, constructor.new(_3793.FlexiblePinAssemblyModalAnalysesAtStiffnesses))
        return value
