...
class UnbalancedMassCompoundModalAnalysesAtStiffnesses(_3980.VirtualComponentCompoundModalAnalysesAtStiffnesses):
    '''UnbalancedMassCompoundModalAnalysesAtStiffnesses
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3858.UnbalancedMassModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3858.UnbalancedMassModalAnalysesAtStiffnesses))
        return value

    @property
    def component_modal_analyses_at_stiffnesses_load_cases(self) -> 'List[_3858.UnbalancedMassModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysesAtStiffnessesLoadCases, constructor.new(_3858.UnbalancedMassModalAnalysesAtStiffnesses))
        return value
