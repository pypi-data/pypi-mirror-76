...
class TorqueConverterConnectionCompoundModalAnalysesAtStiffnesses(_3902.CouplingConnectionCompoundModalAnalysesAtStiffnesses):
    '''TorqueConverterConnectionCompoundModalAnalysesAtStiffnesses
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3854.TorqueConverterConnectionModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3854.TorqueConverterConnectionModalAnalysesAtStiffnesses))
        return value

    @property
    def connection_modal_analyses_at_stiffnesses_load_cases(self) -> 'List[_3854.TorqueConverterConnectionModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionModalAnalysesAtStiffnessesLoadCases, constructor.new(_3854.TorqueConverterConnectionModalAnalysesAtStiffnesses))
        return value
