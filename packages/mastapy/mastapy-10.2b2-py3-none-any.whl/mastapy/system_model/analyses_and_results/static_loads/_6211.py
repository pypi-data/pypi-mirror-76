...
from mastapy.system_model.analyses_and_results.static_loads import _6209, _6210, _6088
...
class StraightBevelDiffGearSetLoadCase(_6088.BevelGearSetLoadCase):
    '''StraightBevelDiffGearSetLoadCase
    ...
    @property
    def straight_bevel_diff_gears_load_case(self) -> 'List[_6209.StraightBevelDiffGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsLoadCase, constructor.new(_6209.StraightBevelDiffGearLoadCase))
        return value

    @property
    def straight_bevel_diff_meshes_load_case(self) -> 'List[_6210.StraightBevelDiffGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesLoadCase, constructor.new(_6210.StraightBevelDiffGearMeshLoadCase))
        return value
