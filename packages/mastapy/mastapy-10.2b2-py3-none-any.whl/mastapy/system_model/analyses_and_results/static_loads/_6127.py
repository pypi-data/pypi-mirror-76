...
from mastapy.system_model.analyses_and_results.static_loads import _6227, _6156, _6201
...
class ElectricMachineHarmonicLoadData(_6201.SpeedDependentHarmonicLoadData):
    '''ElectricMachineHarmonicLoadData
    ...
    @property
    def force_distribution(self) -> '_6529.SMTBitmap':
        ...
        return constructor.new(_6529.SMTBitmap)(self.wrapped.ForceDistribution) if self.wrapped.ForceDistribution else None
