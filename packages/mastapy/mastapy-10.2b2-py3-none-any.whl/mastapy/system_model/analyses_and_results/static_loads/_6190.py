...
from mastapy.system_model.analyses_and_results.static_loads import _6228, _6127, _6232
...
class PowerLoadLoadCase(_6232.VirtualComponentLoadCase):
    '''PowerLoadLoadCase
    ...
    @property
    def wheel_slip_model(self) -> '_5119.WheelSlipType':
        ...
        return constructor.new(_5119.WheelSlipType)(value) if value else None

    @wheel_slip_model.setter
    def wheel_slip_model(self, value: '_5119.WheelSlipType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    def get_harmonic_load_data_for_import(self) -> '_6127.ElectricMachineHarmonicLoadData':
        ...
        return constructor.new(_6127.ElectricMachineHarmonicLoadData)(method_result) if method_result else None
