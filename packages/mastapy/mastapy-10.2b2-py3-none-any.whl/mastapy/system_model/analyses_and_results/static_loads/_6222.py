...
class TimeSeriesLoadCase(_6069.LoadCase):
    ...
    @property
    def driva_analysis_options(self) -> '_5066.MBDAnalysisOptions':
        ...
        return constructor.new(_5066.MBDAnalysisOptions)(self.wrapped.DRIVAAnalysisOptions) if self.wrapped.DRIVAAnalysisOptions else None
