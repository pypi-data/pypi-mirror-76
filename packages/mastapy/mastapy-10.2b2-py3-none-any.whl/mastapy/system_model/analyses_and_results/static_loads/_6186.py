...
from mastapy.system_model.analyses_and_results.static_loads import _6185, _6175
...
class PlanetCarrierLoadCase(_6175.MountableComponentLoadCase):
    '''PlanetCarrierLoadCase
    ...
    @property
    def planet_manufacture_errors(self) -> 'List[_6185.PlanetarySocketManufactureError]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetManufactureErrors, constructor.new(_6185.PlanetarySocketManufactureError))
        return value
