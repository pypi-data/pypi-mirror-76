...
from mastapy.system_model.analyses_and_results.static_loads import _6233, _6234, _6147
...
class WormGearSetLoadCase(_6147.GearSetLoadCase):
    '''WormGearSetLoadCase
    ...
    @property
    def worm_gears_load_case(self) -> 'List[_6233.WormGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsLoadCase, constructor.new(_6233.WormGearLoadCase))
        return value

    @property
    def worm_meshes_load_case(self) -> 'List[_6234.WormGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesLoadCase, constructor.new(_6234.WormGearMeshLoadCase))
        return value
