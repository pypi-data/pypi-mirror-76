...
from mastapy.system_model.analyses_and_results.static_loads import _6127, _6133
...
T = TypeVar('T', bound='_6133.ElectricMachineHarmonicLoadImportOptionsBase')


class ElectricMachineHarmonicLoadDataFromMotorPackages(_6127.ElectricMachineHarmonicLoadData, Generic[T]):
    '''ElectricMachineHarmonicLoadDataFromMotorPackages
