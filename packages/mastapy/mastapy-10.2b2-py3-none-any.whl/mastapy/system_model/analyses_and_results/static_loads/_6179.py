...
class PartLoadCase(_2205.PartAnalysis):
    '''PartLoadCase
    ...
    @property
    def static_load_case(self) -> '_6208.StaticLoadCase':
        ...
        return constructor.new(_6208.StaticLoadCase)(self.wrapped.StaticLoadCase) if self.wrapped.StaticLoadCase else None
    ...
    def get_harmonic_load_data_for_import(self) -> '_6150.HarmonicLoadDataBase':
        ...
        return constructor.new(_6150.HarmonicLoadDataBase)(method_result) if method_result else None
