...
from mastapy.system_model.analyses_and_results.static_loads import _6114, _6080
...
class CVTLoadCase(_6080.BeltDriveLoadCase):
    '''CVTLoadCase
    ...
    @property
    def pulleys(self) -> 'List[_6114.CVTPulleyLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_6114.CVTPulleyLoadCase))
        return value
