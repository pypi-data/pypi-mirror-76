...
from mastapy.system_model.analyses_and_results.static_loads import _6202, _6203, _6088
...
class SpiralBevelGearSetLoadCase(_6088.BevelGearSetLoadCase):
    '''SpiralBevelGearSetLoadCase
    ...
    @property
    def spiral_bevel_gears_load_case(self) -> 'List[_6202.SpiralBevelGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsLoadCase, constructor.new(_6202.SpiralBevelGearLoadCase))
        return value

    @property
    def spiral_bevel_meshes_load_case(self) -> 'List[_6203.SpiralBevelGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesLoadCase, constructor.new(_6203.SpiralBevelGearMeshLoadCase))
        return value
