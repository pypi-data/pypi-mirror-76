...
class GearSetLoadCase(_6200.SpecialisedAssemblyLoadCase):
    '''GearSetLoadCase
    ...
    @property
    def gear_mesh_stiffness_model(self) -> '_5042.GearMeshStiffnessModel':
        ...
        return constructor.new(_5042.GearMeshStiffnessModel)(value) if value else None

    @gear_mesh_stiffness_model.setter
    def gear_mesh_stiffness_model(self, value: '_5042.GearMeshStiffnessModel'):
