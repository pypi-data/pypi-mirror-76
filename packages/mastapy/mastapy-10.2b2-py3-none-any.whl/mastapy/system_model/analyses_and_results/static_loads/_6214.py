...
from mastapy.system_model.analyses_and_results.static_loads import _6212, _6213, _6088
...
class StraightBevelGearSetLoadCase(_6088.BevelGearSetLoadCase):
    '''StraightBevelGearSetLoadCase
    ...
    @property
    def straight_bevel_gears_load_case(self) -> 'List[_6212.StraightBevelGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsLoadCase, constructor.new(_6212.StraightBevelGearLoadCase))
        return value

    @property
    def straight_bevel_meshes_load_case(self) -> 'List[_6213.StraightBevelGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesLoadCase, constructor.new(_6213.StraightBevelGearMeshLoadCase))
        return value
