...
class SteadyStateSynchronousResponse(_6508.CompoundAnalysisCase):
    '''SteadyStateSynchronousResponse
    ...
    @property
    def steady_state_analysis_options(self) -> '_3086.SteadyStateSynchronousResponseOptions':
        ...
        return constructor.new(_3086.SteadyStateSynchronousResponseOptions)(self.wrapped.SteadyStateAnalysisOptions) if self.wrapped.SteadyStateAnalysisOptions else None
