...
class ConnectionSteadyStateSynchronousResponse(_6512.ConnectionStaticLoadAnalysisCase):
    '''ConnectionSteadyStateSynchronousResponse
    ...
    @property
    def steady_state_synchronous_response(self) -> '_3084.SteadyStateSynchronousResponse':
        ...
        return constructor.new(_3084.SteadyStateSynchronousResponse)(self.wrapped.SteadyStateSynchronousResponse) if self.wrapped.SteadyStateSynchronousResponse else None
