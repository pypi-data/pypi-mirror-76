...
class PartToPartShearCouplingHalfCompoundSteadyStateSynchronousResponse(_3148.CouplingHalfCompoundSteadyStateSynchronousResponse):
    '''PartToPartShearCouplingHalfCompoundSteadyStateSynchronousResponse
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3062.PartToPartShearCouplingHalfSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3062.PartToPartShearCouplingHalfSteadyStateSynchronousResponse))
        return value

    @property
    def component_steady_state_synchronous_response_load_cases(self) -> 'List[_3062.PartToPartShearCouplingHalfSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSteadyStateSynchronousResponseLoadCases, constructor.new(_3062.PartToPartShearCouplingHalfSteadyStateSynchronousResponse))
        return value
