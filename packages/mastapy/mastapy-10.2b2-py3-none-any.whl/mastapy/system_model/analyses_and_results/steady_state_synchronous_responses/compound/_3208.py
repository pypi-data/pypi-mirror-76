...
class StraightBevelDiffGearCompoundSteadyStateSynchronousResponse(_3125.BevelGearCompoundSteadyStateSynchronousResponse):
    '''StraightBevelDiffGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3089.StraightBevelDiffGearSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3089.StraightBevelDiffGearSteadyStateSynchronousResponse))
        return value

    @property
    def component_steady_state_synchronous_response_load_cases(self) -> 'List[_3089.StraightBevelDiffGearSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSteadyStateSynchronousResponseLoadCases, constructor.new(_3089.StraightBevelDiffGearSteadyStateSynchronousResponse))
        return value
