...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3036, _3034, _3039
...
class FaceGearSetSteadyStateSynchronousResponse(_3039.GearSetSteadyStateSynchronousResponse):
    '''FaceGearSetSteadyStateSynchronousResponse
    ...
    @property
    def face_gears_steady_state_synchronous_response(self) -> 'List[_3036.FaceGearSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsSteadyStateSynchronousResponse, constructor.new(_3036.FaceGearSteadyStateSynchronousResponse))
        return value

    @property
    def face_meshes_steady_state_synchronous_response(self) -> 'List[_3034.FaceGearMeshSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesSteadyStateSynchronousResponse, constructor.new(_3034.FaceGearMeshSteadyStateSynchronousResponse))
        return value
