...
class PartToPartShearCouplingHalfCompoundModalAnalysisAtAStiffness(_4393.CouplingHalfCompoundModalAnalysisAtAStiffness):
    '''PartToPartShearCouplingHalfCompoundModalAnalysisAtAStiffness
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4310.PartToPartShearCouplingHalfModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4310.PartToPartShearCouplingHalfModalAnalysisAtAStiffness))
        return value

    @property
    def component_modal_analysis_at_a_stiffness_load_cases(self) -> 'List[_4310.PartToPartShearCouplingHalfModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysisAtAStiffnessLoadCases, constructor.new(_4310.PartToPartShearCouplingHalfModalAnalysisAtAStiffness))
        return value
