...
class SpringDamperHalfCompoundModalAnalysisAtAStiffness(_4393.CouplingHalfCompoundModalAnalysisAtAStiffness):
    '''SpringDamperHalfCompoundModalAnalysisAtAStiffness
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4330.SpringDamperHalfModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4330.SpringDamperHalfModalAnalysisAtAStiffness))
        return value

    @property
    def component_modal_analysis_at_a_stiffness_load_cases(self) -> 'List[_4330.SpringDamperHalfModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysisAtAStiffnessLoadCases, constructor.new(_4330.SpringDamperHalfModalAnalysisAtAStiffness))
        return value
