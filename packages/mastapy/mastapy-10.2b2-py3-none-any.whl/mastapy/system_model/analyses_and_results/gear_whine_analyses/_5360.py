...
class KlingelnbergCycloPalloidHypoidGearMeshGearWhineAnalysis(_5357.KlingelnbergCycloPalloidConicalGearMeshGearWhineAnalysis):
    '''KlingelnbergCycloPalloidHypoidGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2301.KlingelnbergCycloPalloidHypoidGearMeshSystemDeflection':
