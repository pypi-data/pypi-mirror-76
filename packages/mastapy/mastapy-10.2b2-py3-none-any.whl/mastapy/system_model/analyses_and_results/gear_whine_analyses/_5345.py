...
class GearWhineAnalysis(_6508.CompoundAnalysisCase):
    '''GearWhineAnalysis
    ...
    @property
    def single_mesh_whine_analyses(self) -> 'List[_5523.SingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SingleMeshWhineAnalyses, constructor.new(_5523.SingleMeshWhineAnalysis))
        return value
