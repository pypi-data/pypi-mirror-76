...
class RollingRingAssemblyCompoundGearWhineAnalysis(_5779.SpecialisedAssemblyCompoundGearWhineAnalysis):
    '''RollingRingAssemblyCompoundGearWhineAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5380.RollingRingAssemblyGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5380.RollingRingAssemblyGearWhineAnalysis))
        return value

    @property
    def assembly_gear_whine_analysis_load_cases(self) -> 'List[_5380.RollingRingAssemblyGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyGearWhineAnalysisLoadCases, constructor.new(_5380.RollingRingAssemblyGearWhineAnalysis))
        return value
