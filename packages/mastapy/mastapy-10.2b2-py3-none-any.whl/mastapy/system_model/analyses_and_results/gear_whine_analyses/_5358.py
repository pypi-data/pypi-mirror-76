...
class KlingelnbergCycloPalloidConicalGearSetGearWhineAnalysis(_5307.ConicalGearSetGearWhineAnalysis):
    '''KlingelnbergCycloPalloidConicalGearSetGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2299.KlingelnbergCycloPalloidConicalGearSetSystemDeflection':
