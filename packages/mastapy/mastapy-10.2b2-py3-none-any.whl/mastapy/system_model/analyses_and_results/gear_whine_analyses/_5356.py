...
class KlingelnbergCycloPalloidConicalGearGearWhineAnalysis(_5305.ConicalGearGearWhineAnalysis):
    '''KlingelnbergCycloPalloidConicalGearGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2300.KlingelnbergCycloPalloidConicalGearSystemDeflection':
