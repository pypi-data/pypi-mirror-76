...
class SpringDamperConnectionGearWhineAnalysis(_5310.CouplingConnectionGearWhineAnalysis):
    '''SpringDamperConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2336.SpringDamperConnectionSystemDeflection':
