...
class ExternalCADModelCompoundSingleMeshWhineAnalysis(_5578.ComponentCompoundSingleMeshWhineAnalysis):
    '''ExternalCADModelCompoundSingleMeshWhineAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5478.ExternalCADModelSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5478.ExternalCADModelSingleMeshWhineAnalysis))
        return value

    @property
    def component_single_mesh_whine_analysis_load_cases(self) -> 'List[_5478.ExternalCADModelSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSingleMeshWhineAnalysisLoadCases, constructor.new(_5478.ExternalCADModelSingleMeshWhineAnalysis))
        return value
