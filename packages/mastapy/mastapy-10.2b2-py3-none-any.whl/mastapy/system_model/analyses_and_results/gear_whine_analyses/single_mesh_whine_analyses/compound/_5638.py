...
class RollingRingAssemblyCompoundSingleMeshWhineAnalysis(_5645.SpecialisedAssemblyCompoundSingleMeshWhineAnalysis):
    '''RollingRingAssemblyCompoundSingleMeshWhineAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5516.RollingRingAssemblySingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5516.RollingRingAssemblySingleMeshWhineAnalysis))
        return value

    @property
    def assembly_single_mesh_whine_analysis_load_cases(self) -> 'List[_5516.RollingRingAssemblySingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySingleMeshWhineAnalysisLoadCases, constructor.new(_5516.RollingRingAssemblySingleMeshWhineAnalysis))
        return value
