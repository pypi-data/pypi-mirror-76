...
class ZerolBevelGearMeshCompoundSingleMeshWhineAnalysis(_5570.BevelGearMeshCompoundSingleMeshWhineAnalysis):
    '''ZerolBevelGearMeshCompoundSingleMeshWhineAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5552.ZerolBevelGearMeshSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5552.ZerolBevelGearMeshSingleMeshWhineAnalysis))
        return value

    @property
    def connection_single_mesh_whine_analysis_load_cases(self) -> 'List[_5552.ZerolBevelGearMeshSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSingleMeshWhineAnalysisLoadCases, constructor.new(_5552.ZerolBevelGearMeshSingleMeshWhineAnalysis))
        return value
