...
class RollingRingCompoundSingleMeshWhineAnalysis(_5592.CouplingHalfCompoundSingleMeshWhineAnalysis):
    '''RollingRingCompoundSingleMeshWhineAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5518.RollingRingSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5518.RollingRingSingleMeshWhineAnalysis))
        return value

    @property
    def component_single_mesh_whine_analysis_load_cases(self) -> 'List[_5518.RollingRingSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSingleMeshWhineAnalysisLoadCases, constructor.new(_5518.RollingRingSingleMeshWhineAnalysis))
        return value
