...
class StraightBevelDiffGearMeshGearWhineAnalysis(_5289.BevelGearMeshGearWhineAnalysis):
    '''StraightBevelDiffGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2339.StraightBevelDiffGearMeshSystemDeflection':
