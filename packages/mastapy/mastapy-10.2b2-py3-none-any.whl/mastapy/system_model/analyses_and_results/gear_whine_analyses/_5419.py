...
class ZerolBevelGearMeshGearWhineAnalysis(_5289.BevelGearMeshGearWhineAnalysis):
    '''ZerolBevelGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2365.ZerolBevelGearMeshSystemDeflection':
