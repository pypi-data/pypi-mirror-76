...
class PlanetaryConnectionGearWhineAnalysis(_5386.ShaftToMountableComponentConnectionGearWhineAnalysis):
    '''PlanetaryConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2318.PlanetaryConnectionSystemDeflection':
