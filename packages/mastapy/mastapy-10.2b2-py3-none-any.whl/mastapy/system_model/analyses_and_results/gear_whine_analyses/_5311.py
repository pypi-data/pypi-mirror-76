...
class CouplingGearWhineAnalysis(_5388.SpecialisedAssemblyGearWhineAnalysis):
    '''CouplingGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2268.CouplingSystemDeflection':
