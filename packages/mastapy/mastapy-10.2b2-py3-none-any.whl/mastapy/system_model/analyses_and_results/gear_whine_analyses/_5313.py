...
class CVTBeltConnectionGearWhineAnalysis(_5281.BeltConnectionGearWhineAnalysis):
    '''CVTBeltConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2269.CVTBeltConnectionSystemDeflection':
