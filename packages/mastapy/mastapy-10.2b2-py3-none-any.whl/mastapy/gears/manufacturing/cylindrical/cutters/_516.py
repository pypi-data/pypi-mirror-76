...
class CylindricalGearRealCutterDesign(_509.CylindricalGearAbstractCutterDesign):
    ...
    @property
    def nominal_cutter_drawing(self) -> '_6529.SMTBitmap':
        ...
        return constructor.new(_6529.SMTBitmap)(self.wrapped.NominalCutterDrawing) if self.wrapped.NominalCutterDrawing else None
