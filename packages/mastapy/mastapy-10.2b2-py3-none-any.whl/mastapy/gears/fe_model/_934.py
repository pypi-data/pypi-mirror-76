...
class GearFEModel(_955.GearImplementationDetail):
    ...
    def get_stress_influence_coefficients_from_fe_with_progress(self, flank: '_128.GearFlanks', progress: '_6526.TaskProgress'):
        ''' 'GetStressInfluenceCoefficientsFromFE' is the original name of this method.
    ...
    def calculate_stiffness_from_fe_with_progress(self, progress: '_6526.TaskProgress'):
        ''' 'CalculateStiffnessFromFE' is the original name of this method.
