...
class MastaSettings:
    ...
    @property
    def electric_machine_detail_database(self) -> '_6126.ElectricMachineDetailDatabase':
        ...
        return constructor.new(_6126.ElectricMachineDetailDatabase)(self.wrapped.ElectricMachineDetailDatabase) if self.wrapped.ElectricMachineDetailDatabase else None
    ...
    @property
    def planet_carrier_settings(self) -> '_2032.PlanetCarrierSettings':
        ...
        return constructor.new(_2032.PlanetCarrierSettings)(self.wrapped.PlanetCarrierSettings) if self.wrapped.PlanetCarrierSettings else None
