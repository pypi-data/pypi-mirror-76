...
class CoordinateSystemEditor(_0.APIBase):
    ...
    @property
    def containing_assembly_image(self) -> '_6529.SMTBitmap':
        '''SMTBitmap: 'ContainingAssemblyImage' is the original name of this property.'''

        return constructor.new(_6529.SMTBitmap)(self.wrapped.ContainingAssemblyImage) if self.wrapped.ContainingAssemblyImage else None

    @containing_assembly_image.setter
    def containing_assembly_image(self, value: '_6529.SMTBitmap'):
    ...
    @property
    def root_assembly_image(self) -> '_6529.SMTBitmap':
        '''SMTBitmap: 'RootAssemblyImage' is the original name of this property.'''

        return constructor.new(_6529.SMTBitmap)(self.wrapped.RootAssemblyImage) if self.wrapped.RootAssemblyImage else None

    @root_assembly_image.setter
    def root_assembly_image(self, value: '_6529.SMTBitmap'):
        value = value.wrapped if value else None
