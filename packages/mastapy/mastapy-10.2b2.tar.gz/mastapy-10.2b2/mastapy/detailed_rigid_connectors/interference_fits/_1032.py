...
from mastapy.bearings.tolerances import _1560, _1547, _1553
...
class InterferenceFitHalfDesign(_974.DetailedRigidConnectorHalfDesign):
    ...
    @property
    def tolerance(self) -> '_1560.SupportTolerance':
        ...
        return constructor.new(_1560.SupportTolerance)(self.wrapped.Tolerance) if self.wrapped.Tolerance else None

    @property
    def tolerance_of_type_inner_support_tolerance(self) -> '_1547.InnerSupportTolerance':
        ...
        if _1547.InnerSupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
        ...
        return constructor.new(_1547.InnerSupportTolerance)(self.wrapped.Tolerance) if self.wrapped.Tolerance else None

    @property
    def tolerance_of_type_outer_support_tolerance(self) -> '_1553.OuterSupportTolerance':
        ...
        if _1553.OuterSupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
        ...
        return constructor.new(_1553.OuterSupportTolerance)(self.wrapped.Tolerance) if self.wrapped.Tolerance else None
