...
class KimosBevelHypoidSingleLoadCaseResultsData(_0.APIBase):
    ...
    @property
    def contact_pressure_chart(self) -> '_6529.SMTBitmap':
        ...
        return constructor.new(_6529.SMTBitmap)(self.wrapped.ContactPressureChart) if self.wrapped.ContactPressureChart else None

    @property
    def pinion_root_stress_chart(self) -> '_6529.SMTBitmap':
        ...
        return constructor.new(_6529.SMTBitmap)(self.wrapped.PinionRootStressChart) if self.wrapped.PinionRootStressChart else None

    @property
    def wheel_root_stress_chart(self) -> '_6529.SMTBitmap':
        ...
        return constructor.new(_6529.SMTBitmap)(self.wrapped.WheelRootStressChart) if self.wrapped.WheelRootStressChart else None

    @property
    def sliding_velocity_chart(self) -> '_6529.SMTBitmap':
        ...
        return constructor.new(_6529.SMTBitmap)(self.wrapped.SlidingVelocityChart) if self.wrapped.SlidingVelocityChart else None

    @property
    def flash_temperature_chart(self) -> '_6529.SMTBitmap':
        ...
        return constructor.new(_6529.SMTBitmap)(self.wrapped.FlashTemperatureChart) if self.wrapped.FlashTemperatureChart else None

    @property
    def friction_coefficient_chart(self) -> '_6529.SMTBitmap':
        ...
        return constructor.new(_6529.SMTBitmap)(self.wrapped.FrictionCoefficientChart) if self.wrapped.FrictionCoefficientChart else None

    @property
    def pressure_velocity_pv_chart(self) -> '_6529.SMTBitmap':
        ...
        return constructor.new(_6529.SMTBitmap)(self.wrapped.PressureVelocityPVChart) if self.wrapped.PressureVelocityPVChart else None
