...
class CylindricalGearMeshFEModel(_935.GearMeshFEModel):
    ...
    def stiffness_wrt_contacts_for_with_progress(self, gear: '_934.GearFEModel', flank: '_128.GearFlanks', progress: '_6526.TaskProgress') -> 'List[_614.GearContactStiffness]':
        ''' 'StiffnessWrtContactsFor' is the original name of this method.
