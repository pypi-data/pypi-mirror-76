...
class RollingBearingDatabase(_1350.SQLDatabase['_1536.RollingBearingKey', '_1777.RollingBearing']):
    '''RollingBearingDatabase
    ...
    def search_for_rolling_bearing_with_name_catalog_and_type(self, designation: 'str', catalog: '_1513.BearingCatalog', type_: '_1538.RollingBearingType') -> 'List[_1777.RollingBearing]':
        ...
        catalog = conversion.mp_to_pn_enum(catalog)
        type_ = conversion.mp_to_pn_enum(type_)
        return conversion.pn_to_mp_objects_in_list(self.wrapped.SearchForRollingBearing(designation if designation else None, catalog, type_), constructor.new(_1777.RollingBearing))
    ...
    def search_for_rolling_bearing_with_name_and_catalog(self, designation: 'str', catalog: '_1513.BearingCatalog') -> '_1777.RollingBearing':
        ...
        return constructor.new(_1777.RollingBearing)(method_result) if method_result else None
    ...
    def search_for_rolling_bearing_with_catalog(self, catalog: '_1513.BearingCatalog') -> 'List[_1777.RollingBearing]':
        ...
        catalog = conversion.mp_to_pn_enum(catalog)
        return conversion.pn_to_mp_objects_in_list(self.wrapped.SearchForRollingBearing(catalog), constructor.new(_1777.RollingBearing))
    ...
    def create_key(self, type_: '_1538.RollingBearingType', designation: Optional['str'] = 'None') -> '_1536.RollingBearingKey':
        ...
        return constructor.new(_1536.RollingBearingKey)(method_result) if method_result else None
