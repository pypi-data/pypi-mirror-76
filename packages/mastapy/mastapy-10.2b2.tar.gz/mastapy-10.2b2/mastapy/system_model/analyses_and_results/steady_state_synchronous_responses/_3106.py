...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3107, _3105, _3039
...
class WormGearSetSteadyStateSynchronousResponse(_3039.GearSetSteadyStateSynchronousResponse):
    '''WormGearSetSteadyStateSynchronousResponse
    ...
    @property
    def worm_gears_steady_state_synchronous_response(self) -> 'List[_3107.WormGearSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsSteadyStateSynchronousResponse, constructor.new(_3107.WormGearSteadyStateSynchronousResponse))
        return value

    @property
    def worm_meshes_steady_state_synchronous_response(self) -> 'List[_3105.WormGearMeshSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesSteadyStateSynchronousResponse, constructor.new(_3105.WormGearMeshSteadyStateSynchronousResponse))
        return value
