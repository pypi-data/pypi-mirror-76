...
class CylindricalGearSetLoadCase(_6147.GearSetLoadCase):
    '''CylindricalGearSetLoadCase
    ...
    @property
    def reset_micro_geometry(self) -> '_6192.ResetMicroGeometryOptions':
        ...
        return constructor.new(_6192.ResetMicroGeometryOptions)(value) if value else None

    @reset_micro_geometry.setter
    def reset_micro_geometry(self, value: '_6192.ResetMicroGeometryOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def cylindrical_gears_load_case(self) -> 'List[_6115.CylindricalGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsLoadCase, constructor.new(_6115.CylindricalGearLoadCase))
        return value

    @property
    def cylindrical_meshes_load_case(self) -> 'List[_6117.CylindricalGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesLoadCase, constructor.new(_6117.CylindricalGearMeshLoadCase))
        return value

    def get_harmonic_load_data_for_import(self) -> '_6118.CylindricalGearSetHarmonicLoadData':
        ...
        return constructor.new(_6118.CylindricalGearSetHarmonicLoadData)(method_result) if method_result else None
