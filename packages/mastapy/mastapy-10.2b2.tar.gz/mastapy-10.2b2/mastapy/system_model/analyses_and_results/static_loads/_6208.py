...
from mastapy.system_model.analyses_and_results.load_case_groups import _5256, _5257, _5258
...
class StaticLoadCase(_6069.LoadCase):
    ...
    @property
    def te_set_up_for_dynamic_analyses_options(self) -> '_2228.TESetUpForDynamicAnalysisOptions':
        ...
        return constructor.new(_2228.TESetUpForDynamicAnalysisOptions)(self.wrapped.TESetUpForDynamicAnalysesOptions) if self.wrapped.TESetUpForDynamicAnalysesOptions else None

    @property
    def gear_whine_harmonic_excitation_analysis_options(self) -> '_5347.GearWhineAnalysisOptions':
        ...
        return constructor.new(_5347.GearWhineAnalysisOptions)(self.wrapped.GearWhineHarmonicExcitationAnalysisOptions) if self.wrapped.GearWhineHarmonicExcitationAnalysisOptions else None

    @property
    def clutch_engagements(self) -> 'List[_5256.ClutchEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ClutchEngagements, constructor.new(_5256.ClutchEngagementStatus))
        return value

    @property
    def concept_clutch_engagements(self) -> 'List[_5257.ConceptSynchroGearEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptClutchEngagements, constructor.new(_5257.ConceptSynchroGearEngagementStatus))
        return value

    def duplicate(self, new_design_state_group: '_5258.DesignState', name: Optional['str'] = 'None') -> 'StaticLoadCase':
