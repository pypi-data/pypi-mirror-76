...
from mastapy.system_model.analyses_and_results.static_loads import _6137, _6138, _6147
...
class FaceGearSetLoadCase(_6147.GearSetLoadCase):
    '''FaceGearSetLoadCase
    ...
    @property
    def face_gears_load_case(self) -> 'List[_6137.FaceGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsLoadCase, constructor.new(_6137.FaceGearLoadCase))
        return value

    @property
    def face_meshes_load_case(self) -> 'List[_6138.FaceGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesLoadCase, constructor.new(_6138.FaceGearMeshLoadCase))
        return value
