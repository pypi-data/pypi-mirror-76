...
from mastapy.system_model.analyses_and_results.static_loads import _6122, _6153, _6134
...
class HarmonicLoadDataJMAGImport(_6153.HarmonicLoadDataImportFromMotorPackages['_6134.ElectricMachineHarmonicLoadJMAGImportOptions']):
    '''HarmonicLoadDataJMAGImport
    ...
    @property
    def electric_machine_data_per_speed(self) -> 'List[_6122.DataFromJMAGPerSpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElectricMachineDataPerSpeed, constructor.new(_6122.DataFromJMAGPerSpeed))
        return value
