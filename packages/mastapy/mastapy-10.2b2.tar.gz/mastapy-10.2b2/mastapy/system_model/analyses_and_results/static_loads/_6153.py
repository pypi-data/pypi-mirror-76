...
from mastapy.system_model.analyses_and_results.static_loads import _6156, _6152, _6133
...
class HarmonicLoadDataImportFromMotorPackages(_6152.HarmonicLoadDataImportBase['T'], Generic[T]):
    '''HarmonicLoadDataImportFromMotorPackages
