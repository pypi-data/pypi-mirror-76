...
from mastapy.system_model.analyses_and_results.static_loads import _6176, _6152, _6132
...
class HarmonicLoadDataExcelImport(_6152.HarmonicLoadDataImportBase['_6132.ElectricMachineHarmonicLoadExcelImportOptions']):
    '''HarmonicLoadDataExcelImport
    ...
    @property
    def speeds(self) -> 'List[_6176.NamedSpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Speeds, constructor.new(_6176.NamedSpeed))
        return value
