...
from mastapy.system_model.analyses_and_results.static_loads import _6166, _6167, _6165
...
class KlingelnbergCycloPalloidHypoidGearSetLoadCase(_6165.KlingelnbergCycloPalloidConicalGearSetLoadCase):
    '''KlingelnbergCycloPalloidHypoidGearSetLoadCase
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_load_case(self) -> 'List[_6166.KlingelnbergCycloPalloidHypoidGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidGearsLoadCase, constructor.new(_6166.KlingelnbergCycloPalloidHypoidGearLoadCase))
        return value

    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_load_case(self) -> 'List[_6167.KlingelnbergCycloPalloidHypoidGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidMeshesLoadCase, constructor.new(_6167.KlingelnbergCycloPalloidHypoidGearMeshLoadCase))
        return value
