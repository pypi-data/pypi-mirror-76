...
class DataFromJMAGPerSpeed(_0.APIBase):
    ...
    @property
    def data_per_mean_torque(self) -> 'List[_6121.DataFromJMAGPerMeanTorque]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DataPerMeanTorque, constructor.new(_6121.DataFromJMAGPerMeanTorque))
        return value
