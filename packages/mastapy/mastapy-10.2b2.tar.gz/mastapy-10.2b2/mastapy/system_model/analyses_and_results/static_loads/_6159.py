...
from mastapy.system_model.analyses_and_results.static_loads import _6157, _6158, _6075
...
class HypoidGearSetLoadCase(_6075.AGMAGleasonConicalGearSetLoadCase):
    '''HypoidGearSetLoadCase
    ...
    @property
    def hypoid_gears_load_case(self) -> 'List[_6157.HypoidGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsLoadCase, constructor.new(_6157.HypoidGearLoadCase))
        return value

    @property
    def hypoid_meshes_load_case(self) -> 'List[_6158.HypoidGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesLoadCase, constructor.new(_6158.HypoidGearMeshLoadCase))
        return value
