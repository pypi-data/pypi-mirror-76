...
from mastapy.system_model.analyses_and_results.static_loads import _6188, _6232
...
class PointLoadLoadCase(_6232.VirtualComponentLoadCase):
    '''PointLoadLoadCase
    ...
    def get_harmonic_load_data_for_import(self) -> '_6188.PointLoadHarmonicLoadData':
        ...
        return constructor.new(_6188.PointLoadHarmonicLoadData)(method_result) if method_result else None
