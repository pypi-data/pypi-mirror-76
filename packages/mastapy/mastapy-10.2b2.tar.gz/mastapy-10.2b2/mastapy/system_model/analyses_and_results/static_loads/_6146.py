...
from mastapy.system_model.analyses_and_results.static_loads import _6145, _6150
...
class GearSetHarmonicLoadData(_6150.HarmonicLoadDataBase):
    '''GearSetHarmonicLoadData
    ...
    @property
    def gear_mesh_te_order_type(self) -> '_6145.GearMeshTEOrderType':
        ...
        return constructor.new(_6145.GearMeshTEOrderType)(value) if value else None

    @gear_mesh_te_order_type.setter
    def gear_mesh_te_order_type(self, value: '_6145.GearMeshTEOrderType'):
