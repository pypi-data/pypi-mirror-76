...
from mastapy.system_model.analyses_and_results.static_loads import _6236, _6237, _6088
...
class ZerolBevelGearSetLoadCase(_6088.BevelGearSetLoadCase):
    '''ZerolBevelGearSetLoadCase
    ...
    @property
    def zerol_bevel_gears_load_case(self) -> 'List[_6236.ZerolBevelGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsLoadCase, constructor.new(_6236.ZerolBevelGearLoadCase))
        return value

    @property
    def zerol_bevel_meshes_load_case(self) -> 'List[_6237.ZerolBevelGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesLoadCase, constructor.new(_6237.ZerolBevelGearMeshLoadCase))
        return value
