...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns.compound import _4219
...
class SynchroniserSleeveCompoundModalAnalysesAtSpeeds(_4219.SynchroniserPartCompoundModalAnalysesAtSpeeds):
    '''SynchroniserSleeveCompoundModalAnalysesAtSpeeds
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4099.SynchroniserSleeveModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4099.SynchroniserSleeveModalAnalysesAtSpeeds))
        return value

    @property
    def component_modal_analyses_at_speeds_load_cases(self) -> 'List[_4099.SynchroniserSleeveModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysesAtSpeedsLoadCases, constructor.new(_4099.SynchroniserSleeveModalAnalysesAtSpeeds))
        return value
