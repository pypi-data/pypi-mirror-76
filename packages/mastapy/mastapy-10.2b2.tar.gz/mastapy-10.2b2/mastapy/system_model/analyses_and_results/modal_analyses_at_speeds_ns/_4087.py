...
class StabilityAnalysis(_6521.StaticLoadAnalysisCase):
    '''StabilityAnalysis
    ...
    @property
    def modal_analyses_at_speeds_options(self) -> '_4059.ModalAnalysesAtSpeedsOptions':
        ...
        return constructor.new(_4059.ModalAnalysesAtSpeedsOptions)(self.wrapped.ModalAnalysesAtSpeedsOptions) if self.wrapped.ModalAnalysesAtSpeedsOptions else None
