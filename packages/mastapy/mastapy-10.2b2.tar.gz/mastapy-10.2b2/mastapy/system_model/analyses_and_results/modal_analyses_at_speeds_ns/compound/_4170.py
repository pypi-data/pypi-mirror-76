...
class ImportedFEComponentCompoundModalAnalysesAtSpeeds(_4113.AbstractShaftOrHousingCompoundModalAnalysesAtSpeeds):
    '''ImportedFEComponentCompoundModalAnalysesAtSpeeds
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4046.ImportedFEComponentModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4046.ImportedFEComponentModalAnalysesAtSpeeds))
        return value

    @property
    def component_modal_analyses_at_speeds_load_cases(self) -> 'List[_4046.ImportedFEComponentModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysesAtSpeedsLoadCases, constructor.new(_4046.ImportedFEComponentModalAnalysesAtSpeeds))
        return value
