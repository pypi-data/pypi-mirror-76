...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _4087, _3992
...
class RootAssemblyModalAnalysesAtSpeeds(_3992.AssemblyModalAnalysesAtSpeeds):
    '''RootAssemblyModalAnalysesAtSpeeds
    ...
    @property
    def modal_analyses_at_speeds_inputs(self) -> '_4087.StabilityAnalysis':
        ...
        return constructor.new(_4087.StabilityAnalysis)(self.wrapped.ModalAnalysesAtSpeedsInputs) if self.wrapped.ModalAnalysesAtSpeedsInputs else None
