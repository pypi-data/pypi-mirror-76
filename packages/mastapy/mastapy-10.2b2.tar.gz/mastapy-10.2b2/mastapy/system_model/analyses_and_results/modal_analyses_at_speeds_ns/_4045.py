...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _4044, _4043, _3991
...
class HypoidGearSetModalAnalysesAtSpeeds(_3991.AGMAGleasonConicalGearSetModalAnalysesAtSpeeds):
    '''HypoidGearSetModalAnalysesAtSpeeds
    ...
    @property
    def hypoid_gears_modal_analyses_at_speeds(self) -> 'List[_4044.HypoidGearModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsModalAnalysesAtSpeeds, constructor.new(_4044.HypoidGearModalAnalysesAtSpeeds))
        return value

    @property
    def hypoid_meshes_modal_analyses_at_speeds(self) -> 'List[_4043.HypoidGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesModalAnalysesAtSpeeds, constructor.new(_4043.HypoidGearMeshModalAnalysesAtSpeeds))
        return value
