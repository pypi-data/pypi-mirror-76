...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _4015, _4014, _4041
...
class ConceptGearSetModalAnalysesAtSpeeds(_4041.GearSetModalAnalysesAtSpeeds):
    '''ConceptGearSetModalAnalysesAtSpeeds
    ...
    @property
    def concept_gears_modal_analyses_at_speeds(self) -> 'List[_4015.ConceptGearModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsModalAnalysesAtSpeeds, constructor.new(_4015.ConceptGearModalAnalysesAtSpeeds))
        return value

    @property
    def concept_meshes_modal_analyses_at_speeds(self) -> 'List[_4014.ConceptGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesModalAnalysesAtSpeeds, constructor.new(_4014.ConceptGearMeshModalAnalysesAtSpeeds))
        return value
