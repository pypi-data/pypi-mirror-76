...
class SpringDamperConnectionCompoundModalAnalysesAtSpeeds(_4148.CouplingConnectionCompoundModalAnalysesAtSpeeds):
    '''SpringDamperConnectionCompoundModalAnalysesAtSpeeds
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4084.SpringDamperConnectionModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4084.SpringDamperConnectionModalAnalysesAtSpeeds))
        return value

    @property
    def connection_modal_analyses_at_speeds_load_cases(self) -> 'List[_4084.SpringDamperConnectionModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionModalAnalysesAtSpeedsLoadCases, constructor.new(_4084.SpringDamperConnectionModalAnalysesAtSpeeds))
        return value
