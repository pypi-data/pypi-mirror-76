...
class KlingelnbergCycloPalloidHypoidGearMeshCompoundModalAnalysesAtSpeeds(_4173.KlingelnbergCycloPalloidConicalGearMeshCompoundModalAnalysesAtSpeeds):
    '''KlingelnbergCycloPalloidHypoidGearMeshCompoundModalAnalysesAtSpeeds
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4051.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4051.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysesAtSpeeds))
        return value

    @property
    def connection_modal_analyses_at_speeds_load_cases(self) -> 'List[_4051.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionModalAnalysesAtSpeedsLoadCases, constructor.new(_4051.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysesAtSpeeds))
        return value
