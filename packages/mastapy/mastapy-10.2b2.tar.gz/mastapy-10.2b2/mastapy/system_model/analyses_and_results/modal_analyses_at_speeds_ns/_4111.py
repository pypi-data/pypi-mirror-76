...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _4110, _4109, _4003
...
class ZerolBevelGearSetModalAnalysesAtSpeeds(_4003.BevelGearSetModalAnalysesAtSpeeds):
    '''ZerolBevelGearSetModalAnalysesAtSpeeds
    ...
    @property
    def zerol_bevel_gears_modal_analyses_at_speeds(self) -> 'List[_4110.ZerolBevelGearModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsModalAnalysesAtSpeeds, constructor.new(_4110.ZerolBevelGearModalAnalysesAtSpeeds))
        return value

    @property
    def zerol_bevel_meshes_modal_analyses_at_speeds(self) -> 'List[_4109.ZerolBevelGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesModalAnalysesAtSpeeds, constructor.new(_4109.ZerolBevelGearMeshModalAnalysesAtSpeeds))
        return value
