...
class ConnectionDynamicAnalysis(_6511.ConnectionFEAnalysis):
    '''ConnectionDynamicAnalysis
    ...
    @property
    def dynamic_analysis(self) -> '_5865.DynamicAnalysis':
        ...
        return constructor.new(_5865.DynamicAnalysis)(self.wrapped.DynamicAnalysis) if self.wrapped.DynamicAnalysis else None
