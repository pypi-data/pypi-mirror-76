...
class FlexiblePinAssemblyCompoundDynamicAnalysis(_6032.SpecialisedAssemblyCompoundDynamicAnalysis):
    '''FlexiblePinAssemblyCompoundDynamicAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5871.FlexiblePinAssemblyDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5871.FlexiblePinAssemblyDynamicAnalysis))
        return value

    @property
    def assembly_dynamic_analysis_load_cases(self) -> 'List[_5871.FlexiblePinAssemblyDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyDynamicAnalysisLoadCases, constructor.new(_5871.FlexiblePinAssemblyDynamicAnalysis))
        return value
