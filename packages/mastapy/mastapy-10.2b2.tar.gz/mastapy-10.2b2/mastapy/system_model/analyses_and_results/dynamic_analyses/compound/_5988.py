...
class ExternalCADModelCompoundDynamicAnalysis(_5965.ComponentCompoundDynamicAnalysis):
    '''ExternalCADModelCompoundDynamicAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5867.ExternalCADModelDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5867.ExternalCADModelDynamicAnalysis))
        return value

    @property
    def component_dynamic_analysis_load_cases(self) -> 'List[_5867.ExternalCADModelDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentDynamicAnalysisLoadCases, constructor.new(_5867.ExternalCADModelDynamicAnalysis))
        return value
