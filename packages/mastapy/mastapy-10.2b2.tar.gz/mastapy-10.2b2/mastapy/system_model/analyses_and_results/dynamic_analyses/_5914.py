...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5912, _5913, _5835
...
class SpiralBevelGearSetDynamicAnalysis(_5835.BevelGearSetDynamicAnalysis):
    '''SpiralBevelGearSetDynamicAnalysis
    ...
    @property
    def spiral_bevel_gears_dynamic_analysis(self) -> 'List[_5912.SpiralBevelGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsDynamicAnalysis, constructor.new(_5912.SpiralBevelGearDynamicAnalysis))
        return value

    @property
    def spiral_bevel_meshes_dynamic_analysis(self) -> 'List[_5913.SpiralBevelGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesDynamicAnalysis, constructor.new(_5913.SpiralBevelGearMeshDynamicAnalysis))
        return value
