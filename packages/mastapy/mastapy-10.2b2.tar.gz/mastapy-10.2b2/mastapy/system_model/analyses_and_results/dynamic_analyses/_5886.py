...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5884, _5885, _5883
...
class KlingelnbergCycloPalloidHypoidGearSetDynamicAnalysis(_5883.KlingelnbergCycloPalloidConicalGearSetDynamicAnalysis):
    '''KlingelnbergCycloPalloidHypoidGearSetDynamicAnalysis
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_dynamic_analysis(self) -> 'List[_5884.KlingelnbergCycloPalloidHypoidGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidGearsDynamicAnalysis, constructor.new(_5884.KlingelnbergCycloPalloidHypoidGearDynamicAnalysis))
        return value

    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_dynamic_analysis(self) -> 'List[_5885.KlingelnbergCycloPalloidHypoidGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidMeshesDynamicAnalysis, constructor.new(_5885.KlingelnbergCycloPalloidHypoidGearMeshDynamicAnalysis))
        return value
