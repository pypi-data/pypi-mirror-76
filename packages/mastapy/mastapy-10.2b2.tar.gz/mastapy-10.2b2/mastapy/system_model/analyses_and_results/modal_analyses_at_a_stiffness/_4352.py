...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4351, _4350, _4287
...
class WormGearSetModalAnalysisAtAStiffness(_4287.GearSetModalAnalysisAtAStiffness):
    '''WormGearSetModalAnalysisAtAStiffness
    ...
    @property
    def worm_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4351.WormGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsModalAnalysisAtAStiffness, constructor.new(_4351.WormGearModalAnalysisAtAStiffness))
        return value

    @property
    def worm_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4350.WormGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesModalAnalysisAtAStiffness, constructor.new(_4350.WormGearMeshModalAnalysisAtAStiffness))
        return value
