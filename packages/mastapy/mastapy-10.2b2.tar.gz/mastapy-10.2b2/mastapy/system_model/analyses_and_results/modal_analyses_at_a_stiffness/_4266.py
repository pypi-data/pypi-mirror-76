...
class ConnectionModalAnalysisAtAStiffness(_6512.ConnectionStaticLoadAnalysisCase):
    '''ConnectionModalAnalysisAtAStiffness
    ...
    @property
    def modal_analysis_at_a_stiffness(self) -> '_4305.ModalAnalysisAtAStiffness':
        ...
        return constructor.new(_4305.ModalAnalysisAtAStiffness)(self.wrapped.ModalAnalysisAtAStiffness) if self.wrapped.ModalAnalysisAtAStiffness else None
