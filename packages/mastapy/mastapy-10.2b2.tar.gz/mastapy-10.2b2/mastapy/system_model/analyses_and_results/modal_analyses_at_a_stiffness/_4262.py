...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4261, _4260, _4287
...
class ConceptGearSetModalAnalysisAtAStiffness(_4287.GearSetModalAnalysisAtAStiffness):
    '''ConceptGearSetModalAnalysisAtAStiffness
    ...
    @property
    def concept_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4261.ConceptGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsModalAnalysisAtAStiffness, constructor.new(_4261.ConceptGearModalAnalysisAtAStiffness))
        return value

    @property
    def concept_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4260.ConceptGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesModalAnalysisAtAStiffness, constructor.new(_4260.ConceptGearMeshModalAnalysisAtAStiffness))
        return value
