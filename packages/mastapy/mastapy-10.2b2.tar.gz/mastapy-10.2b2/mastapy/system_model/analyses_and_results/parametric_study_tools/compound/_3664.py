...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _3662, _3663, _3674
...
class CylindricalGearSetCompoundParametricStudyTool(_3674.GearSetCompoundParametricStudyTool):
    '''CylindricalGearSetCompoundParametricStudyTool
    ...
    @property
    def cylindrical_gears_compound_parametric_study_tool(self) -> 'List[_3662.CylindricalGearCompoundParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsCompoundParametricStudyTool, constructor.new(_3662.CylindricalGearCompoundParametricStudyTool))
        return value

    @property
    def cylindrical_meshes_compound_parametric_study_tool(self) -> 'List[_3663.CylindricalGearMeshCompoundParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesCompoundParametricStudyTool, constructor.new(_3663.CylindricalGearMeshCompoundParametricStudyTool))
        return value

    @property
    def load_case_analyses_ready(self) -> 'List[_3527.CylindricalGearSetParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3527.CylindricalGearSetParametricStudyTool))
        return value

    @property
    def assembly_parametric_study_tool_load_cases(self) -> 'List[_3527.CylindricalGearSetParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyParametricStudyToolLoadCases, constructor.new(_3527.CylindricalGearSetParametricStudyTool))
        return value
