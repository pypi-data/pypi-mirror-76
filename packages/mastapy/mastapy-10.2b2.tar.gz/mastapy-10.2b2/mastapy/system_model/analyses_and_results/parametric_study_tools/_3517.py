...
class ConnectionParametricStudyTool(_6509.ConnectionAnalysisCase):
    '''ConnectionParametricStudyTool
    ...
    @property
    def parametric_study_tool(self) -> '_3569.ParametricStudyTool':
        ...
        return constructor.new(_3569.ParametricStudyTool)(self.wrapped.ParametricStudyTool) if self.wrapped.ParametricStudyTool else None
