...
class KlingelnbergCycloPalloidHypoidGearMeshCompoundParametricStudyTool(_3682.KlingelnbergCycloPalloidConicalGearMeshCompoundParametricStudyTool):
    '''KlingelnbergCycloPalloidHypoidGearMeshCompoundParametricStudyTool
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3553.KlingelnbergCycloPalloidHypoidGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3553.KlingelnbergCycloPalloidHypoidGearMeshParametricStudyTool))
        return value

    @property
    def connection_parametric_study_tool_load_cases(self) -> 'List[_3553.KlingelnbergCycloPalloidHypoidGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionParametricStudyToolLoadCases, constructor.new(_3553.KlingelnbergCycloPalloidHypoidGearMeshParametricStudyTool))
        return value
