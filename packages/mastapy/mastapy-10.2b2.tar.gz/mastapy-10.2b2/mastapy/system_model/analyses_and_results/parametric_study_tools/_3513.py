...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3512, _3511, _3543
...
class ConceptGearSetParametricStudyTool(_3543.GearSetParametricStudyTool):
    '''ConceptGearSetParametricStudyTool
    ...
    @property
    def concept_gears_parametric_study_tool(self) -> 'List[_3512.ConceptGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsParametricStudyTool, constructor.new(_3512.ConceptGearParametricStudyTool))
        return value

    @property
    def concept_meshes_parametric_study_tool(self) -> 'List[_3511.ConceptGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesParametricStudyTool, constructor.new(_3511.ConceptGearMeshParametricStudyTool))
        return value
