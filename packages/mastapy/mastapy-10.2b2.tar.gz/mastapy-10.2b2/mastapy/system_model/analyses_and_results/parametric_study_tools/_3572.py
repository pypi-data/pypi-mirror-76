...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3564, _3561
...
class ParametricStudyVariable(_2199.AnalysisCaseVariable):
    '''ParametricStudyVariable
    ...
    @property
    def dimension(self) -> '_3564.ParametricStudyDimension':
        ...
        return constructor.new(_3564.ParametricStudyDimension)(value) if value else None

    @dimension.setter
    def dimension(self, value: '_3564.ParametricStudyDimension'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.Dimension = value

    @property
    def distribution(self) -> '_3561.MonteCarloDistribution':
        ...
        return constructor.new(_3561.MonteCarloDistribution)(value) if value else None

    @distribution.setter
    def distribution(self, value: '_3561.MonteCarloDistribution'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
