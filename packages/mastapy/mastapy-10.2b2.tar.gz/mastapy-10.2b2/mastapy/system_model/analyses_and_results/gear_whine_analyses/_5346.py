...
class GearWhineAnalysisFEExportOptions(_0.APIBase):
    ...
    @property
    def analysis_options(self) -> '_5347.GearWhineAnalysisOptions':
        ...
        return constructor.new(_5347.GearWhineAnalysisOptions)(self.wrapped.AnalysisOptions) if self.wrapped.AnalysisOptions else None
