...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5302, _5303, _5344
...
class ConceptGearSetGearWhineAnalysis(_5344.GearSetGearWhineAnalysis):
    '''ConceptGearSetGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2258.ConceptGearSetSystemDeflection':
    ...
    @property
    def gears_gear_whine_analysis(self) -> 'List[_5302.ConceptGearGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsGearWhineAnalysis, constructor.new(_5302.ConceptGearGearWhineAnalysis))
        return value

    @property
    def concept_gears_gear_whine_analysis(self) -> 'List[_5302.ConceptGearGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsGearWhineAnalysis, constructor.new(_5302.ConceptGearGearWhineAnalysis))
        return value

    @property
    def meshes_gear_whine_analysis(self) -> 'List[_5303.ConceptGearMeshGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesGearWhineAnalysis, constructor.new(_5303.ConceptGearMeshGearWhineAnalysis))
        return value

    @property
    def concept_meshes_gear_whine_analysis(self) -> 'List[_5303.ConceptGearMeshGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesGearWhineAnalysis, constructor.new(_5303.ConceptGearMeshGearWhineAnalysis))
        return value
