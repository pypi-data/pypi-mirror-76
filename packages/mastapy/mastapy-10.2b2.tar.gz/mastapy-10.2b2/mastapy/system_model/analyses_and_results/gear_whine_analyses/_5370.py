...
class PartToPartShearCouplingConnectionGearWhineAnalysis(_5310.CouplingConnectionGearWhineAnalysis):
    '''PartToPartShearCouplingConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2315.PartToPartShearCouplingConnectionSystemDeflection':
