...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5389, _5338
...
class GearWhineAnalysisOptions(_0.APIBase):
    ...
    @property
    def excitation_selection(self) -> '_5425.ExcitationSourceSelectionGroup':
        ...
        return constructor.new(_5425.ExcitationSourceSelectionGroup)(self.wrapped.ExcitationSelection) if self.wrapped.ExcitationSelection else None
