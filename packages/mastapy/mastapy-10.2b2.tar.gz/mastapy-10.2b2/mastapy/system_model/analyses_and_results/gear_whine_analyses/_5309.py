...
class ConnectorGearWhineAnalysis(_5367.MountableComponentGearWhineAnalysis):
    '''ConnectorGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2265.ConnectorSystemDeflection':
