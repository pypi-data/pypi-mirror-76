...
class KlingelnbergCycloPalloidSpiralBevelGearMeshGearWhineAnalysis(_5357.KlingelnbergCycloPalloidConicalGearMeshGearWhineAnalysis):
    '''KlingelnbergCycloPalloidSpiralBevelGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2304.KlingelnbergCycloPalloidSpiralBevelGearMeshSystemDeflection':
