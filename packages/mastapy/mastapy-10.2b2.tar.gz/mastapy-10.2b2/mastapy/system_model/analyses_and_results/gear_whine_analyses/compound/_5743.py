...
class GuideDxfModelCompoundGearWhineAnalysis(_5712.ComponentCompoundGearWhineAnalysis):
    '''GuideDxfModelCompoundGearWhineAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5349.GuideDxfModelGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5349.GuideDxfModelGearWhineAnalysis))
        return value

    @property
    def component_gear_whine_analysis_load_cases(self) -> 'List[_5349.GuideDxfModelGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentGearWhineAnalysisLoadCases, constructor.new(_5349.GuideDxfModelGearWhineAnalysis))
        return value
