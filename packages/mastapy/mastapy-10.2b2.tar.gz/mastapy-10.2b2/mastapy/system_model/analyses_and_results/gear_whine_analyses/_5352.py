...
class HypoidGearMeshGearWhineAnalysis(_5277.AGMAGleasonConicalGearMeshGearWhineAnalysis):
    '''HypoidGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2293.HypoidGearMeshSystemDeflection':
