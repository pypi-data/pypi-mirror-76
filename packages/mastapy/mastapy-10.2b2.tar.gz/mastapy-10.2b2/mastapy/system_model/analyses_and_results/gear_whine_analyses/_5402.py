...
class StraightBevelPlanetGearGearWhineAnalysis(_5396.StraightBevelDiffGearGearWhineAnalysis):
    '''StraightBevelPlanetGearGearWhineAnalysis
    ...
    @property
    def component_design(self) -> '_2109.StraightBevelPlanetGear':
    ...
    @property
    def system_deflection_results(self) -> '_2345.StraightBevelPlanetGearSystemDeflection':
