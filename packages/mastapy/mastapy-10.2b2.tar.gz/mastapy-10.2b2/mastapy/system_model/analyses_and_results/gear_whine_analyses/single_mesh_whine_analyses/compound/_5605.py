...
class FlexiblePinAssemblyCompoundSingleMeshWhineAnalysis(_5645.SpecialisedAssemblyCompoundSingleMeshWhineAnalysis):
    '''FlexiblePinAssemblyCompoundSingleMeshWhineAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5482.FlexiblePinAssemblySingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5482.FlexiblePinAssemblySingleMeshWhineAnalysis))
        return value

    @property
    def assembly_single_mesh_whine_analysis_load_cases(self) -> 'List[_5482.FlexiblePinAssemblySingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySingleMeshWhineAnalysisLoadCases, constructor.new(_5482.FlexiblePinAssemblySingleMeshWhineAnalysis))
        return value
