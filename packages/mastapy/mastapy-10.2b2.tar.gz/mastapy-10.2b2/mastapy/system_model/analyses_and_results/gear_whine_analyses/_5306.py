...
class ConicalGearMeshGearWhineAnalysis(_5341.GearMeshGearWhineAnalysis):
    '''ConicalGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2261.ConicalGearMeshSystemDeflection':
