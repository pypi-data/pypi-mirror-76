...
class MeasurementComponentGearWhineAnalysis(_5414.VirtualComponentGearWhineAnalysis):
    '''MeasurementComponentGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2309.MeasurementComponentSystemDeflection':
