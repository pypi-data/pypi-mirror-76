...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _5741
...
class CylindricalGearMeshCompoundGearWhineAnalysis(_5741.GearMeshCompoundGearWhineAnalysis):
    '''CylindricalGearMeshCompoundGearWhineAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5317.CylindricalGearMeshGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5317.CylindricalGearMeshGearWhineAnalysis))
        return value

    @property
    def connection_gear_whine_analysis_load_cases(self) -> 'List[_5317.CylindricalGearMeshGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionGearWhineAnalysisLoadCases, constructor.new(_5317.CylindricalGearMeshGearWhineAnalysis))
        return value
