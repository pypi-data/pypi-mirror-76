...
class SynchroniserHalfGearWhineAnalysis(_5406.SynchroniserPartGearWhineAnalysis):
    '''SynchroniserHalfGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2347.SynchroniserHalfSystemDeflection':
