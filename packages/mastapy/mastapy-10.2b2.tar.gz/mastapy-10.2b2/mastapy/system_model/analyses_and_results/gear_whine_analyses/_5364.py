...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5362, _5363, _5358
...
class KlingelnbergCycloPalloidSpiralBevelGearSetGearWhineAnalysis(_5358.KlingelnbergCycloPalloidConicalGearSetGearWhineAnalysis):
    '''KlingelnbergCycloPalloidSpiralBevelGearSetGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2305.KlingelnbergCycloPalloidSpiralBevelGearSetSystemDeflection':
    ...
    @property
    def gears_gear_whine_analysis(self) -> 'List[_5362.KlingelnbergCycloPalloidSpiralBevelGearGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsGearWhineAnalysis, constructor.new(_5362.KlingelnbergCycloPalloidSpiralBevelGearGearWhineAnalysis))
        return value

    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_gear_whine_analysis(self) -> 'List[_5362.KlingelnbergCycloPalloidSpiralBevelGearGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidSpiralBevelGearsGearWhineAnalysis, constructor.new(_5362.KlingelnbergCycloPalloidSpiralBevelGearGearWhineAnalysis))
        return value

    @property
    def meshes_gear_whine_analysis(self) -> 'List[_5363.KlingelnbergCycloPalloidSpiralBevelGearMeshGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesGearWhineAnalysis, constructor.new(_5363.KlingelnbergCycloPalloidSpiralBevelGearMeshGearWhineAnalysis))
        return value

    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_gear_whine_analysis(self) -> 'List[_5363.KlingelnbergCycloPalloidSpiralBevelGearMeshGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidSpiralBevelMeshesGearWhineAnalysis, constructor.new(_5363.KlingelnbergCycloPalloidSpiralBevelGearMeshGearWhineAnalysis))
        return value
