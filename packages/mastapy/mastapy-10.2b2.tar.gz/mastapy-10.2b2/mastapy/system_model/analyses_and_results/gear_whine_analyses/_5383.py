...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5345, _5279
...
class RootAssemblyGearWhineAnalysis(_5279.AssemblyGearWhineAnalysis):
    '''RootAssemblyGearWhineAnalysis
    ...
    @property
    def gear_whine_analysis_inputs(self) -> '_5345.GearWhineAnalysis':
        ...
        return constructor.new(_5345.GearWhineAnalysis)(self.wrapped.GearWhineAnalysisInputs) if self.wrapped.GearWhineAnalysisInputs else None
