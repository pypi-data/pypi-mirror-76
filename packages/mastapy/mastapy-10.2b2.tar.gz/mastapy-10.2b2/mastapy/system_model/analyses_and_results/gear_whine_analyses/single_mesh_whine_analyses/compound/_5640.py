...
class RollingRingConnectionCompoundSingleMeshWhineAnalysis(_5614.InterMountableComponentConnectionCompoundSingleMeshWhineAnalysis):
    '''RollingRingConnectionCompoundSingleMeshWhineAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5517.RollingRingConnectionSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5517.RollingRingConnectionSingleMeshWhineAnalysis))
        return value

    @property
    def connection_single_mesh_whine_analysis_load_cases(self) -> 'List[_5517.RollingRingConnectionSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSingleMeshWhineAnalysisLoadCases, constructor.new(_5517.RollingRingConnectionSingleMeshWhineAnalysis))
        return value
