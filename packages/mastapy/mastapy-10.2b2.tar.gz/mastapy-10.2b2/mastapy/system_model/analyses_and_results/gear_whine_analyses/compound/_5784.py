...
class SpringDamperConnectionCompoundGearWhineAnalysis(_5725.CouplingConnectionCompoundGearWhineAnalysis):
    '''SpringDamperConnectionCompoundGearWhineAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5393.SpringDamperConnectionGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5393.SpringDamperConnectionGearWhineAnalysis))
        return value

    @property
    def connection_gear_whine_analysis_load_cases(self) -> 'List[_5393.SpringDamperConnectionGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionGearWhineAnalysisLoadCases, constructor.new(_5393.SpringDamperConnectionGearWhineAnalysis))
        return value
