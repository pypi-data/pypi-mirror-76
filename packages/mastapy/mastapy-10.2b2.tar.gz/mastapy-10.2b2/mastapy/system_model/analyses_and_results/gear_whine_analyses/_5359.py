...
class KlingelnbergCycloPalloidHypoidGearGearWhineAnalysis(_5356.KlingelnbergCycloPalloidConicalGearGearWhineAnalysis):
    '''KlingelnbergCycloPalloidHypoidGearGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2303.KlingelnbergCycloPalloidHypoidGearSystemDeflection':
