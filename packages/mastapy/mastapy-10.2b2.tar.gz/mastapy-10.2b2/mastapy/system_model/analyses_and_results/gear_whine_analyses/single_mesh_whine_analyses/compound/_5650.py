...
class SpringDamperConnectionCompoundSingleMeshWhineAnalysis(_5591.CouplingConnectionCompoundSingleMeshWhineAnalysis):
    '''SpringDamperConnectionCompoundSingleMeshWhineAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5528.SpringDamperConnectionSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5528.SpringDamperConnectionSingleMeshWhineAnalysis))
        return value

    @property
    def connection_single_mesh_whine_analysis_load_cases(self) -> 'List[_5528.SpringDamperConnectionSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSingleMeshWhineAnalysisLoadCases, constructor.new(_5528.SpringDamperConnectionSingleMeshWhineAnalysis))
        return value
