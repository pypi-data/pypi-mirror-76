...
class RollingRingConnectionGearWhineAnalysis(_5355.InterMountableComponentConnectionGearWhineAnalysis):
    '''RollingRingConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2324.RollingRingConnectionSystemDeflection':
