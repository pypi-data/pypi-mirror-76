...
class ShaftGearWhineAnalysis(_5275.AbstractShaftOrHousingGearWhineAnalysis):
    '''ShaftGearWhineAnalysis
    ...
    @property
    def coupled_modal_analysis(self) -> '_4815.ShaftModalAnalysis':
    ...
    @property
    def system_deflection_results(self) -> '_2330.ShaftSystemDeflection':
