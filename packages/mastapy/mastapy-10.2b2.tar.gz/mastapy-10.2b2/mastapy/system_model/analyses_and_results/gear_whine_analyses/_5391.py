...
class SpiralBevelGearMeshGearWhineAnalysis(_5289.BevelGearMeshGearWhineAnalysis):
    '''SpiralBevelGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2333.SpiralBevelGearMeshSystemDeflection':
