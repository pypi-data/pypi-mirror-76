...
class FlexiblePinAssemblyGearWhineAnalysis(_5388.SpecialisedAssemblyGearWhineAnalysis):
    '''FlexiblePinAssemblyGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2288.FlexiblePinAssemblySystemDeflection':
