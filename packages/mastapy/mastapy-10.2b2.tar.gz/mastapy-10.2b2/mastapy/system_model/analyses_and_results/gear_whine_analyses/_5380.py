...
class RollingRingAssemblyGearWhineAnalysis(_5388.SpecialisedAssemblyGearWhineAnalysis):
    '''RollingRingAssemblyGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2323.RollingRingAssemblySystemDeflection':
