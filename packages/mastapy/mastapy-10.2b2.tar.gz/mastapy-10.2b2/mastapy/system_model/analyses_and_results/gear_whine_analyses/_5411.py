...
class TorqueConverterTurbineGearWhineAnalysis(_5312.CouplingHalfGearWhineAnalysis):
    '''TorqueConverterTurbineGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2357.TorqueConverterTurbineSystemDeflection':
