...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.single_mesh_whine_analyses import _5523, _5437
...
class RootAssemblySingleMeshWhineAnalysis(_5437.AssemblySingleMeshWhineAnalysis):
    '''RootAssemblySingleMeshWhineAnalysis
    ...
    @property
    def single_mesh_whine_analysis_inputs(self) -> '_5523.SingleMeshWhineAnalysis':
        ...
        return constructor.new(_5523.SingleMeshWhineAnalysis)(self.wrapped.SingleMeshWhineAnalysisInputs) if self.wrapped.SingleMeshWhineAnalysisInputs else None
