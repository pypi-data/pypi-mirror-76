...
class StraightBevelGearCompoundSteadyStateSynchronousResponseOnAShaft(_2636.BevelGearCompoundSteadyStateSynchronousResponseOnAShaft):
    '''StraightBevelGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_design(self) -> '_2107.StraightBevelGear':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2603.StraightBevelGearSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2603.StraightBevelGearSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def component_steady_state_synchronous_response_on_a_shaft_load_cases(self) -> 'List[_2603.StraightBevelGearSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSteadyStateSynchronousResponseOnAShaftLoadCases, constructor.new(_2603.StraightBevelGearSteadyStateSynchronousResponseOnAShaft))
        return value
