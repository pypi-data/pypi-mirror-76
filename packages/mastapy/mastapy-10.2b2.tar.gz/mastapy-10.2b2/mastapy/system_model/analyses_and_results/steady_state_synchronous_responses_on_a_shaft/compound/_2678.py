...
class HypoidGearMeshCompoundSteadyStateSynchronousResponseOnAShaft(_2625.AGMAGleasonConicalGearMeshCompoundSteadyStateSynchronousResponseOnAShaft):
    '''HypoidGearMeshCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2555.HypoidGearMeshSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2555.HypoidGearMeshSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def connection_steady_state_synchronous_response_on_a_shaft_load_cases(self) -> 'List[_2555.HypoidGearMeshSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSteadyStateSynchronousResponseOnAShaftLoadCases, constructor.new(_2555.HypoidGearMeshSteadyStateSynchronousResponseOnAShaft))
        return value
