...
class PartToPartShearCouplingCompoundSteadyStateSynchronousResponseOnAShaft(_2657.CouplingCompoundSteadyStateSynchronousResponseOnAShaft):
    '''PartToPartShearCouplingCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_design(self) -> '_2143.PartToPartShearCoupling':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2576.PartToPartShearCouplingSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2576.PartToPartShearCouplingSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def assembly_steady_state_synchronous_response_on_a_shaft_load_cases(self) -> 'List[_2576.PartToPartShearCouplingSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySteadyStateSynchronousResponseOnAShaftLoadCases, constructor.new(_2576.PartToPartShearCouplingSteadyStateSynchronousResponseOnAShaft))
        return value
