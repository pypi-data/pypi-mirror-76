...
class RollingRingCompoundSteadyStateSynchronousResponseOnAShaft(_2659.CouplingHalfCompoundSteadyStateSynchronousResponseOnAShaft):
    '''RollingRingCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_design(self) -> '_2151.RollingRing':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2585.RollingRingSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2585.RollingRingSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def component_steady_state_synchronous_response_on_a_shaft_load_cases(self) -> 'List[_2585.RollingRingSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSteadyStateSynchronousResponseOnAShaftLoadCases, constructor.new(_2585.RollingRingSteadyStateSynchronousResponseOnAShaft))
        return value
