...
class TorqueConverterAdvancedSystemDeflection(_6295.CouplingAdvancedSystemDeflection):
    '''TorqueConverterAdvancedSystemDeflection
    ...
    @property
    def assembly_load_case(self) -> '_6224.TorqueConverterLoadCase':
        ...
        return constructor.new(_6224.TorqueConverterLoadCase)(self.wrapped.AssemblyLoadCase) if self.wrapped.AssemblyLoadCase else None

    @property
    def assembly_system_deflection_results(self) -> 'List[_2356.TorqueConverterSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2356.TorqueConverterSystemDeflection))
        return value
