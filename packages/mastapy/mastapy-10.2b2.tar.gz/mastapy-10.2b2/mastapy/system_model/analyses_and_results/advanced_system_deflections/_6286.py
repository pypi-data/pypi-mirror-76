...
class ConceptGearAdvancedSystemDeflection(_6312.GearAdvancedSystemDeflection):
    '''ConceptGearAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2259.ConceptGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2259.ConceptGearSystemDeflection))
        return value
