...
class RollingRingAdvancedSystemDeflection(_6297.CouplingHalfAdvancedSystemDeflection):
    '''RollingRingAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_6195.RollingRingLoadCase':
        ...
        return constructor.new(_6195.RollingRingLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2325.RollingRingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2325.RollingRingSystemDeflection))
        return value
