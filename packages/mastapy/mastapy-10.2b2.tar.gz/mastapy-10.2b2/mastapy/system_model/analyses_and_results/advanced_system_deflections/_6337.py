...
class PartToPartShearCouplingConnectionAdvancedSystemDeflection(_6296.CouplingConnectionAdvancedSystemDeflection):
    '''PartToPartShearCouplingConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_6180.PartToPartShearCouplingConnectionLoadCase':
        ...
        return constructor.new(_6180.PartToPartShearCouplingConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def connection_system_deflection_results(self) -> 'List[_2315.PartToPartShearCouplingConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2315.PartToPartShearCouplingConnectionSystemDeflection))
        return value
