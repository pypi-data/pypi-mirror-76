...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6258, _6264
...
class RootAssemblyAdvancedSystemDeflection(_6264.AssemblyAdvancedSystemDeflection):
    '''RootAssemblyAdvancedSystemDeflection
    ...
    @property
    def advanced_system_deflection_inputs(self) -> '_6258.AdvancedSystemDeflection':
        ...
        return constructor.new(_6258.AdvancedSystemDeflection)(self.wrapped.AdvancedSystemDeflectionInputs) if self.wrapped.AdvancedSystemDeflectionInputs else None
