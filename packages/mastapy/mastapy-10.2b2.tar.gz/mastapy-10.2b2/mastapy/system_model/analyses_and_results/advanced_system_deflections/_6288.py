...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6286, _6287, _6314
...
class ConceptGearSetAdvancedSystemDeflection(_6314.GearSetAdvancedSystemDeflection):
    '''ConceptGearSetAdvancedSystemDeflection
    ...
    @property
    def concept_gears_advanced_system_deflection(self) -> 'List[_6286.ConceptGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsAdvancedSystemDeflection, constructor.new(_6286.ConceptGearAdvancedSystemDeflection))
        return value

    @property
    def concept_meshes_advanced_system_deflection(self) -> 'List[_6287.ConceptGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesAdvancedSystemDeflection, constructor.new(_6287.ConceptGearMeshAdvancedSystemDeflection))
        return value

    @property
    def assembly_system_deflection_results(self) -> 'List[_2258.ConceptGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2258.ConceptGearSetSystemDeflection))
        return value
