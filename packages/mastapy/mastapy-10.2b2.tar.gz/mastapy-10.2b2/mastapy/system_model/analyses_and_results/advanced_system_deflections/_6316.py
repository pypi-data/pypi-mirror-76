...
class HypoidGearAdvancedSystemDeflection(_6261.AGMAGleasonConicalGearAdvancedSystemDeflection):
    '''HypoidGearAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_6157.HypoidGearLoadCase':
        ...
        return constructor.new(_6157.HypoidGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2295.HypoidGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2295.HypoidGearSystemDeflection))
        return value
