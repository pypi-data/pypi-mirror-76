...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6301, _6302, _6314
...
class CylindricalGearSetAdvancedSystemDeflection(_6314.GearSetAdvancedSystemDeflection):
    '''CylindricalGearSetAdvancedSystemDeflection
    ...
    @property
    def cylindrical_gears_advanced_system_deflection(self) -> 'List[_6301.CylindricalGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsAdvancedSystemDeflection, constructor.new(_6301.CylindricalGearAdvancedSystemDeflection))
        return value

    @property
    def cylindrical_meshes_advanced_system_deflection(self) -> 'List[_6302.CylindricalGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesAdvancedSystemDeflection, constructor.new(_6302.CylindricalGearMeshAdvancedSystemDeflection))
        return value
