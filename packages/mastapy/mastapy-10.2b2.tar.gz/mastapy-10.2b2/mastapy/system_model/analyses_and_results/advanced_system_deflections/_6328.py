...
class KlingelnbergCycloPalloidSpiralBevelGearMeshAdvancedSystemDeflection(_6322.KlingelnbergCycloPalloidConicalGearMeshAdvancedSystemDeflection):
    '''KlingelnbergCycloPalloidSpiralBevelGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_6170.KlingelnbergCycloPalloidSpiralBevelGearMeshLoadCase':
        ...
        return constructor.new(_6170.KlingelnbergCycloPalloidSpiralBevelGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2304.KlingelnbergCycloPalloidSpiralBevelGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2304.KlingelnbergCycloPalloidSpiralBevelGearMeshSystemDeflection))
        return value
