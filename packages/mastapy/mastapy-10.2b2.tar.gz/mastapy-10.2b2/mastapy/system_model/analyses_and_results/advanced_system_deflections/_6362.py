...
class StraightBevelGearAdvancedSystemDeflection(_6273.BevelGearAdvancedSystemDeflection):
    '''StraightBevelGearAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_6212.StraightBevelGearLoadCase':
        ...
        return constructor.new(_6212.StraightBevelGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2344.StraightBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2344.StraightBevelGearSystemDeflection))
        return value
