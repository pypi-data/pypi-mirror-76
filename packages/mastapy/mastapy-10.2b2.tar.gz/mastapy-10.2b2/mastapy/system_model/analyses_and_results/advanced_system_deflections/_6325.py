...
class KlingelnbergCycloPalloidHypoidGearMeshAdvancedSystemDeflection(_6322.KlingelnbergCycloPalloidConicalGearMeshAdvancedSystemDeflection):
    '''KlingelnbergCycloPalloidHypoidGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_6167.KlingelnbergCycloPalloidHypoidGearMeshLoadCase':
        ...
        return constructor.new(_6167.KlingelnbergCycloPalloidHypoidGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2301.KlingelnbergCycloPalloidHypoidGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2301.KlingelnbergCycloPalloidHypoidGearMeshSystemDeflection))
        return value
