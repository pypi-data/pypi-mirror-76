...
class StraightBevelDiffGearMeshAdvancedSystemDeflection(_6274.BevelGearMeshAdvancedSystemDeflection):
    '''StraightBevelDiffGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_6210.StraightBevelDiffGearMeshLoadCase':
        ...
        return constructor.new(_6210.StraightBevelDiffGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2339.StraightBevelDiffGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2339.StraightBevelDiffGearMeshSystemDeflection))
        return value
