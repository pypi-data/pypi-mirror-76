...
class ZerolBevelGearAdvancedSystemDeflection(_6273.BevelGearAdvancedSystemDeflection):
    '''ZerolBevelGearAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2367.ZerolBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2367.ZerolBevelGearSystemDeflection))
        return value
