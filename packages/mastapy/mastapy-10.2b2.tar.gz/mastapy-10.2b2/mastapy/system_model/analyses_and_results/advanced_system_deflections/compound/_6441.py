...
class HypoidGearMeshCompoundAdvancedSystemDeflection(_6388.AGMAGleasonConicalGearMeshCompoundAdvancedSystemDeflection):
    '''HypoidGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_6317.HypoidGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_6317.HypoidGearMeshAdvancedSystemDeflection))
        return value

    @property
    def connection_advanced_system_deflection_load_cases(self) -> 'List[_6317.HypoidGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAdvancedSystemDeflectionLoadCases, constructor.new(_6317.HypoidGearMeshAdvancedSystemDeflection))
        return value
