...
class RollingRingConnectionAdvancedSystemDeflection(_6320.InterMountableComponentConnectionAdvancedSystemDeflection):
    '''RollingRingConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_6194.RollingRingConnectionLoadCase':
        ...
        return constructor.new(_6194.RollingRingConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2324.RollingRingConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2324.RollingRingConnectionSystemDeflection))
        return value
