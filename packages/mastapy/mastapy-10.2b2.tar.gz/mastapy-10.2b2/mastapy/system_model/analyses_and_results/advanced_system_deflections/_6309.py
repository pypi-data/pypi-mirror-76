...
class FaceGearMeshAdvancedSystemDeflection(_6313.GearMeshAdvancedSystemDeflection):
    '''FaceGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_6138.FaceGearMeshLoadCase':
        ...
        return constructor.new(_6138.FaceGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2285.FaceGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2285.FaceGearMeshSystemDeflection))
        return value
