...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _3861, _3860, _3796
...
class WormGearSetModalAnalysesAtStiffnesses(_3796.GearSetModalAnalysesAtStiffnesses):
    '''WormGearSetModalAnalysesAtStiffnesses
    ...
    @property
    def worm_gears_modal_analyses_at_stiffnesses(self) -> 'List[_3861.WormGearModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsModalAnalysesAtStiffnesses, constructor.new(_3861.WormGearModalAnalysesAtStiffnesses))
        return value

    @property
    def worm_meshes_modal_analyses_at_stiffnesses(self) -> 'List[_3860.WormGearMeshModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesModalAnalysesAtStiffnesses, constructor.new(_3860.WormGearMeshModalAnalysesAtStiffnesses))
        return value
