...
class StraightBevelDiffGearMeshCompoundModalAnalysesAtStiffnesses(_3881.BevelGearMeshCompoundModalAnalysesAtStiffnesses):
    '''StraightBevelDiffGearMeshCompoundModalAnalysesAtStiffnesses
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3842.StraightBevelDiffGearMeshModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3842.StraightBevelDiffGearMeshModalAnalysesAtStiffnesses))
        return value

    @property
    def connection_modal_analyses_at_stiffnesses_load_cases(self) -> 'List[_3842.StraightBevelDiffGearMeshModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionModalAnalysesAtStiffnessesLoadCases, constructor.new(_3842.StraightBevelDiffGearMeshModalAnalysesAtStiffnesses))
        return value
