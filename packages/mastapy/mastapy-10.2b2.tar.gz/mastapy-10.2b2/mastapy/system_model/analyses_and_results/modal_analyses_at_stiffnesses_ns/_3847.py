...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _3846, _3845, _3758
...
class StraightBevelGearSetModalAnalysesAtStiffnesses(_3758.BevelGearSetModalAnalysesAtStiffnesses):
    '''StraightBevelGearSetModalAnalysesAtStiffnesses
    ...
    @property
    def straight_bevel_gears_modal_analyses_at_stiffnesses(self) -> 'List[_3846.StraightBevelGearModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsModalAnalysesAtStiffnesses, constructor.new(_3846.StraightBevelGearModalAnalysesAtStiffnesses))
        return value

    @property
    def straight_bevel_meshes_modal_analyses_at_stiffnesses(self) -> 'List[_3845.StraightBevelGearMeshModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesModalAnalysesAtStiffnesses, constructor.new(_3845.StraightBevelGearMeshModalAnalysesAtStiffnesses))
        return value
