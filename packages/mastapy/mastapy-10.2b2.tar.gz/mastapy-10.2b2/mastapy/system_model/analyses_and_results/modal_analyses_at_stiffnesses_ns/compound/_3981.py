...
class WormGearCompoundModalAnalysesAtStiffnesses(_3917.GearCompoundModalAnalysesAtStiffnesses):
    '''WormGearCompoundModalAnalysesAtStiffnesses
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3861.WormGearModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3861.WormGearModalAnalysesAtStiffnesses))
        return value

    @property
    def component_modal_analyses_at_stiffnesses_load_cases(self) -> 'List[_3861.WormGearModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysesAtStiffnessesLoadCases, constructor.new(_3861.WormGearModalAnalysesAtStiffnesses))
        return value
