...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _3864, _3863, _3758
...
class ZerolBevelGearSetModalAnalysesAtStiffnesses(_3758.BevelGearSetModalAnalysesAtStiffnesses):
    '''ZerolBevelGearSetModalAnalysesAtStiffnesses
    ...
    @property
    def zerol_bevel_gears_modal_analyses_at_stiffnesses(self) -> 'List[_3864.ZerolBevelGearModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsModalAnalysesAtStiffnesses, constructor.new(_3864.ZerolBevelGearModalAnalysesAtStiffnesses))
        return value

    @property
    def zerol_bevel_meshes_modal_analyses_at_stiffnesses(self) -> 'List[_3863.ZerolBevelGearMeshModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesModalAnalysesAtStiffnesses, constructor.new(_3863.ZerolBevelGearMeshModalAnalysesAtStiffnesses))
        return value
