...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _3780, _3747
...
class RootAssemblyModalAnalysesAtStiffnesses(_3747.AssemblyModalAnalysesAtStiffnesses):
    '''RootAssemblyModalAnalysesAtStiffnesses
    ...
    @property
    def modal_analyses_at_stiffnesses_inputs(self) -> '_3780.CriticalSpeedAnalysis':
        ...
        return constructor.new(_3780.CriticalSpeedAnalysis)(self.wrapped.ModalAnalysesAtStiffnessesInputs) if self.wrapped.ModalAnalysesAtStiffnessesInputs else None
