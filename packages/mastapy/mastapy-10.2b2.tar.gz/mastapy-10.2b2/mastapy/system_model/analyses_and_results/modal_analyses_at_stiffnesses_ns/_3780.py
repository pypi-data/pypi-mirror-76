...
class CriticalSpeedAnalysis(_6521.StaticLoadAnalysisCase):
    '''CriticalSpeedAnalysis
    ...
    @property
    def modal_analyses_at_stiffnesses_options(self) -> '_3814.ModalAnalysesAtStiffnessesOptions':
        ...
        return constructor.new(_3814.ModalAnalysesAtStiffnessesOptions)(self.wrapped.ModalAnalysesAtStiffnessesOptions) if self.wrapped.ModalAnalysesAtStiffnessesOptions else None
