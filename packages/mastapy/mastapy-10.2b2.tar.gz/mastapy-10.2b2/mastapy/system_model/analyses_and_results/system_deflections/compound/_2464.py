...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2465, _2378
...
class ShaftCompoundSystemDeflection(_2378.AbstractShaftOrHousingCompoundSystemDeflection):
    '''ShaftCompoundSystemDeflection
    ...
    @property
    def shaft_duty_cycle_damage_results(self) -> '_2465.ShaftDutyCycleSystemDeflection':
        ...
        return constructor.new(_2465.ShaftDutyCycleSystemDeflection)(self.wrapped.ShaftDutyCycleDamageResults) if self.wrapped.ShaftDutyCycleDamageResults else None

    @property
    def load_case_analyses_ready(self) -> 'List[_2330.ShaftSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2330.ShaftSystemDeflection))
        return value

    @property
    def component_system_deflection_load_cases(self) -> 'List[_2330.ShaftSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionLoadCases, constructor.new(_2330.ShaftSystemDeflection))
        return value
