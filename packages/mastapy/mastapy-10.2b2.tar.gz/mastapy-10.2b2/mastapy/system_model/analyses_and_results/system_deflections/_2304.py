...
class KlingelnbergCycloPalloidSpiralBevelGearMeshSystemDeflection(_2298.KlingelnbergCycloPalloidConicalGearMeshSystemDeflection):
    '''KlingelnbergCycloPalloidSpiralBevelGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3305.KlingelnbergCycloPalloidSpiralBevelGearMeshPowerFlow':
