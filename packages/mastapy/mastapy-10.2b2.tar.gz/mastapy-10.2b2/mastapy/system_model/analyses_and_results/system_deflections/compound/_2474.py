...
class SpringDamperHalfCompoundSystemDeflection(_2414.CouplingHalfCompoundSystemDeflection):
    '''SpringDamperHalfCompoundSystemDeflection
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2337.SpringDamperHalfSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2337.SpringDamperHalfSystemDeflection))
        return value

    @property
    def component_system_deflection_load_cases(self) -> 'List[_2337.SpringDamperHalfSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionLoadCases, constructor.new(_2337.SpringDamperHalfSystemDeflection))
        return value
