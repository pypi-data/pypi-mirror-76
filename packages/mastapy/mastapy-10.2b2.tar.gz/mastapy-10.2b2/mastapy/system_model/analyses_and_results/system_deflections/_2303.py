...
class KlingelnbergCycloPalloidHypoidGearSystemDeflection(_2300.KlingelnbergCycloPalloidConicalGearSystemDeflection):
    '''KlingelnbergCycloPalloidHypoidGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3303.KlingelnbergCycloPalloidHypoidGearPowerFlow':
