...
class ConceptCouplingCompoundSystemDeflection(_2412.CouplingCompoundSystemDeflection):
    '''ConceptCouplingCompoundSystemDeflection
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2256.ConceptCouplingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2256.ConceptCouplingSystemDeflection))
        return value

    @property
    def assembly_system_deflection_load_cases(self) -> 'List[_2256.ConceptCouplingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionLoadCases, constructor.new(_2256.ConceptCouplingSystemDeflection))
        return value
