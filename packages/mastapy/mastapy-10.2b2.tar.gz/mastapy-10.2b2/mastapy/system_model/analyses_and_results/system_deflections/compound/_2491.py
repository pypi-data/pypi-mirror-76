...
class UnbalancedMassCompoundSystemDeflection(_2492.VirtualComponentCompoundSystemDeflection):
    '''UnbalancedMassCompoundSystemDeflection
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2360.UnbalancedMassSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2360.UnbalancedMassSystemDeflection))
        return value

    @property
    def component_system_deflection_load_cases(self) -> 'List[_2360.UnbalancedMassSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionLoadCases, constructor.new(_2360.UnbalancedMassSystemDeflection))
        return value
