...
from mastapy.system_model.analyses_and_results.system_deflections import _2278, _2272, _2290
...
class CylindricalGearSetSystemDeflection(_2290.GearSetSystemDeflection):
    '''CylindricalGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3282.CylindricalGearSetPowerFlow':
    ...
    @property
    def cylindrical_gears_system_deflection(self) -> 'List[_2278.CylindricalGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsSystemDeflection, constructor.new(_2278.CylindricalGearSystemDeflection))
        return value

    @property
    def cylindrical_meshes_system_deflection(self) -> 'List[_2272.CylindricalGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesSystemDeflection, constructor.new(_2272.CylindricalGearMeshSystemDeflection))
        return value
