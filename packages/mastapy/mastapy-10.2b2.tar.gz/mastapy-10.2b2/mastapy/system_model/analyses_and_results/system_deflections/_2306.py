...
class KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection(_2300.KlingelnbergCycloPalloidConicalGearSystemDeflection):
    '''KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3306.KlingelnbergCycloPalloidSpiralBevelGearPowerFlow':
