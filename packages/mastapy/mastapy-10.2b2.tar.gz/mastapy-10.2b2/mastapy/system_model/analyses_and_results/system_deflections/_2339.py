...
class StraightBevelDiffGearMeshSystemDeflection(_2243.BevelGearMeshSystemDeflection):
    '''StraightBevelDiffGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3338.StraightBevelDiffGearMeshPowerFlow':
