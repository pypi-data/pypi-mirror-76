...
from mastapy.system_model.analyses_and_results.system_deflections import _2328, _2329, _2230
...
class ShaftSystemDeflection(_2230.AbstractShaftOrHousingSystemDeflection):
    '''ShaftSystemDeflection
    ...
    @property
    def twod_drawing_showing_axial_forces_with_mounted_components(self) -> '_6529.SMTBitmap':
        ...
        return constructor.new(_6529.SMTBitmap)(self.wrapped.TwoDDrawingShowingAxialForcesWithMountedComponents) if self.wrapped.TwoDDrawingShowingAxialForcesWithMountedComponents else None

    @property
    def component_design(self) -> '_2043.Shaft':
    ...
    @property
    def component_load_case(self) -> '_6198.ShaftLoadCase':
        ...
        return constructor.new(_6198.ShaftLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def power_flow_results(self) -> '_3329.ShaftPowerFlow':
    ...
    @property
    def shaft_section_end_with_worst_static_safety_factor(self) -> '_2328.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2328.ShaftSectionEndResultsSystemDeflection)(self.wrapped.ShaftSectionEndWithWorstStaticSafetyFactor) if self.wrapped.ShaftSectionEndWithWorstStaticSafetyFactor else None

    @property
    def shaft_section_end_with_worst_fatigue_safety_factor(self) -> '_2328.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2328.ShaftSectionEndResultsSystemDeflection)(self.wrapped.ShaftSectionEndWithWorstFatigueSafetyFactor) if self.wrapped.ShaftSectionEndWithWorstFatigueSafetyFactor else None

    @property
    def shaft_section_end_with_worst_fatigue_safety_factor_for_infinite_life(self) -> '_2328.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2328.ShaftSectionEndResultsSystemDeflection)(self.wrapped.ShaftSectionEndWithWorstFatigueSafetyFactorForInfiniteLife) if self.wrapped.ShaftSectionEndWithWorstFatigueSafetyFactorForInfiniteLife else None
    ...
    @property
    def shaft_section_results(self) -> 'List[_2329.ShaftSectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftSectionResults, constructor.new(_2329.ShaftSectionSystemDeflection))
        return value

    @property
    def shaft_section_end_results_by_offset_with_worst_safety_factor(self) -> 'List[_2328.ShaftSectionEndResultsSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftSectionEndResultsByOffsetWithWorstSafetyFactor, constructor.new(_2328.ShaftSectionEndResultsSystemDeflection))
        return value
