...
class PlanetaryConnectionCompoundSystemDeflection(_2467.ShaftToMountableComponentConnectionCompoundSystemDeflection):
    '''PlanetaryConnectionCompoundSystemDeflection
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2318.PlanetaryConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2318.PlanetaryConnectionSystemDeflection))
        return value

    @property
    def connection_system_deflection_load_cases(self) -> 'List[_2318.PlanetaryConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionLoadCases, constructor.new(_2318.PlanetaryConnectionSystemDeflection))
        return value
