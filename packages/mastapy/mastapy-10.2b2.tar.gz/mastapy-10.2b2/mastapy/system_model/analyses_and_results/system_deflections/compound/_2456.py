...
class PlanetCarrierCompoundSystemDeflection(_2448.MountableComponentCompoundSystemDeflection):
    '''PlanetCarrierCompoundSystemDeflection
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2319.PlanetCarrierSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2319.PlanetCarrierSystemDeflection))
        return value

    @property
    def component_system_deflection_load_cases(self) -> 'List[_2319.PlanetCarrierSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionLoadCases, constructor.new(_2319.PlanetCarrierSystemDeflection))
        return value
