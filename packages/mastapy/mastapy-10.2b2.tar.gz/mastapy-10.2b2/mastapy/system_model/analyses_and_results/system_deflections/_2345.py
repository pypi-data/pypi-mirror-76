...
class StraightBevelPlanetGearSystemDeflection(_2341.StraightBevelDiffGearSystemDeflection):
    '''StraightBevelPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3344.StraightBevelPlanetGearPowerFlow':
