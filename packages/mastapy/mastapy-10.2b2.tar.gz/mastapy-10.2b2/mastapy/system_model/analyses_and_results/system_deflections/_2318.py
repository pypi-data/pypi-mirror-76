...
class PlanetaryConnectionSystemDeflection(_2331.ShaftToMountableComponentConnectionSystemDeflection):
    '''PlanetaryConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3316.PlanetaryConnectionPowerFlow':
