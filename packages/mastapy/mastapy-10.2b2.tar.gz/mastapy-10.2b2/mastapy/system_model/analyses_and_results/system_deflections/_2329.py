...
class ShaftSectionSystemDeflection(_1430.Bar):
    ...
    @property
    def left_end(self) -> '_2328.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2328.ShaftSectionEndResultsSystemDeflection)(self.wrapped.LeftEnd) if self.wrapped.LeftEnd else None

    @property
    def right_end(self) -> '_2328.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2328.ShaftSectionEndResultsSystemDeflection)(self.wrapped.RightEnd) if self.wrapped.RightEnd else None
