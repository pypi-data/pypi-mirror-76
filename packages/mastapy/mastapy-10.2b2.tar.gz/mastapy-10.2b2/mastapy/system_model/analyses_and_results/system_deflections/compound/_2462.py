...
class RollingRingConnectionCompoundSystemDeflection(_2436.InterMountableComponentConnectionCompoundSystemDeflection):
    '''RollingRingConnectionCompoundSystemDeflection
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2324.RollingRingConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2324.RollingRingConnectionSystemDeflection))
        return value

    @property
    def connection_system_deflection_load_cases(self) -> 'List[_2324.RollingRingConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionLoadCases, constructor.new(_2324.RollingRingConnectionSystemDeflection))
        return value
