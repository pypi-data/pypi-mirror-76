...
class ShaftHubConnectionSystemDeflection(_2265.ConnectorSystemDeflection):
    '''ShaftHubConnectionSystemDeflection
    ...
    @property
    def component_design(self) -> '_2153.ShaftHubConnection':
    ...
    @property
    def component_load_case(self) -> '_6197.ShaftHubConnectionLoadCase':
        ...
        return constructor.new(_6197.ShaftHubConnectionLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def power_flow_results(self) -> '_3328.ShaftHubConnectionPowerFlow':
    ...
    @property
    def left_flank_contacts(self) -> 'List[_2376.SplineFlankContactReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LeftFlankContacts, constructor.new(_2376.SplineFlankContactReporting))
        return value

    @property
    def right_flank_contacts(self) -> 'List[_2376.SplineFlankContactReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RightFlankContacts, constructor.new(_2376.SplineFlankContactReporting))
        return value

    @property
    def tip_contacts(self) -> 'List[_2376.SplineFlankContactReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TipContacts, constructor.new(_2376.SplineFlankContactReporting))
        return value
