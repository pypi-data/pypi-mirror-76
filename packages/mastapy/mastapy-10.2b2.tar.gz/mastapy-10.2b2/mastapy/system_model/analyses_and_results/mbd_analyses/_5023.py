...
class ConnectionMultiBodyDynamicsAnalysis(_6513.ConnectionTimeSeriesLoadAnalysisCase):
    '''ConnectionMultiBodyDynamicsAnalysis
    ...
    @property
    def multi_body_dynamics_analysis(self) -> '_5070.MultiBodyDynamicsAnalysis':
        ...
        return constructor.new(_5070.MultiBodyDynamicsAnalysis)(self.wrapped.MultiBodyDynamicsAnalysis) if self.wrapped.MultiBodyDynamicsAnalysis else None
