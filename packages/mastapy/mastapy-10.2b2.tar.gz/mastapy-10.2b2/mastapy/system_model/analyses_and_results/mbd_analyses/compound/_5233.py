...
class StraightBevelGearMeshCompoundMultiBodyDynamicsAnalysis(_5147.BevelGearMeshCompoundMultiBodyDynamicsAnalysis):
    '''StraightBevelGearMeshCompoundMultiBodyDynamicsAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5102.StraightBevelGearMeshMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5102.StraightBevelGearMeshMultiBodyDynamicsAnalysis))
        return value

    @property
    def connection_multi_body_dynamics_analysis_load_cases(self) -> 'List[_5102.StraightBevelGearMeshMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionMultiBodyDynamicsAnalysisLoadCases, constructor.new(_5102.StraightBevelGearMeshMultiBodyDynamicsAnalysis))
        return value
