...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _5128, _5130
...
class ShaftHubConnectionMultiBodyDynamicsAnalysis(_5024.ConnectorMultiBodyDynamicsAnalysis):
    '''ShaftHubConnectionMultiBodyDynamicsAnalysis
    ...
    @property
    def peak_dynamic_force_angular(self) -> '_5130.DynamicTorqueVector3DResult':
        ...
        return constructor.new(_5130.DynamicTorqueVector3DResult)(self.wrapped.PeakDynamicForceAngular) if self.wrapped.PeakDynamicForceAngular else None
