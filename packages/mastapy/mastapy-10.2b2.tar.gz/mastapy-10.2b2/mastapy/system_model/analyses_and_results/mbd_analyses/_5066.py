...
from mastapy.system_model.analyses_and_results.mbd_analyses.external_interfaces import _5131
...
class MBDAnalysisOptions(_0.APIBase):
    ...
    @property
    def analysis_type(self) -> '_4992.AnalysisTypes':
        '''AnalysisTypes: 'AnalysisType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.AnalysisType)
        return constructor.new(_4992.AnalysisTypes)(value) if value else None

    @analysis_type.setter
    def analysis_type(self, value: '_4992.AnalysisTypes'):
    ...
    @property
    def method_to_define_period(self) -> '_5050.InertiaAdjustedLoadCasePeriodMethod':
        ...
        return constructor.new(_5050.InertiaAdjustedLoadCasePeriodMethod)(value) if value else None

    @method_to_define_period.setter
    def method_to_define_period(self, value: '_5050.InertiaAdjustedLoadCasePeriodMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def static_load_cases_to_create(self) -> '_5051.InertiaAdjustedLoadCaseResultsToCreate':
        ...
        return constructor.new(_5051.InertiaAdjustedLoadCaseResultsToCreate)(value) if value else None

    @static_load_cases_to_create.setter
    def static_load_cases_to_create(self, value: '_5051.InertiaAdjustedLoadCaseResultsToCreate'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def external_interface_options(self) -> '_5131.DynamicExternalInterfaceOptions':
        ...
        return constructor.new(_5131.DynamicExternalInterfaceOptions)(self.wrapped.ExternalInterfaceOptions) if self.wrapped.ExternalInterfaceOptions else None

    @property
    def run_up_analysis_options(self) -> '_5067.MBDRunUpAnalysisOptions':
        ...
        return constructor.new(_5067.MBDRunUpAnalysisOptions)(self.wrapped.RunUpAnalysisOptions) if self.wrapped.RunUpAnalysisOptions else None

    @property
    def frequency_response_options(self) -> '_4772.FrequencyResponseAnalysisOptions':
        ...
        return constructor.new(_4772.FrequencyResponseAnalysisOptions)(self.wrapped.FrequencyResponseOptions) if self.wrapped.FrequencyResponseOptions else None
