...
class CylindricalGearMeshCompoundMultiBodyDynamicsAnalysis(_5184.GearMeshCompoundMultiBodyDynamicsAnalysis):
    '''CylindricalGearMeshCompoundMultiBodyDynamicsAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5031.CylindricalGearMeshMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5031.CylindricalGearMeshMultiBodyDynamicsAnalysis))
        return value

    @property
    def connection_multi_body_dynamics_analysis_load_cases(self) -> 'List[_5031.CylindricalGearMeshMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionMultiBodyDynamicsAnalysisLoadCases, constructor.new(_5031.CylindricalGearMeshMultiBodyDynamicsAnalysis))
        return value
