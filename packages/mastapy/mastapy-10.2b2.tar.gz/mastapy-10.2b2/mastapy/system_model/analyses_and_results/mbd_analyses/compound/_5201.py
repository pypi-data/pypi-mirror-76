...
class MassDiscCompoundMultiBodyDynamicsAnalysis(_5246.VirtualComponentCompoundMultiBodyDynamicsAnalysis):
    '''MassDiscCompoundMultiBodyDynamicsAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5064.MassDiscMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5064.MassDiscMultiBodyDynamicsAnalysis))
        return value

    @property
    def component_multi_body_dynamics_analysis_load_cases(self) -> 'List[_5064.MassDiscMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentMultiBodyDynamicsAnalysisLoadCases, constructor.new(_5064.MassDiscMultiBodyDynamicsAnalysis))
        return value
