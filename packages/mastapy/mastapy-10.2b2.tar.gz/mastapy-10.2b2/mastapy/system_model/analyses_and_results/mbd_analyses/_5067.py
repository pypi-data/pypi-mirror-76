...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5053, _5091, _5086
...
class MBDRunUpAnalysisOptions(_6507.AbstractAnalysisOptions['_6222.TimeSeriesLoadCase']):
    '''MBDRunUpAnalysisOptions
    ...
    @property
    def input_velocity_processing_type(self) -> '_5053.InputVelocityForRunUpProcessingType':
        ...
        return constructor.new(_5053.InputVelocityForRunUpProcessingType)(value) if value else None

    @input_velocity_processing_type.setter
    def input_velocity_processing_type(self, value: '_5053.InputVelocityForRunUpProcessingType'):
    ...
    @property
    def shape_of_initial_acceleration_period(self) -> '_5091.ShapeOfInitialAccelerationPeriodForRunUp':
        ...
        return constructor.new(_5091.ShapeOfInitialAccelerationPeriodForRunUp)(value) if value else None

    @shape_of_initial_acceleration_period.setter
    def shape_of_initial_acceleration_period(self, value: '_5091.ShapeOfInitialAccelerationPeriodForRunUp'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ShapeOfInitialAccelerationPeriod = value

    @property
    def run_up_driving_mode(self) -> '_5086.RunUpDrivingMode':
        ...
        return constructor.new(_5086.RunUpDrivingMode)(value) if value else None

    @run_up_driving_mode.setter
    def run_up_driving_mode(self, value: '_5086.RunUpDrivingMode'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
