...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5081, _5092
...
class BeltDriveMultiBodyDynamicsAnalysis(_5092.SpecialisedAssemblyMultiBodyDynamicsAnalysis):
    '''BeltDriveMultiBodyDynamicsAnalysis
    ...
    @property
    def pulleys(self) -> 'List[_5081.PulleyMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_5081.PulleyMultiBodyDynamicsAnalysis))
        return value
