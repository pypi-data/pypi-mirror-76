...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _2846, _2844, _2758
...
class StraightBevelGearSetSteadyStateSynchronousResponseAtASpeed(_2758.BevelGearSetSteadyStateSynchronousResponseAtASpeed):
    '''StraightBevelGearSetSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def straight_bevel_gears_steady_state_synchronous_response_at_a_speed(self) -> 'List[_2846.StraightBevelGearSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsSteadyStateSynchronousResponseAtASpeed, constructor.new(_2846.StraightBevelGearSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def straight_bevel_meshes_steady_state_synchronous_response_at_a_speed(self) -> 'List[_2844.StraightBevelGearMeshSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesSteadyStateSynchronousResponseAtASpeed, constructor.new(_2844.StraightBevelGearMeshSteadyStateSynchronousResponseAtASpeed))
        return value
