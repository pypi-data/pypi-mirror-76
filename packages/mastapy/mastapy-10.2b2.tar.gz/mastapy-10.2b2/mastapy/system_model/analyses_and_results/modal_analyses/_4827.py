...
from mastapy.system_model.analyses_and_results.modal_analyses import _4826, _4825, _4736
...
class StraightBevelDiffGearSetModalAnalysis(_4736.BevelGearSetModalAnalysis):
    '''StraightBevelDiffGearSetModalAnalysis
    ...
    @property
    def straight_bevel_diff_gears_modal_analysis(self) -> 'List[_4826.StraightBevelDiffGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsModalAnalysis, constructor.new(_4826.StraightBevelDiffGearModalAnalysis))
        return value

    @property
    def straight_bevel_diff_meshes_modal_analysis(self) -> 'List[_4825.StraightBevelDiffGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesModalAnalysis, constructor.new(_4825.StraightBevelDiffGearMeshModalAnalysis))
        return value
