...
class RollingRingAssemblyCompoundModalAnalysis(_4956.SpecialisedAssemblyCompoundModalAnalysis):
    '''RollingRingAssemblyCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4810.RollingRingAssemblyModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4810.RollingRingAssemblyModalAnalysis))
        return value

    @property
    def assembly_modal_analysis_load_cases(self) -> 'List[_4810.RollingRingAssemblyModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyModalAnalysisLoadCases, constructor.new(_4810.RollingRingAssemblyModalAnalysis))
        return value
