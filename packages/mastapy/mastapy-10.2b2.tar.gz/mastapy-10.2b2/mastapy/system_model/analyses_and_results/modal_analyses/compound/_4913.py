...
class FaceGearCompoundModalAnalysis(_4917.GearCompoundModalAnalysis):
    '''FaceGearCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4769.FaceGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4769.FaceGearModalAnalysis))
        return value

    @property
    def component_modal_analysis_load_cases(self) -> 'List[_4769.FaceGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysisLoadCases, constructor.new(_4769.FaceGearModalAnalysis))
        return value
