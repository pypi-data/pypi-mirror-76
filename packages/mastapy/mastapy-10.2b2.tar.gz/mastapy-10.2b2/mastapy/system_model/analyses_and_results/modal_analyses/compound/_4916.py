...
class FlexiblePinAssemblyCompoundModalAnalysis(_4956.SpecialisedAssemblyCompoundModalAnalysis):
    '''FlexiblePinAssemblyCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4771.FlexiblePinAssemblyModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4771.FlexiblePinAssemblyModalAnalysis))
        return value

    @property
    def assembly_modal_analysis_load_cases(self) -> 'List[_4771.FlexiblePinAssemblyModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyModalAnalysisLoadCases, constructor.new(_4771.FlexiblePinAssemblyModalAnalysis))
        return value
