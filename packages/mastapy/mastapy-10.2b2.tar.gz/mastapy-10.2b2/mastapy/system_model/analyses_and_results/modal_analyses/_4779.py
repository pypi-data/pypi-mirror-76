...
from mastapy.system_model.analyses_and_results.modal_analyses import _4778, _4777, _4724
...
class HypoidGearSetModalAnalysis(_4724.AGMAGleasonConicalGearSetModalAnalysis):
    '''HypoidGearSetModalAnalysis
    ...
    @property
    def hypoid_gears_modal_analysis(self) -> 'List[_4778.HypoidGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsModalAnalysis, constructor.new(_4778.HypoidGearModalAnalysis))
        return value

    @property
    def hypoid_meshes_modal_analysis(self) -> 'List[_4777.HypoidGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesModalAnalysis, constructor.new(_4777.HypoidGearMeshModalAnalysis))
        return value
