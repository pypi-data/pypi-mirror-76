...
class CouplingConnectionModalAnalysis(_4781.InterMountableComponentConnectionModalAnalysis):
    '''CouplingConnectionModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2266.CouplingConnectionSystemDeflection':
