...
from mastapy.system_model.analyses_and_results.modal_analyses import _4743, _4773, _4800
...
class AbstractAssemblyModalAnalysis(_4800.PartModalAnalysis):
    ...
    @property
    def gear_meshes(self) -> 'List[_4773.GearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshes, constructor.new(_4773.GearMeshModalAnalysis))
        return value
