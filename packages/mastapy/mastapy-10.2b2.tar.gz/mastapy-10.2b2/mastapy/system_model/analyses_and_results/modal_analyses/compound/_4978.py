...
class TorqueConverterTurbineCompoundModalAnalysis(_4903.CouplingHalfCompoundModalAnalysis):
    '''TorqueConverterTurbineCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4840.TorqueConverterTurbineModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4840.TorqueConverterTurbineModalAnalysis))
        return value

    @property
    def component_modal_analysis_load_cases(self) -> 'List[_4840.TorqueConverterTurbineModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysisLoadCases, constructor.new(_4840.TorqueConverterTurbineModalAnalysis))
        return value
