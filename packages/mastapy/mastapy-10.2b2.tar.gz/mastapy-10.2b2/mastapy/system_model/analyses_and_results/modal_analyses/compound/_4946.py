...
class PointLoadCompoundModalAnalysis(_4980.VirtualComponentCompoundModalAnalysis):
    '''PointLoadCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4807.PointLoadModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4807.PointLoadModalAnalysis))
        return value

    @property
    def component_modal_analysis_load_cases(self) -> 'List[_4807.PointLoadModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysisLoadCases, constructor.new(_4807.PointLoadModalAnalysis))
        return value
