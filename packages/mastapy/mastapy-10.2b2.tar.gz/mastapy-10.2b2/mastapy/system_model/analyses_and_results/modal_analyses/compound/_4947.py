...
class PowerLoadCompoundModalAnalysis(_4980.VirtualComponentCompoundModalAnalysis):
    '''PowerLoadCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4808.PowerLoadModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4808.PowerLoadModalAnalysis))
        return value

    @property
    def component_modal_analysis_load_cases(self) -> 'List[_4808.PowerLoadModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysisLoadCases, constructor.new(_4808.PowerLoadModalAnalysis))
        return value
