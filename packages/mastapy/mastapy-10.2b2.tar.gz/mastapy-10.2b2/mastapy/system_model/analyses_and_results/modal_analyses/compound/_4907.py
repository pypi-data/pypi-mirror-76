...
class CylindricalGearCompoundModalAnalysis(_4917.GearCompoundModalAnalysis):
    '''CylindricalGearCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4763.CylindricalGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4763.CylindricalGearModalAnalysis))
        return value

    @property
    def component_modal_analysis_load_cases(self) -> 'List[_4763.CylindricalGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysisLoadCases, constructor.new(_4763.CylindricalGearModalAnalysis))
        return value
