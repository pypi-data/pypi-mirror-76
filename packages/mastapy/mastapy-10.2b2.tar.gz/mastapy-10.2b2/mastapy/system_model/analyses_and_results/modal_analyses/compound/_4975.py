...
class TorqueConverterCompoundModalAnalysis(_4901.CouplingCompoundModalAnalysis):
    '''TorqueConverterCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4838.TorqueConverterModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4838.TorqueConverterModalAnalysis))
        return value

    @property
    def assembly_modal_analysis_load_cases(self) -> 'List[_4838.TorqueConverterModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyModalAnalysisLoadCases, constructor.new(_4838.TorqueConverterModalAnalysis))
        return value
