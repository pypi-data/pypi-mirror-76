...
class PulleyCompoundModalAnalysis(_4903.CouplingHalfCompoundModalAnalysis):
    '''PulleyCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4809.PulleyModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4809.PulleyModalAnalysis))
        return value

    @property
    def component_modal_analysis_load_cases(self) -> 'List[_4809.PulleyModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysisLoadCases, constructor.new(_4809.PulleyModalAnalysis))
        return value
