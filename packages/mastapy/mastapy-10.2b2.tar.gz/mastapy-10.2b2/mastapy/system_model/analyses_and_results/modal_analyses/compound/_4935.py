...
class MassDiscCompoundModalAnalysis(_4980.VirtualComponentCompoundModalAnalysis):
    '''MassDiscCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4791.MassDiscModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4791.MassDiscModalAnalysis))
        return value

    @property
    def component_modal_analysis_load_cases(self) -> 'List[_4791.MassDiscModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysisLoadCases, constructor.new(_4791.MassDiscModalAnalysis))
        return value
