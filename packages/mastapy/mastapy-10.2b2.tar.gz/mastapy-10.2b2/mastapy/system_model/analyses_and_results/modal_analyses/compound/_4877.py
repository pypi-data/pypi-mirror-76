...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4875, _4876, _4882
...
class BevelDifferentialGearSetCompoundModalAnalysis(_4882.BevelGearSetCompoundModalAnalysis):
    '''BevelDifferentialGearSetCompoundModalAnalysis
    ...
    @property
    def bevel_differential_gears_compound_modal_analysis(self) -> 'List[_4875.BevelDifferentialGearCompoundModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialGearsCompoundModalAnalysis, constructor.new(_4875.BevelDifferentialGearCompoundModalAnalysis))
        return value

    @property
    def bevel_differential_meshes_compound_modal_analysis(self) -> 'List[_4876.BevelDifferentialGearMeshCompoundModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialMeshesCompoundModalAnalysis, constructor.new(_4876.BevelDifferentialGearMeshCompoundModalAnalysis))
        return value
