...
class RootAssemblyCompoundPowerFlow(_3368.AssemblyCompoundPowerFlow):
    '''RootAssemblyCompoundPowerFlow
    ...
    @property
    def compound_static_load(self) -> '_5255.AbstractStaticLoadCaseGroup':
        ...
        return constructor.new(_5255.AbstractStaticLoadCaseGroup)(self.wrapped.CompoundStaticLoad) if self.wrapped.CompoundStaticLoad else None

    @property
    def compound_static_load_of_type_abstract_design_state_load_case_group(self) -> '_5253.AbstractDesignStateLoadCaseGroup':
        ...
        if _5253.AbstractDesignStateLoadCaseGroup.TYPE not in self.wrapped.CompoundStaticLoad.__class__.__mro__:
        ...
        return constructor.new(_5253.AbstractDesignStateLoadCaseGroup)(self.wrapped.CompoundStaticLoad) if self.wrapped.CompoundStaticLoad else None

    @property
    def compound_static_load_of_type_design_state(self) -> '_5258.DesignState':
        ...
        if _5258.DesignState.TYPE not in self.wrapped.CompoundStaticLoad.__class__.__mro__:
        ...
        return constructor.new(_5258.DesignState)(self.wrapped.CompoundStaticLoad) if self.wrapped.CompoundStaticLoad else None

    @property
    def compound_static_load_of_type_duty_cycle(self) -> '_5259.DutyCycle':
        ...
        if _5259.DutyCycle.TYPE not in self.wrapped.CompoundStaticLoad.__class__.__mro__:
        ...
        return constructor.new(_5259.DutyCycle)(self.wrapped.CompoundStaticLoad) if self.wrapped.CompoundStaticLoad else None

    @property
    def compound_static_load_of_type_sub_group_in_single_design_state(self) -> '_5263.SubGroupInSingleDesignState':
        ...
        if _5263.SubGroupInSingleDesignState.TYPE not in self.wrapped.CompoundStaticLoad.__class__.__mro__:
        ...
        return constructor.new(_5263.SubGroupInSingleDesignState)(self.wrapped.CompoundStaticLoad) if self.wrapped.CompoundStaticLoad else None
