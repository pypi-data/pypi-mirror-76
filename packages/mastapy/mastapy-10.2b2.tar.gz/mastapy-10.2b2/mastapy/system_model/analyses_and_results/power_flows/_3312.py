...
class PartPowerFlow(_6519.PartStaticLoadAnalysisCase):
    '''PartPowerFlow
    ...
    @property
    def power_flow(self) -> '_3320.PowerFlow':
        ...
        return constructor.new(_3320.PowerFlow)(self.wrapped.PowerFlow) if self.wrapped.PowerFlow else None
