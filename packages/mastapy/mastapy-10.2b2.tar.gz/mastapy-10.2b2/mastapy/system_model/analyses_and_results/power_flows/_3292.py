...
from mastapy.system_model.analyses_and_results.power_flows import _3290, _3291, _3331
...
class GearSetPowerFlow(_3331.SpecialisedAssemblyPowerFlow):
    '''GearSetPowerFlow
    ...
    @property
    def meshes_power_flow(self) -> 'List[_3290.GearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesPowerFlow, constructor.new(_3290.GearMeshPowerFlow))
        return value

    @property
    def gears_power_flow(self) -> 'List[_3291.GearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsPowerFlow, constructor.new(_3291.GearPowerFlow))
        return value
