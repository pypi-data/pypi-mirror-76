...
class ZerolBevelGearMeshCompoundPowerFlow(_3378.BevelGearMeshCompoundPowerFlow):
    '''ZerolBevelGearMeshCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3360.ZerolBevelGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3360.ZerolBevelGearMeshPowerFlow))
        return value

    @property
    def connection_power_flow_load_cases(self) -> 'List[_3360.ZerolBevelGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionPowerFlowLoadCases, constructor.new(_3360.ZerolBevelGearMeshPowerFlow))
        return value
