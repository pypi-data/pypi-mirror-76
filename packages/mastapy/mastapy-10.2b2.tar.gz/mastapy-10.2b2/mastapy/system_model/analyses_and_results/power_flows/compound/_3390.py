...
class ConceptGearCompoundPowerFlow(_3414.GearCompoundPowerFlow):
    '''ConceptGearCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3266.ConceptGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3266.ConceptGearPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_3266.ConceptGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_3266.ConceptGearPowerFlow))
        return value
