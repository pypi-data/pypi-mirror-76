...
from mastapy.system_model.analyses_and_results.power_flows import _3358, _3357, _3292
...
class WormGearSetPowerFlow(_3292.GearSetPowerFlow):
    '''WormGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_3358.WormGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsPowerFlow, constructor.new(_3358.WormGearPowerFlow))
        return value

    @property
    def worm_gears_power_flow(self) -> 'List[_3358.WormGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsPowerFlow, constructor.new(_3358.WormGearPowerFlow))
        return value

    @property
    def meshes_power_flow(self) -> 'List[_3357.WormGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesPowerFlow, constructor.new(_3357.WormGearMeshPowerFlow))
        return value

    @property
    def worm_meshes_power_flow(self) -> 'List[_3357.WormGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesPowerFlow, constructor.new(_3357.WormGearMeshPowerFlow))
        return value
