...
from mastapy.system_model.analyses_and_results.power_flows import _3266, _3265, _3292
...
class ConceptGearSetPowerFlow(_3292.GearSetPowerFlow):
    '''ConceptGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_3266.ConceptGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsPowerFlow, constructor.new(_3266.ConceptGearPowerFlow))
        return value

    @property
    def concept_gears_power_flow(self) -> 'List[_3266.ConceptGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsPowerFlow, constructor.new(_3266.ConceptGearPowerFlow))
        return value

    @property
    def meshes_power_flow(self) -> 'List[_3265.ConceptGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesPowerFlow, constructor.new(_3265.ConceptGearMeshPowerFlow))
        return value

    @property
    def concept_meshes_power_flow(self) -> 'List[_3265.ConceptGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesPowerFlow, constructor.new(_3265.ConceptGearMeshPowerFlow))
        return value
