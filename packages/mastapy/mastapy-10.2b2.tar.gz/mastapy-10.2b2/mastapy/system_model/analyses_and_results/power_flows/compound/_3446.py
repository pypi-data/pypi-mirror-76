...
class RollingRingAssemblyCompoundPowerFlow(_3453.SpecialisedAssemblyCompoundPowerFlow):
    '''RollingRingAssemblyCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3324.RollingRingAssemblyPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3324.RollingRingAssemblyPowerFlow))
        return value

    @property
    def assembly_power_flow_load_cases(self) -> 'List[_3324.RollingRingAssemblyPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyPowerFlowLoadCases, constructor.new(_3324.RollingRingAssemblyPowerFlow))
        return value
