...
from mastapy.system_model.analyses_and_results.power_flows import _3295, _3294, _3242
...
class HypoidGearSetPowerFlow(_3242.AGMAGleasonConicalGearSetPowerFlow):
    '''HypoidGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_3295.HypoidGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsPowerFlow, constructor.new(_3295.HypoidGearPowerFlow))
        return value

    @property
    def hypoid_gears_power_flow(self) -> 'List[_3295.HypoidGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsPowerFlow, constructor.new(_3295.HypoidGearPowerFlow))
        return value

    @property
    def meshes_power_flow(self) -> 'List[_3294.HypoidGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesPowerFlow, constructor.new(_3294.HypoidGearMeshPowerFlow))
        return value

    @property
    def hypoid_meshes_power_flow(self) -> 'List[_3294.HypoidGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesPowerFlow, constructor.new(_3294.HypoidGearMeshPowerFlow))
        return value
