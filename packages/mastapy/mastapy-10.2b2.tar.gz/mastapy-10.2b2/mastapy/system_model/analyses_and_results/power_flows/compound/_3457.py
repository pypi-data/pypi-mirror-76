...
class SpringDamperCompoundPowerFlow(_3398.CouplingCompoundPowerFlow):
    '''SpringDamperCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3337.SpringDamperPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3337.SpringDamperPowerFlow))
        return value

    @property
    def assembly_power_flow_load_cases(self) -> 'List[_3337.SpringDamperPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyPowerFlowLoadCases, constructor.new(_3337.SpringDamperPowerFlow))
        return value
