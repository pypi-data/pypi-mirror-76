...
from mastapy.system_model.analyses_and_results.power_flows import _3281, _3280, _3292
...
class CylindricalGearSetPowerFlow(_3292.GearSetPowerFlow):
    '''CylindricalGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_3281.CylindricalGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsPowerFlow, constructor.new(_3281.CylindricalGearPowerFlow))
        return value

    @property
    def cylindrical_gears_power_flow(self) -> 'List[_3281.CylindricalGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsPowerFlow, constructor.new(_3281.CylindricalGearPowerFlow))
        return value

    @property
    def meshes_power_flow(self) -> 'List[_3280.CylindricalGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesPowerFlow, constructor.new(_3280.CylindricalGearMeshPowerFlow))
        return value

    @property
    def cylindrical_meshes_power_flow(self) -> 'List[_3280.CylindricalGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesPowerFlow, constructor.new(_3280.CylindricalGearMeshPowerFlow))
        return value
