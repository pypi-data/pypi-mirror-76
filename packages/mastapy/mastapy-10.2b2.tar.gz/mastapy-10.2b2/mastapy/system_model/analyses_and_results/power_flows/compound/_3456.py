...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3454, _3455, _3379
...
class SpiralBevelGearSetCompoundPowerFlow(_3379.BevelGearSetCompoundPowerFlow):
    '''SpiralBevelGearSetCompoundPowerFlow
    ...
    @property
    def spiral_bevel_gears_compound_power_flow(self) -> 'List[_3454.SpiralBevelGearCompoundPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsCompoundPowerFlow, constructor.new(_3454.SpiralBevelGearCompoundPowerFlow))
        return value

    @property
    def spiral_bevel_meshes_compound_power_flow(self) -> 'List[_3455.SpiralBevelGearMeshCompoundPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesCompoundPowerFlow, constructor.new(_3455.SpiralBevelGearMeshCompoundPowerFlow))
        return value

    @property
    def load_case_analyses_ready(self) -> 'List[_3334.SpiralBevelGearSetPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3334.SpiralBevelGearSetPowerFlow))
        return value

    @property
    def assembly_power_flow_load_cases(self) -> 'List[_3334.SpiralBevelGearSetPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyPowerFlowLoadCases, constructor.new(_3334.SpiralBevelGearSetPowerFlow))
        return value
