...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4570, _4569, _4493
...
class SpiralBevelGearSetModalAnalysisAtASpeed(_4493.BevelGearSetModalAnalysisAtASpeed):
    '''SpiralBevelGearSetModalAnalysisAtASpeed
    ...
    @property
    def spiral_bevel_gears_modal_analysis_at_a_speed(self) -> 'List[_4570.SpiralBevelGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsModalAnalysisAtASpeed, constructor.new(_4570.SpiralBevelGearModalAnalysisAtASpeed))
        return value

    @property
    def spiral_bevel_meshes_modal_analysis_at_a_speed(self) -> 'List[_4569.SpiralBevelGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesModalAnalysisAtASpeed, constructor.new(_4569.SpiralBevelGearMeshModalAnalysisAtASpeed))
        return value
