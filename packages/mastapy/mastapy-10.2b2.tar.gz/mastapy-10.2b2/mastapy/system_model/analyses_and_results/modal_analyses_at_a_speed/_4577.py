...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4576, _4575, _4493
...
class StraightBevelDiffGearSetModalAnalysisAtASpeed(_4493.BevelGearSetModalAnalysisAtASpeed):
    '''StraightBevelDiffGearSetModalAnalysisAtASpeed
    ...
    @property
    def straight_bevel_diff_gears_modal_analysis_at_a_speed(self) -> 'List[_4576.StraightBevelDiffGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsModalAnalysisAtASpeed, constructor.new(_4576.StraightBevelDiffGearModalAnalysisAtASpeed))
        return value

    @property
    def straight_bevel_diff_meshes_modal_analysis_at_a_speed(self) -> 'List[_4575.StraightBevelDiffGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesModalAnalysisAtASpeed, constructor.new(_4575.StraightBevelDiffGearMeshModalAnalysisAtASpeed))
        return value
