...
class MeasurementComponentCompoundModalAnalysisAtASpeed(_4713.VirtualComponentCompoundModalAnalysisAtASpeed):
    '''MeasurementComponentCompoundModalAnalysisAtASpeed
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4547.MeasurementComponentModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4547.MeasurementComponentModalAnalysisAtASpeed))
        return value

    @property
    def component_modal_analysis_at_a_speed_load_cases(self) -> 'List[_4547.MeasurementComponentModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysisAtASpeedLoadCases, constructor.new(_4547.MeasurementComponentModalAnalysisAtASpeed))
        return value
