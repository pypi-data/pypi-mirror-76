...
class ImportedFEWithSelection(_1932.BaseFEWithSelection):
    ...
    @property
    def imported_fe(self) -> '_1954.ImportedFE':
        ...
        return constructor.new(_1954.ImportedFE)(self.wrapped.ImportedFE) if self.wrapped.ImportedFE else None

    @property
    def element_face_groups(self) -> 'List[_1945.ElementFaceGroupWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElementFaceGroups, constructor.new(_1945.ElementFaceGroupWithSelection))
        return value

    @property
    def node_groups(self) -> 'List[_1979.NodeGroupWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodeGroups, constructor.new(_1979.NodeGroupWithSelection))
        return value
