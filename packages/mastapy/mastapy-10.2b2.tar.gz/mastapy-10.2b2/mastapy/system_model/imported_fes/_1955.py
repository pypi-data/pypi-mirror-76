...
from mastapy.system_model.imported_fes import _1944, _1960
...
class ImportedFEElectricMachineStatorLink(_1960.ImportedFEMultiNodeLink):
    '''ImportedFEElectricMachineStatorLink
    ...
    @property
    def electric_machine_dynamic_load_data(self) -> '_1944.ElectricMachineDynamicLoadData':
        ...
        return constructor.new(_1944.ElectricMachineDynamicLoadData)(self.wrapped.ElectricMachineDynamicLoadData) if self.wrapped.ElectricMachineDynamicLoadData else None
