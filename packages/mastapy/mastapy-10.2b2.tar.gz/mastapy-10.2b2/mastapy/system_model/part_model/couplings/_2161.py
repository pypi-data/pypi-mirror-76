...
from mastapy.system_model.part_model.couplings import _2162, _2164, _2139
...
class TorqueConverter(_2139.Coupling):
    '''TorqueConverter
    ...
    @property
    def pump(self) -> '_2162.TorqueConverterPump':
        ...
        return constructor.new(_2162.TorqueConverterPump)(self.wrapped.Pump) if self.wrapped.Pump else None

    @property
    def turbine(self) -> '_2164.TorqueConverterTurbine':
        ...
        return constructor.new(_2164.TorqueConverterTurbine)(self.wrapped.Turbine) if self.wrapped.Turbine else None
