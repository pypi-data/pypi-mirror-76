...
from mastapy.system_model.part_model.couplings import _2160, _2158
...
class Synchroniser(_2038.SpecialisedAssembly):
    '''Synchroniser
    ...
    @property
    def hub_and_sleeve(self) -> '_2160.SynchroniserSleeve':
        ...
        return constructor.new(_2160.SynchroniserSleeve)(self.wrapped.HubAndSleeve) if self.wrapped.HubAndSleeve else None

    @property
    def left_cone(self) -> '_2158.SynchroniserHalf':
        ...
        return constructor.new(_2158.SynchroniserHalf)(self.wrapped.LeftCone) if self.wrapped.LeftCone else None

    @property
    def right_cone(self) -> '_2158.SynchroniserHalf':
        ...
        return constructor.new(_2158.SynchroniserHalf)(self.wrapped.RightCone) if self.wrapped.RightCone else None
