...
from mastapy.system_model.part_model import _2002, _2023, _2026
...
class PlanetCarrier(_2026.MountableComponent):
    '''PlanetCarrier
    ...
    @property
    def planetary_load_sharing_agma_application_level(self) -> '_2002.AGMALoadSharingTableApplicationLevel':
        ...
        return constructor.new(_2002.AGMALoadSharingTableApplicationLevel)(value) if value else None

    @planetary_load_sharing_agma_application_level.setter
    def planetary_load_sharing_agma_application_level(self, value: '_2002.AGMALoadSharingTableApplicationLevel'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.PlanetaryLoadSharingAGMAApplicationLevel = value

    @property
    def planetary_load_sharing(self) -> '_2023.LoadSharingModes':
        ...
        return constructor.new(_2023.LoadSharingModes)(value) if value else None

    @planetary_load_sharing.setter
    def planetary_load_sharing(self, value: '_2023.LoadSharingModes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    def attach_carrier_shaft(self, shaft: '_2043.Shaft', offset: Optional['float'] = float('nan')):
    ...
    def attach_pin_shaft(self, shaft: '_2043.Shaft', offset: Optional['float'] = float('nan')):
