...
from mastapy.system_model.part_model.gears import _2085, _2087, _2086
...
class PlanetaryGearSet(_2086.CylindricalGearSet):
    '''PlanetaryGearSet
    ...
    @property
    def suns(self) -> 'List[_2085.CylindricalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Suns, constructor.new(_2085.CylindricalGear))
        return value

    @property
    def planets(self) -> 'List[_2087.CylindricalPlanetGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Planets, constructor.new(_2087.CylindricalPlanetGear))
        return value

    @property
    def annuluses(self) -> 'List[_2085.CylindricalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Annuluses, constructor.new(_2085.CylindricalGear))
        return value

    def add_sun(self) -> '_2085.CylindricalGear':
    ...
    def add_planet(self) -> '_2085.CylindricalGear':
