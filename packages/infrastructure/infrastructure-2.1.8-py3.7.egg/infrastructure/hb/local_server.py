...
# @Last Modified time: 2020-08-07 17:14:12
...
class LocalServer(object):
	def __init__(self,alreadyRecord,JavaCoverageReportUrl="",coverageLog="",
		javaCoverageNolib="",javaCoverageLibOneNotSN=""):
		"""
			操作本地服务器
		"""
	...
	def parseReport(self):
		...
		if os.path.exists(index_path):
			...
			if "uat" in hostname:
				...
				env = "uat"
			report_html_url = ['https://{}-rfautotest.hellobike.cn/report/{}/report/{}/index.html'.format(
					env,self.alreadyRecord.service_name,self.alreadyRecord.id),
				'https://{}-rfautotest.hellobike.cn/report/{}/report/{}/incrementReport.html'.format(
				env,self.alreadyRecord.service_name,self.alreadyRecord.id)]
