...
class Client:
    ...
    def get_experiment_preview_sync(self, dataset_key: str, validset_key: str, classification: bool,
                                    ...
                                    fold_column: str, reproducible: bool, resumed_experiment_id: str,
                                    config_overrides: str):
    ...
    # PATCHED
    def get_experiment_tuning_suggestion(self, dataset_key: str, target_col: str, is_classification: bool, is_time_series: bool, is_image: bool, config_overrides: str, cols_to_drop: str) -> ModelParameters:
        """
