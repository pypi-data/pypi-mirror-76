...
class Checksum(object):
    ...
    def __init__(self, path=None, checksum=None, local_vars_configuration=None):  # noqa: E501
        """Checksum - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def path(self):
        """Gets the path of this Checksum.  # noqa: E501

        File path.  # noqa: E501

        :return: The path of this Checksum.  # noqa: E501
        :rtype: str
        """
        return self._path
    ...
    @path.setter
    def path(self, path):
        """Sets the path of this Checksum.

        File path.  # noqa: E501

        :param path: The path of this Checksum.  # noqa: E501
        :type: str
        """
