...
class IntegrationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.BackfillPartial = channel.stream_stream(
...
class IntegrationServiceServicer(object):
    ...
    def BackfillPartial(self, request_iterator, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_IntegrationServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'BackfillPartial': grpc.stream_stream_rpc_method_handler(
...
class IntegrationService(object):
    ...
    @staticmethod
    def BackfillPartial(request_iterator,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/calixa.domain.integration.IntegrationService/BackfillPartial',
