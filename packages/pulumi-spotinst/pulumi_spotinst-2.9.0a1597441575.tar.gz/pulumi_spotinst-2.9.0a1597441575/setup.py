...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'spotinst', '2.9.0-alpha.1597441575+9563bb8f'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource spotinst 2.9.0-alpha.1597441575+9563bb8f`
                """)
            else:
                raise
