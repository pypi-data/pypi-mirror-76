...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'spotinst', '2.9.0-alpha.1597248995+2b76bad3'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource spotinst 2.9.0-alpha.1597248995+2b76bad3`
                """)
            else:
                raise
