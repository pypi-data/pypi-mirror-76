...
def initialise_oauth_user_info(apps, schema_editor):
    ...
    OAuthToken = apps.get_model('kde_account_oauth_client', 'OAuthToken')
    OAuthUserInfo = apps.get_model('kde_account_oauth_client', 'OAuthUserInfo')
...
class Migration(migrations.Migration):
    dependencies = [
        ...
        ('kde_account_oauth_client', '0001_initial'),
    ]
