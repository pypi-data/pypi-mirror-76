...
class StatsMatcher(betterproto.Message):
    ...
    exclusion_list: ___type_matcher_v4_alpha__.ListStringMatcher = betterproto.message_field(
        2, group="stats_matcher"
    )
    # Inclusive match. No stats are enabled except for those matching one of the
    # supplied StringMatcher protos.
    inclusion_list: ___type_matcher_v4_alpha__.ListStringMatcher = betterproto.message_field(
