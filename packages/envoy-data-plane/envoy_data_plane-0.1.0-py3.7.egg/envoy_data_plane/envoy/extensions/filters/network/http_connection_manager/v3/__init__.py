...
class HttpConnectionManager(betterproto.Message):
    ...
    # this property.
    route_config: _____config_route_v3__.RouteConfiguration = betterproto.message_field(
    ...
    common_http_protocol_options: _____config_core_v3__.HttpProtocolOptions = betterproto.message_field(
        35
    )
    # Additional HTTP/1 settings that are passed to the HTTP/1 codec.
    http_protocol_options: _____config_core_v3__.Http1ProtocolOptions = betterproto.message_field(
        8
    )
    # Additional HTTP/2 settings that are passed directly to the HTTP/2 codec.
    http2_protocol_options: _____config_core_v3__.Http2ProtocolOptions = betterproto.message_field(
        9
    )
    ...
    access_log: List[_____config_accesslog_v3__.AccessLog] = betterproto.message_field(
        13
    )
...
class LocalReplyConfig(betterproto.Message):
    ...
    body_format: _____config_core_v3__.SubstitutionFormatString = betterproto.message_field(
        2
    )
...
class ResponseMapper(betterproto.Message):
    ...
    body_format_override: _____config_core_v3__.SubstitutionFormatString = betterproto.message_field(
        4
    )
...
class ScopedRoutes(betterproto.Message):
    ...
    rds_config_source: _____config_core_v3__.ConfigSource = betterproto.message_field(3)
...
class ScopedRds(betterproto.Message):
    ...
    scoped_rds_config_source: _____config_core_v3__.ConfigSource = betterproto.message_field(
        1
    )
...
class HttpFilter(betterproto.Message):
    ...
    config_discovery: _____config_core_v3__.ExtensionConfigSource = betterproto.message_field(
        5, group="config_type"
    )
