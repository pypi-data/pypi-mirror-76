...
class ExtAuthz(betterproto.Message):
    ...
    transport_api_version: _____config_core_v3__.ApiVersion = betterproto.enum_field(12)
    ...
    filter_enabled: _____config_core_v3__.RuntimeFractionalPercent = betterproto.message_field(
        9
    )
    ...
    # disabled.
    deny_at_disable: _____config_core_v3__.RuntimeFeatureFlag = betterproto.message_field(
        11
    )
...
class AuthorizationRequest(betterproto.Message):
    ...
    allowed_headers: _____type_matcher_v3__.ListStringMatcher = betterproto.message_field(
        1
    )
    ...
    # overridden.
    headers_to_add: List[_____config_core_v3__.HeaderValue] = betterproto.message_field(
        2
    )
...
class AuthorizationResponse(betterproto.Message):
    ...
    # overridden.
    allowed_upstream_headers: _____type_matcher_v3__.ListStringMatcher = betterproto.message_field(
        1
    )
    # When this :ref:`list <envoy_api_msg_type.matcher.v3.ListStringMatcher>` is
    # set, authorization response headers that have a correspondent match will be
    ...
    # appended.
    allowed_upstream_headers_to_append: _____type_matcher_v3__.ListStringMatcher = betterproto.message_field(
        3
    )
    # When this :ref:`list <envoy_api_msg_type.matcher.v3.ListStringMatcher>`. is
    # set, authorization response headers that have a correspondent match will be
    ...
    # automatically added.
    allowed_client_headers: _____type_matcher_v3__.ListStringMatcher = betterproto.message_field(
        2
    )
