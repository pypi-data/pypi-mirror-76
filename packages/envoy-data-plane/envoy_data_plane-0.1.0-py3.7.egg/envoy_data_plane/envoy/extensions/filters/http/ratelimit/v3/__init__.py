...
class RateLimit(betterproto.Message):
    ...
    # success.
    rate_limit_service: _____config_ratelimit_v3__.RateLimitServiceConfig = betterproto.message_field(
        7
    )
    ...
    enable_x_ratelimit_headers: "RateLimitXRateLimitHeadersRfcVersion" = betterproto.enum_field(
        8
    )
