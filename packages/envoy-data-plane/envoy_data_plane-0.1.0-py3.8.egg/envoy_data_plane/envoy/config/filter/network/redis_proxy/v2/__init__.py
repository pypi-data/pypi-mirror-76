...
class RedisProxy(betterproto.Message):
    ...
    downstream_auth_password: _____api_v2_core__.DataSource = betterproto.message_field(
        6
    )
...
class RedisProxyPrefixRoutesRouteRequestMirrorPolicy(betterproto.Message):
    ...
    runtime_fraction: _____api_v2_core__.RuntimeFractionalPercent = betterproto.message_field(
        2
    )
