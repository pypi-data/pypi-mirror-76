...
class Permission(betterproto.Message):
    ...
    header: ___api_v2_route__.HeaderMatcher = betterproto.message_field(4, group="rule")
    ...
    requested_server_name: ___type_matcher__.StringMatcher = betterproto.message_field(
        9, group="rule"
    )
