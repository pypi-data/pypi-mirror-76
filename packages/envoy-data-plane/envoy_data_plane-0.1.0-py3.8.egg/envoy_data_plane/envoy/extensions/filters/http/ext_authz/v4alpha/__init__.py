...
class ExtAuthz(betterproto.Message):
    ...
    transport_api_version: _____config_core_v4_alpha__.ApiVersion = betterproto.enum_field(
        12
    )
    ...
    filter_enabled: _____config_core_v4_alpha__.RuntimeFractionalPercent = betterproto.message_field(
        9
    )
    ...
    # disabled.
    deny_at_disable: _____config_core_v4_alpha__.RuntimeFeatureFlag = betterproto.message_field(
        11
    )
...
class AuthorizationRequest(betterproto.Message):
    ...
    allowed_headers: _____type_matcher_v4_alpha__.ListStringMatcher = betterproto.message_field(
        1
    )
...
class AuthorizationResponse(betterproto.Message):
    ...
    # overridden.
    allowed_upstream_headers: _____type_matcher_v4_alpha__.ListStringMatcher = betterproto.message_field(
        1
    )
    # When this :ref:`list
    # <envoy_api_msg_type.matcher.v4alpha.ListStringMatcher>` is set,
    ...
    # automatically added.
    allowed_client_headers: _____type_matcher_v4_alpha__.ListStringMatcher = betterproto.message_field(
        2
    )
...
class CheckSettings(betterproto.Message):
    ...
    # lters.http.ext_authz.v4alpha.ExtAuthz.grpc_service>`.
