...
class Decompressor(betterproto.Message):
    ...
    decompressor_library: _____config_core_v3__.TypedExtensionConfig = betterproto.message_field(
        1
    )
    # Configuration for request decompression. Decompression is enabled by
    # default if left empty.
    request_direction_config: "DecompressorRequestDirectionConfig" = betterproto.message_field(
        2
    )
    # Configuration for response decompression. Decompression is enabled by
    # default if left empty.
    response_direction_config: "DecompressorResponseDirectionConfig" = betterproto.message_field(
        3
    )
