...
class FilterConfig(betterproto.Message):
    ...
    individual_method_stats_allowlist: _____config_core_v3__.GrpcMethodList = betterproto.message_field(
        2, group="per_method_stat_specifier"
    )
    ...
    stats_for_all_methods: Optional[bool] = betterproto.message_field(
        3, group="per_method_stat_specifier", wraps=betterproto.TYPE_BOOL
    )
