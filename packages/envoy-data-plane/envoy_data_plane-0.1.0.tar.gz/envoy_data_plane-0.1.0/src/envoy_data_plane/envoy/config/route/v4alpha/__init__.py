...
# sources: envoy/config/route/v4alpha/route_components.proto, envoy/config/route/v4alpha/route.proto, envoy/config/route/v4alpha/scoped_route.proto
...
class VirtualHost(betterproto.Message):
    ...
    retry_policy_typed_config: betterproto_lib_google_protobuf.Any = betterproto.message_field(
        20
    )
...
class RouteMatch(betterproto.Message):
    ...
    # HTTP/1.1. For HTTP/2, where CONNECT requests may have a path, the path
    # matchers will work if there is a path present. Note that CONNECT support is
    # currently considered alpha in Envoy. [#comment:TODO(htuch): Replace the
    # above comment with an alpha tag.
    ...
    # semantics.
    runtime_fraction: __core_v4_alpha__.RuntimeFractionalPercent = betterproto.message_field(
        9
    )
...
class CorsPolicy(betterproto.Message):
    ...
    # requests to filter.
    filter_enabled: __core_v4_alpha__.RuntimeFractionalPercent = betterproto.message_field(
    ...
    shadow_enabled: __core_v4_alpha__.RuntimeFractionalPercent = betterproto.message_field(
        10
    )
...
class RouteAction(betterproto.Message):
    ...
    regex_rewrite: ___type_matcher_v4_alpha__.RegexMatchAndSubstitute = betterproto.message_field(
        32
    )
    ...
    host_rewrite_path_regex: ___type_matcher_v4_alpha__.RegexMatchAndSubstitute = betterproto.message_field(
        35, group="host_rewrite_specifier"
    )
    ...
    # :ref:`rate_limits
    # <envoy_api_field_config.route.v4alpha.VirtualHost.rate_limits>` are not
    ...
    # <envoy_api_field_config.route.v4alpha.RouteAction.timeout>`, but limit the
    ...
    # <envoy_api_field_config.route.v4alpha.RouteAction.timeout>` or its default.
...
class RouteActionUpgradeConfigConnectConfig(betterproto.Message):
    ...
    proxy_protocol_config: __core_v4_alpha__.ProxyProtocolConfig = betterproto.message_field(
        1
    )
...
class RetryPolicy(betterproto.Message):
    ...
    rate_limited_retry_back_off: "RetryPolicyRateLimitedRetryBackOff" = betterproto.message_field(
        11
    )
...
class HedgePolicy(betterproto.Message):
    ...
    # implemented-hide:]
    additional_request_chance: ___type_v3__.FractionalPercent = betterproto.message_field(
        2
    )
...
class HeaderMatcher(betterproto.Message):
    ...
    safe_regex_match: ___type_matcher_v4_alpha__.RegexMatcher = betterproto.message_field(
...
class QueryParameterMatcher(betterproto.Message):
    ...
    string_match: ___type_matcher_v4_alpha__.StringMatcher = betterproto.message_field(
...
class ScopedRouteConfiguration(betterproto.Message):
    ...
    # to fetch the :ref:`envoy_api_msg_config.route.v4alpha.RouteConfiguration`
