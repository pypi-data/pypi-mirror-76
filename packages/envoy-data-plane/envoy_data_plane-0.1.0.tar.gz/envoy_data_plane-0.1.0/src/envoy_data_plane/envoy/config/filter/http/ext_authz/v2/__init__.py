...
class ExtAuthz(betterproto.Message):
    ...
    # requests.
    filter_enabled: _____api_v2_core__.RuntimeFractionalPercent = betterproto.message_field(
        9
    )
    ...
    # disabled.
    deny_at_disable: _____api_v2_core__.RuntimeFeatureFlag = betterproto.message_field(
        11
    )
...
class AuthorizationRequest(betterproto.Message):
    ...
    allowed_headers: _____type_matcher__.ListStringMatcher = betterproto.message_field(
        1
    )
    ...
    # overridden.
    headers_to_add: List[_____api_v2_core__.HeaderValue] = betterproto.message_field(2)
...
class AuthorizationResponse(betterproto.Message):
    ...
    # overridden.
    allowed_upstream_headers: _____type_matcher__.ListStringMatcher = betterproto.message_field(
        1
    )
    # When this :ref:`list <envoy_api_msg_type.matcher.ListStringMatcher>`. is
    # set, authorization response headers that have a correspondent match will be
    ...
    # automatically added.
    allowed_client_headers: _____type_matcher__.ListStringMatcher = betterproto.message_field(
        2
    )
