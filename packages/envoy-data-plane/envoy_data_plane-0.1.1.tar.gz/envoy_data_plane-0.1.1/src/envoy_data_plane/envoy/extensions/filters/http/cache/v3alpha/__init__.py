...
class CacheConfig(betterproto.Message):
    ...
    # [#not-implemented-hide:] <TODO(toddmgreer) implement *vary* headers> List
    # of allowed *Vary* headers. The *vary* response header holds a list of
    # header names that affect the contents of a response, as described by
    ...
    # *vary* header mentions any header names that aren't in
