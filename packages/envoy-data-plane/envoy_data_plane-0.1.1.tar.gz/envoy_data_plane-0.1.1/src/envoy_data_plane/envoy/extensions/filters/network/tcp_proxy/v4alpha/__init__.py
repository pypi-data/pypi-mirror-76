...
class TcpProxy(betterproto.Message):
    ...
    metadata_match: _____config_core_v4_alpha__.Metadata = betterproto.message_field(9)
...
class TcpProxyWeightedClusterClusterWeight(betterproto.Message):
    ...
    # *envoy.lb*.
    metadata_match: _____config_core_v4_alpha__.Metadata = betterproto.message_field(3)
