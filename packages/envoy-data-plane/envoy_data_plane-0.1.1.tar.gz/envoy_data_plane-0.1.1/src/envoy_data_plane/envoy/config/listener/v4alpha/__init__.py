...
class FilterChainMatch(betterproto.Message):
    ...
    # ignored.
    source_prefix_ranges: List[__core_v4_alpha__.CidrRange] = betterproto.message_field(
        6
    )
...
class Listener(betterproto.Message):
    ...
    socket_options: List[__core_v4_alpha__.SocketOption] = betterproto.message_field(13)
    ...
    # implemented-hide:]
    udp_writer_config: __core_v4_alpha__.TypedExtensionConfig = betterproto.message_field(
        23
    )
