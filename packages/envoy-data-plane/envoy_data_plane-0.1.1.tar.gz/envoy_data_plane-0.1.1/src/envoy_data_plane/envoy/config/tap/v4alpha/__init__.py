...
class TapConfig(betterproto.Message):
    ...
    tap_enabled: __core_v4_alpha__.RuntimeFractionalPercent = betterproto.message_field(
        3
    )
...
class MatchPredicate(betterproto.Message):
    ...
    http_response_generic_body_match: "HttpGenericBodyMatch" = betterproto.message_field(
        10, group="rule"
    )
