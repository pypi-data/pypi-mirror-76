...
class ClusterDiscoveryServiceStub(betterproto.ServiceStub):
    ...
    async def fetch_clusters(
        ...
        *,
        version_info: str = "",
        node: Optional[core.Node] = None,
        resource_names: List[str] = [],
        type_url: str = "",
        response_nonce: str = "",
        error_detail: Optional[___google_rpc__.Status] = None,
    ) -> DiscoveryResponse:
...
class VirtualHostDiscoveryServiceStub(betterproto.ServiceStub):
    ...
    <envoy_api_field_DeltaDiscoveryRequest.resource_names_subscribe>` field
    contains a list of virtual host names or aliases to track. The contents of
    an alias would be the contents of a *host* or *authority* header used to
    make an http request. An xDS server will match an alias to a virtual host
    based on the content of :ref:`domains'
    <envoy_api_field_route.VirtualHost.domains>` field. The
    *resource_names_unsubscribe* field contains a list of virtual host names
    that have been :ref:`unsubscribed <xds_protocol_unsubscribe>` from the
    routing table associated with the RouteConfiguration.
    """
...
class ScopedRoutesDiscoveryServiceStub(betterproto.ServiceStub):
    ...
    :ref:`RouteConfiguration<envoy_api_msg_RouteConfiguration>` message) to
    each HTTP request.
    """
