...
class TlsCertificate(betterproto.Message):
    ...
    # [#not-implemented-hide:]
    signed_certificate_timestamp: List[_core__.DataSource] = betterproto.message_field(
        5
    )
...
class CertificateValidationContext(betterproto.Message):
    ...
    trust_chain_verification: "CertificateValidationContextTrustChainVerification" = betterproto.enum_field(
        10
    )
