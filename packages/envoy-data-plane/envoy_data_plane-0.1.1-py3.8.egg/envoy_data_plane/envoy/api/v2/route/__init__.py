...
class VirtualHost(betterproto.Message):
    ...
    request_headers_to_add: List[_core__.HeaderValueOption] = betterproto.message_field(
        7
    )
...
class RouteAction(betterproto.Message):
    ...
    regex_rewrite: ___type_matcher__.RegexMatchAndSubstitute = betterproto.message_field(
        32
    )
...
class HedgePolicy(betterproto.Message):
    ...
    # implemented-hide:]
    additional_request_chance: ___type__.FractionalPercent = betterproto.message_field(
        2
    )
