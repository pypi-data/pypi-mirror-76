...
class DnsCacheConfig(betterproto.Message):
    ...
    dns_lookup_family: ____config_cluster_v3__.ClusterDnsLookupFamily = betterproto.enum_field(
        2
    )
    ...
    dns_failure_refresh_rate: ____config_cluster_v3__.ClusterRefreshRate = betterproto.message_field(
        6
    )
