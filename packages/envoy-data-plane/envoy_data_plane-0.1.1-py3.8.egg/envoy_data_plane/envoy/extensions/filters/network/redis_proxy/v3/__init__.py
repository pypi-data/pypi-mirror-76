...
class RedisProxy(betterproto.Message):
    ...
    downstream_auth_password: _____config_core_v3__.DataSource = betterproto.message_field(
        6
    )
    ...
    downstream_auth_username: _____config_core_v3__.DataSource = betterproto.message_field(
        7
    )
...
class RedisProxyPrefixRoutesRouteRequestMirrorPolicy(betterproto.Message):
    ...
    runtime_fraction: _____config_core_v3__.RuntimeFractionalPercent = betterproto.message_field(
        2
    )
...
class RedisProxyRedisFault(betterproto.Message):
    ...
    fault_enabled: _____config_core_v3__.RuntimeFractionalPercent = betterproto.message_field(
        2
    )
