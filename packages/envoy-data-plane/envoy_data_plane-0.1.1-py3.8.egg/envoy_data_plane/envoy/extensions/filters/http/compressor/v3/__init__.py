...
class Compressor(betterproto.Message):
    ...
    # defaults to enabled.
    runtime_enabled: _____config_core_v3__.RuntimeFeatureFlag = betterproto.message_field(
        5
    )
    ...
    compressor_library: _____config_core_v3__.TypedExtensionConfig = betterproto.message_field(
        6
    )
