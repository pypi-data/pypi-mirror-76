...
# sources: envoy/config/route/v3/route_components.proto, envoy/config/route/v3/route.proto, envoy/config/route/v3/scoped_route.proto
...
class RouteMatch(betterproto.Message):
    ...
    # semantics.
    runtime_fraction: __core_v3__.RuntimeFractionalPercent = betterproto.message_field(
        9
    )
...
class CorsPolicy(betterproto.Message):
    ...
    shadow_enabled: __core_v3__.RuntimeFractionalPercent = betterproto.message_field(10)
...
class RouteAction(betterproto.Message):
    ...
    regex_rewrite: ___type_matcher_v3__.RegexMatchAndSubstitute = betterproto.message_field(
        32
    )
    ...
    host_rewrite_path_regex: ___type_matcher_v3__.RegexMatchAndSubstitute = betterproto.message_field(
...
class RouteActionUpgradeConfigConnectConfig(betterproto.Message):
    ...
    proxy_protocol_config: __core_v3__.ProxyProtocolConfig = betterproto.message_field(
        1
    )
