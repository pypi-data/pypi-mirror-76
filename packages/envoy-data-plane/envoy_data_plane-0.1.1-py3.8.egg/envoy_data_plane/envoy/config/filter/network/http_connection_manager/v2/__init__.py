...
class HttpConnectionManager(betterproto.Message):
    ...
    common_http_protocol_options: _____api_v2_core__.HttpProtocolOptions = betterproto.message_field(
        35
    )
    # Additional HTTP/1 settings that are passed to the HTTP/1 codec.
    http_protocol_options: _____api_v2_core__.Http1ProtocolOptions = betterproto.message_field(
        8
    )
    # Additional HTTP/2 settings that are passed directly to the HTTP/2 codec.
    http2_protocol_options: _____api_v2_core__.Http2ProtocolOptions = betterproto.message_field(
        9
    )
...
class HttpConnectionManagerTracing(betterproto.Message):
    ...
    operation_name: "HttpConnectionManagerTracingOperationName" = betterproto.enum_field(
        1
    )
...
class ScopedRds(betterproto.Message):
    ...
    scoped_rds_config_source: _____api_v2_core__.ConfigSource = betterproto.message_field(
        1
    )
