...
class Policy(betterproto.Message):
    ...
    checked_condition: ____google_api_expr_v1_alpha1__.CheckedExpr = betterproto.message_field(
        4
    )
...
class Permission(betterproto.Message):
    ...
    requested_server_name: ___type_matcher_v3__.StringMatcher = betterproto.message_field(
        9, group="rule"
    )
...
class Principal(betterproto.Message):
    ...
    source_ip: __core_v3__.CidrRange = betterproto.message_field(5, group="identifier")
    ...
    # protocol, etc.
    remote_ip: __core_v3__.CidrRange = betterproto.message_field(11, group="identifier")
    # A header (or pseudo-header such as :path or :method) on the incoming HTTP
    # request. Only available for HTTP request. Note: the pseudo-header :path
    # includes the query and fragment string. Use the `url_path` field if you
    # want to match the URL path without the query and fragment string.
