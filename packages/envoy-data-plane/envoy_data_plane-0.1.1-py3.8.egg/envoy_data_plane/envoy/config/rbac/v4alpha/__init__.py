...
class Permission(betterproto.Message):
    ...
    requested_server_name: ___type_matcher_v4_alpha__.StringMatcher = betterproto.message_field(
        9, group="rule"
    )
...
class PrincipalAuthenticated(betterproto.Message):
    ...
    principal_name: ___type_matcher_v4_alpha__.StringMatcher = betterproto.message_field(
        2
    )
