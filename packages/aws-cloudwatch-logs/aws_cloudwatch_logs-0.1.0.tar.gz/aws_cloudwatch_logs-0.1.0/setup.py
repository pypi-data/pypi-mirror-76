...
from aws_cloudwatch_logs._version import __version__
...
setup(
    ...
    url="https://github.com/normoes/aws_cloudwatch_logs",
    download_url=f"https://github.com/normoes/aws_cloudwatch_logs/archive/{__version__}.tar.gz",
    packages=find_packages(exclude=["tests*"]),
    install_requires=["boto3>=1.10.25"],
    extras_require={"test": ["mock", "pytest"]},
    scripts=["bin/aws_cloudwatch_logs"],
    # entry_points={
    #     "console_scripts": [
