define([
    ...
    var getUserInput = function() {
		require([
			...
			// var selection = $('<select id="cred" onchange="document.option_selected()"/>');
			// var idx;
			// for(idx = 0; idx < creds.length; idx++) {
			// 	var cred_num = idx + 1;
			// 	selection.append($('<option value=' + cred_num + '>' +  cred_num + '</option>'));
			// }
			...
			// document.option_selected = function() {
			// 	var value = document.getElementById("cred").value;
			// 	var idx = value.split(' ')[0];
			// 	var selected = creds[idx];
			// 	server = selected['server'];
			// 	port = selected['port'];
			// 	username = selected['user'];
					...
					'New': {
						...
						click: function() {
							...
							body.html(
								...
								<input class="form-control" id="server" type="text" placeholder="localhost">\
								</div>\
								<div class="form-group">\
								<label for="port">Port: </label>\
								<input class="form-control" id="port" type="text" placeholder="8848">\
								</div>\
								<div class="form-group">\
								<label for="username">Username: </label>\
								<input class="form-control" id="username" type="text" placeholder="admin">\
								</div>\
								<div class="form-group">\
								<label for="password">Password: </label>\
								<input class="form-control" id="password" type="password" placeholder="123456">\
								</div>\
								</form>'
							);
							// dialog
