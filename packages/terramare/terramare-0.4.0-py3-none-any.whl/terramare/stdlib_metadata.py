...
def _make_datetime(s: str) -> datetime.datetime:
    try:
        ...
        raise StdlibDeserializationError("invalid ISO-8601 datetime")
...
def _make_regex(s: str) -> Pattern:
    try:
        ...
        raise StdlibDeserializationError(f"invalid regex: {e}")
...
def _make_ipv4_address(s: str) -> ipaddress.IPv4Address:
    try:
        ...
        raise StdlibDeserializationError(f"invalid IPv4 address: {e}")
...
def _make_ipv6_address(s: str) -> ipaddress.IPv6Address:
    try:
        ...
        raise StdlibDeserializationError(f"invalid IPv6 address: {e}")
