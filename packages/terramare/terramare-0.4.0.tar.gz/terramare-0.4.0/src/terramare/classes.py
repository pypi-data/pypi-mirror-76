...
from typing import Any, Callable, Dict, FrozenSet, List, Sequence, Type, TypeVar, cast
...
def _mk_construct_fn(
    handle_exception_ts: FrozenSet[Type[Exception]], fn: Callable[[Any], T],
