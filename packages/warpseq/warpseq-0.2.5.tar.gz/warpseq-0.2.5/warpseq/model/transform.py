...
class Transform(NewReferenceObject, Directionable):
    ...
    def __init__(self, song=None, name=None, slots=None, octave_slots=None, divide=1, obj_id=None,
        ...
        self._mod = ModExpression(song=song, defer=False) # song may be None, will update later
    ...
    def process(self, song, pattern, scale, track, note_list, t_start, slot_duration):
        ...
        # transform reset here seems incorrect because it means patterns of different lengths will not fly
