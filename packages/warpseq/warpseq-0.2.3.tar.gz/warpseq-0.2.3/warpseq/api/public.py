...
class Transforms(CollectionApi):
    ...
    public_fields    = [ 'name', 'slots', 'octave_slots', 'divide', 'applies_to', 'direction' ]
    ...
    def add(self, name, slots:list=None, octave_slots:list=None, divide:int=1, applies_to:str=None, direction='forward'):
        params = locals()
        return self._generic_add(name, params)

    def edit(self, name, new_name:str=None, slots:list=None, octave_slots:list=None, divide:int=1, applies_to:str=None, direction=None):
        params = locals()
        return self._generic_edit(name, params)
