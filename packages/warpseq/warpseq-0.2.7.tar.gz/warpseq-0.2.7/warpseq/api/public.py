...
from ..playback.realtime_engine import RealtimeEngine
from ..playback.multi_player import MultiPlayer
from ..playback.midi import get_devices
...
class Transforms(CollectionApi):
    ...
    public_fields    = [ 'name', 'slots', 'octave_slots', 'divide', 'applies_to', 'direction', 'auto_reset' ]
    ...
    def add(self, name, slots:list=None, octave_slots:list=None, divide:int=1, applies_to:str=None, direction='forward', auto_reset=False):
        params = locals()
        return self._generic_add(name, params)

    def edit(self, name, new_name:str=None, slots:list=None, octave_slots:list=None, divide:int=1, applies_to:str=None, direction=None, auto_reset=None):
        params = locals()
        return self._generic_edit(name, params)
...
class Patterns(CollectionApi):
    ...
    def edit(self, name, new_name:str=None, slots:list=None, direction=None, length=None):
        params = locals()
        return self._generic_edit(name, params)
