...
class Rule:
    ...
    def match(
        self,
        initial: t.Optional[Initial],
        vowel: t.Optional[Vowel],
        final: t.Optional[Final],
    ) -> bool:
...
class Syllable:
    ...
    @property
    def hangul_initial(self) -> str:
        return self.initial.hangul

    @property
    def hangul_vowel(self) -> str:
        return self.vowel.hangul

    @property
    def hangul_final(self):
        return "" if self.final.hangul is None else self.final.hangul
