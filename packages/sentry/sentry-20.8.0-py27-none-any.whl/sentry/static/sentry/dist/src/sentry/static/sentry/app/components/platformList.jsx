...
})(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  border-radius: ", ";\n  box-shadow: 0 0 0 1px ", ";\n  &:not(:first-child) {\n    margin-left: ", ";\n  }\n"], ["\n  border-radius: ", ";\n  box-shadow: 0 0 0 1px ", ";\n  &:not(:first-child) {\n    margin-left: ", ";\n  }\n"])), function (p) { return p.theme.borderRadius; }, function (p) { return p.theme.white; }, function (p) { return p.size * -1 + getOverlapWidth(p.size) + "px;"; });
