...
var NavMenuToggle = styled(Button)(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  display: none;\n  margin: -", " ", " -", " -", ";\n  padding: ", ";\n  color: ", ";\n  &:hover,\n  &:focus,\n  &:active {\n    color: ", ";\n  }\n  @media (max-width: ", ") {\n    display: block;\n  }\n"], ["\n  display: none;\n  margin: -", " ", " -", " -", ";\n  padding: ", ";\n  color: ", ";\n  &:hover,\n  &:focus,\n  &:active {\n    color: ", ";\n  }\n  @media (max-width: ", ") {\n    display: block;\n  }\n"])), space(1), space(1), space(1), space(1), space(1), function (p) { return p.theme.gray600; }, function (p) { return p.theme.gray800; }, function (p) { return p.theme.breakpoints[0]; });
