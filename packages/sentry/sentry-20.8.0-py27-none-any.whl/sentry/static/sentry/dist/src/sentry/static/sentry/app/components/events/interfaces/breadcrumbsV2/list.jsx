...
var ListContainer = /** @class */ (function (_super) {
    ...
    ListContainer.prototype.render = function () {
        ...
        var scrollToIndex = this.state.scrollToIndex;
          ...
          {function (_a) {
            ...
            return (<React.Fragment>
              ...
              <StyledList ref={function (el) {
                _this.listRef = el;
            }} deferredMeasurementCache={cache} height={LIST_MAX_HEIGHT} overscanRowCount={5} rowCount={breadcrumbs.length} rowHeight={cache.rowHeight} rowRenderer={_this.renderRow} width={width} 
