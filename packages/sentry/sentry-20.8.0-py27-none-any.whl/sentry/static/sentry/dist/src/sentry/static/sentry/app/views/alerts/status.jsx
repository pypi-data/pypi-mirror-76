...
var Status = function (_a) {
    ...
    var icon = isResolved ? (<IconCheckmark color={disableIconColor ? undefined : 'green400'}/>) : isWarning ? (<IconWarning color={disableIconColor ? undefined : 'orange400'}/>) : (<IconFire color={disableIconColor ? undefined : 'red400'}/>);
