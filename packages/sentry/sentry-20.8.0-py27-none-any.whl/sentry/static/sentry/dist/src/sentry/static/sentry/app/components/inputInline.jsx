...
var Input = styled('div')(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  min-width: 40px;\n  margin: 0;\n  border: 1px solid ", ";\n  outline: none;\n\n  line-height: inherit;\n  border-radius: ", ";\n  background: transparent;\n\n  &:focus,\n  &:active {\n    border: 1px solid ", ";\n    background-color: ", ";\n  }\n"], ["\n  min-width: 40px;\n  margin: 0;\n  border: 1px solid ", ";\n  outline: none;\n\n  line-height: inherit;\n  border-radius: ", ";\n  background: transparent;\n\n  &:focus,\n  &:active {\n    border: 1px solid ", ";\n    background-color: ", ";\n  }\n"])), function (p) { return (p.isHovering ? p.theme.borderDark : 'transparent'); }, space(0.5), function (p) { return (p.isDisabled ? 'transparent' : p.theme.borderLight); }, function (p) { return (p.isDisabled ? 'transparent' : p.theme.gray300); });
