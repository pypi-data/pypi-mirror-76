...
var DurationPercentileChart = /** @class */ (function (_super) {
    ...
    DurationPercentileChart.prototype.renderBody = function () {
        ...
        return (<AreaChart grid={{ left: '10px', right: '10px', top: '40px', bottom: '0px' }} xAxis={xAxis} yAxis={{ type: 'value' }} series={transformData(chartData.data)} tooltip={tooltip} colors={colors}/>);
    };
