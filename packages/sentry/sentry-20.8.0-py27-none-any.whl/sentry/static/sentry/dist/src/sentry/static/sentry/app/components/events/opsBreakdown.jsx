...
var OpsBreakdown = /** @class */ (function (_super) {
    ...
    OpsBreakdown.prototype.render = function () {
        ...
        {breakdown.map(function (currOp) {
            ...
            var opsColor = pickSpanBarColour(name);
            return (<OpsLine key={name}>
              <OpsNameContainer>
...
var BreakdownHeader = styled('div')(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n"], ["\n  display: flex;\n  align-items: center;\n"])));
