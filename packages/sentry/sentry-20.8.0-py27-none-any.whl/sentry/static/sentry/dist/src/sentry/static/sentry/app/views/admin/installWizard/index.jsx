...
var Pattern = styled('div')(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  &::before {\n    ", "\n    content: '';\n    background-image: linear-gradient(\n      to right,\n      ", " 0%,\n      ", " 100%\n    );\n    background-repeat: repeat-y;\n  }\n\n  &::after {\n    ", "\n    content: '';\n    background: url(", ");\n    background-size: 400px;\n    opacity: 0.8;\n  }\n"], ["\n  &::before {\n    ", "\n    content: '';\n    background-image: linear-gradient(\n      to right,\n      ", " 0%,\n      ", " 100%\n    );\n    background-repeat: repeat-y;\n  }\n\n  &::after {\n    ", "\n    content: '';\n    background: url(", ");\n    background-size: 400px;\n    opacity: 0.8;\n  }\n"])), fixedStyle, function (p) { return p.theme.purple300; }, function (p) { return p.theme.purple400; }, fixedStyle, sentryPattern);
...
var SetupWizard = styled('div')(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  background: ", ";\n  border-radius: ", ";\n  box-shadow: ", ";\n  margin-top: 40px;\n  padding: 40px 40px 20px;\n  width: 600px;\n  z-index: ", ";\n"], ["\n  background: ", ";\n  border-radius: ", ";\n  box-shadow: ", ";\n  margin-top: 40px;\n  padding: 40px 40px 20px;\n  width: 600px;\n  z-index: ", ";\n"])), function (p) { return p.theme.white; }, function (p) { return p.theme.borderRadius; }, function (p) { return p.theme.dropShadowHeavy; }, function (p) { return p.theme.zIndex.initial; });
