...
var Placeholder = styled(function (props) {
    ...
    "\n"])), function (p) { return (p.error ? p.theme.red100 : p.theme.gray200); }, function (p) { return p.error && "color: " + p.theme.red300 + ";"; }, function (p) { return p.width; }, function (p) { return p.height; }, function (p) { return (p.shape === 'circle' ? 'border-radius: 100%;' : ''); }, function (p) {
