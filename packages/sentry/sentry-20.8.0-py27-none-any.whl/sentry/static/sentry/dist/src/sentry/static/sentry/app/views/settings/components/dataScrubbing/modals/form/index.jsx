...
var Form = /** @class */ (function (_super) {
    ...
    Form.prototype.render = function () {
        ...
        <SourceGroup isExpanded={displayEventId}>
          ...
          <Field data-test-id="source-field" label={t('Source')} help={t('Where to look. In the simplest case this can be an attribute name.')} inline={false} error={errors === null || errors === void 0 ? void 0 : errors.source} flexibleControlStateSize stacked required showHelpInTooltip>
            <SourceField onChange={function (value) { return onChange('source', value); }} value={source} onBlur={onValidate('source')} isRegExMatchesSelected={type === RuleType.PATTERN} suggestions={sourceSuggestions}/>
          </Field>
        </SourceGroup>
      </React.Fragment>);
    };
