...
var Pagination = /** @class */ (function (_super) {
    ...
    Pagination.prototype.render = function () {
        ...
        <ButtonBar merged>
          <Button icon={<IconChevron direction="left" size="sm" color={previousDisabled ? 'gray400' : 'gray700'}/>} aria-label={t('Previous')} disabled={previousDisabled} onClick={function () {
            callIfFunction(onCursor, links.previous.cursor, path, query, -1);
        }}/>
          <Button icon={<IconChevron direction="right" size="sm" color={nextDisabled ? 'gray400' : 'gray700'}/>} aria-label={t('Next')} disabled={nextDisabled} onClick={function () {
