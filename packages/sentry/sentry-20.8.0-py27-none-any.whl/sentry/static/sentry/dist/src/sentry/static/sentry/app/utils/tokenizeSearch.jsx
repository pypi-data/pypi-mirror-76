...
var QueryResults = /** @class */ (function () {
    ...
    QueryResults.prototype.addTag = function (key, tags) {
        var e_3, _a;
        try {
            for (var tags_1 = __values(tags), tags_1_1 = tags_1.next(); !tags_1_1.done; tags_1_1 = tags_1.next()) {
                var t = tags_1_1.value;
                this.tagValues[key] = Array.isArray(this.tagValues[key])
                    ? __spread(this.tagValues[key], [t]) : [t];
                var token = { type: TokenType.TAG, key: key, value: t };
    ...
    QueryResults.prototype.setTag = function (key, tags) {
        this.removeTag(key);
        this.addTag(key, tags);
        return this;
    };
    QueryResults.prototype.getTags = function (key) {
    ...
    QueryResults.prototype.removeTagValue = function (key, value) {
        var values = this.getTags(key);
        if (Array.isArray(values) && values.length) {
            this.setTag(key, values.filter(function (item) { return item !== value; }));
        }
    };
