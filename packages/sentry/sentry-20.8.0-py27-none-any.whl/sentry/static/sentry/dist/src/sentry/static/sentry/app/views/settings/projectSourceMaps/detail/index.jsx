...
var ProjectSourceMaps = /** @class */ (function (_super) {
    ...
    ProjectSourceMaps.prototype.renderArtifacts = function () {
        ...
        return artifacts.map(function (artifact) {
            return (<SourceMapsArtifactRow key={artifact.id} artifact={artifact} onDelete={_this.handleArtifactDelete} downloadUrl={"" + artifactApiUrl + artifact.id + "/?download=1"}/>);
        });
    };
    ProjectSourceMaps.prototype.renderBody = function () {
        ...
        <StyledSettingsPageHeader title={<Title>
              ...
              <Confirm message={t('Are you sure you want to remove all artifacts in this archive?')} onConfirm={this.handleArchiveDelete}>
                <Button icon={<IconDelete size="sm"/>} title={t('Remove All Artifacts')}/>
              </Confirm>
