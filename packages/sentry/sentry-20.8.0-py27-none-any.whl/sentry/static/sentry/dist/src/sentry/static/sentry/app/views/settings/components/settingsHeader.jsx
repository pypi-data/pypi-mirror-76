...
var SettingsHeader = styled('div')(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  position: sticky;\n  top: 0;\n  z-index: ", ";\n  padding: ", " ", ";\n  border-bottom: 1px solid ", ";\n  background: #fff;\n  height: ", ";\n"], ["\n  position: sticky;\n  top: 0;\n  z-index: ", ";\n  padding: ", " ", ";\n  border-bottom: 1px solid ", ";\n  background: #fff;\n  height: ", ";\n"])), function (p) { return p.theme.zIndex.header + HEADER_Z_INDEX_OFFSET; }, space(3), space(4), function (p) { return p.theme.borderLight; }, function (p) { return p.theme.settings.headerHeight; });
