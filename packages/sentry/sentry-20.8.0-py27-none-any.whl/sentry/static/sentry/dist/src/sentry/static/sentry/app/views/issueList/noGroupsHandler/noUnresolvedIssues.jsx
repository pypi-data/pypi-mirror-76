...
var CongratsRobotsVideo = React.lazy(function () {
    return import(/* webpackChunkName: "CongratsRobotsVideo" */ './congratsRobots');
});
/**
...
var Wrapper = styled('div')(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  display: flex;\n  padding: ", " ", ";\n  flex-direction: column;\n  align-items: center;\n  text-align: center;\n  color: ", ";\n\n  @media (max-width: ", ") {\n    font-size: ", ";\n  }\n"], ["\n  display: flex;\n  padding: ", " ", ";\n  flex-direction: column;\n  align-items: center;\n  text-align: center;\n  color: ", ";\n\n  @media (max-width: ", ") {\n    font-size: ", ";\n  }\n"])), space(4), space(4), function (p) { return p.theme.gray600; }, function (p) { return p.theme.breakpoints[0]; }, function (p) { return p.theme.fontSizeMedium; });
