...
var StatusMessage = styled('div')(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n  display: grid;\n  grid-template-columns: max-content max-content;\n  grid-gap: ", ";\n  align-items: center;\n  font-size: ", ";\n  color: ", ";\n\n  > :first-child {\n    ", ";\n  }\n"], ["\n  display: grid;\n  grid-template-columns: max-content max-content;\n  grid-gap: ", ";\n  align-items: center;\n  font-size: ", ";\n  color: ", ";\n\n  > :first-child {\n    ", ";\n  }\n"])), space(1), function (p) { return p.theme.fontSizeMedium; }, function (p) { return (p.status === 'error' ? p.theme.red400 : p.theme.gray600); }, function (p) { return p.status === 'success' && "color: " + p.theme.green400; });
