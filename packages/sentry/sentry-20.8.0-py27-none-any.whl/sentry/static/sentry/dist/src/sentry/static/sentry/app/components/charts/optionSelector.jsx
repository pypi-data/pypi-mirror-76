...
var StyledDropdownButton = styled(DropdownButton)(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  padding: ", " ", ";\n  font-weight: normal;\n  color: ", ";\n  z-index: ", ";\n\n  &:hover,\n  &:focus,\n  &:active {\n    color: ", ";\n  }\n"], ["\n  padding: ", " ", ";\n  font-weight: normal;\n  color: ", ";\n  z-index: ", ";\n\n  &:hover,\n  &:focus,\n  &:active {\n    color: ", ";\n  }\n"])), space(1), space(2), function (p) { return p.theme.gray600; }, function (p) { return (p.isOpen ? p.theme.zIndex.dropdownAutocomplete.actor : 'auto'); }, function (p) { return p.theme.gray700; });
