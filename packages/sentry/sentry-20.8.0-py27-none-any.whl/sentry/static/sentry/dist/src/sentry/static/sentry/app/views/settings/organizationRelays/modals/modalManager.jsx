...
var DialogManager = /** @class */ (function (_super) {
    ...
    DialogManager.prototype.render = function () {
        var _a = this.state, values = _a.values, errors = _a.errors, title = _a.title, isFormValid = _a.isFormValid, disables = _a.disables;
        return (<Modal {...this.props} title={title} onSave={this.handleSave} disabled={!isFormValid} content={<Form onChange={this.handleChange} onValidate={this.handleValidate} onValidateKey={this.handleValidateKey} errors={errors} values={values} disables={disables}/>}/>);
    };
