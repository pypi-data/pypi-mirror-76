...
function makeGenericTransactionCta(opts) {
    ...
    var transaction = (_b = query.getTags('transaction')) === null || _b === void 0 ? void 0 : _b.find(function (filter) { return !filter.includes('*'); });
    // CASE 1
...
function makeFailureRateCta(_a) {
    ...
    var transaction = (_c = query.getTags('transaction')) === null || _c === void 0 ? void 0 : _c.find(function (filter) { return !filter.includes('*'); });
