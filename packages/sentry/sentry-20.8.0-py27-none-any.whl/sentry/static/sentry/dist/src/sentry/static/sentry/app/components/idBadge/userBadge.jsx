...
var UserBadge = function (_a) {
    var className = _a.className, displayName = _a.displayName, displayEmail = _a.displayEmail, avatarSize = _a.avatarSize, _b = _a.hideEmail, hideEmail = _b === void 0 ? false : _b, user = _a.user;
