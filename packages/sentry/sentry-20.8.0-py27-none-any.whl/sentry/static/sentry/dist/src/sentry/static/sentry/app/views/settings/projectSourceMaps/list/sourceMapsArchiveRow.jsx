...
var SourceMapsArchiveRow = function (_a) {
    ...
    return (<React.Fragment>
      ...
      <ActionsColumn>
        <ButtonBar gap={0.5}>
          <Confirm onConfirm={function () { return onDelete(name); }} message={t('Are you sure you want to remove all artifacts in this archive?')}>
            <Button size="small" icon={<IconDelete size="sm"/>} title={t('Remove All Artifacts')}/>
          </Confirm>
        </ButtonBar>
      </ActionsColumn>
    </React.Fragment>);
