...
var GuideAnchor = createReactClass({
    ...
    render: function () {
        ...
        return (<StyledHovercard show body={this.getHovercardBody()} tipColor={theme.purple400} position={position} offset={offset}>
        <span ref={function (el) { return (_this.containerElement = el); }}>{children}</span>
      </StyledHovercard>);
    },
});
var GuideContainer = styled('div')(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  display: grid;\n  grid-template-rows: repeat(2, auto);\n  grid-gap: ", ";\n  text-align: center;\n  line-height: 1.5;\n  background-color: ", ";\n  border-color: ", ";\n  color: ", ";\n"], ["\n  display: grid;\n  grid-template-rows: repeat(2, auto);\n  grid-gap: ", ";\n  text-align: center;\n  line-height: 1.5;\n  background-color: ", ";\n  border-color: ", ";\n  color: ", ";\n"])), space(2), function (p) { return p.theme.purple400; }, function (p) { return p.theme.purple400; }, function (p) { return p.theme.gray100; });
