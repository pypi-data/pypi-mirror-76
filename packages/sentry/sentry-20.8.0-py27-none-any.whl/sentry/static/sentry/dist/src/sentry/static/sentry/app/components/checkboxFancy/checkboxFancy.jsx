...
var disabledStyles = function (p) {
    return p.isDisabled && css(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n    background: ", ";\n    border-color: ", ";\n  "], ["\n    background: ", ";\n    border-color: ", ";\n  "])), p.isChecked || p.isIndeterminate ? p.theme.gray400 : p.theme.gray100, p.theme.borderDark);
};
...
var CheckboxFancy = styled(function (_a) {
    ...
    return p.isChecked || p.isIndeterminate ? p.theme.purple400 : 'transparent';
}, function (p) { return (p.isChecked || p.isIndeterminate ? p.theme.purple400 : p.theme.gray500); }, function (p) { return (p.isDisabled ? 'not-allowed' : 'pointer'); }, function (p) { return (!p.isChecked || !p.isIndeterminate) && 'transition: 500ms border ease-out'; }, hoverStyles, disabledStyles);
