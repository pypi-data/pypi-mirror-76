...
var InviteMembers = /** @class */ (function (_super) {
    ...
    InviteMembers.prototype.render = function () {
        var _a;
        var _b = this.state, invitedEmails = _b.invitedEmails, roleList = _b.roleList;
        var _c = this.props, project = _c.project, formProps = _c.formProps, organization = _c.organization;
        ...
        <Panel>
          <Form apiEndpoint={"/organizations/" + organization.slug + "/members/"} apiMethod="POST" submitLabel={t('Invite Member')} onSubmitSuccess={this.handleSubmitSuccess} initialData={{ teams: [(_a = project === null || project === void 0 ? void 0 : project.teams[0]) === null || _a === void 0 ? void 0 : _a.slug] }} {...formProps}>
            <HelpText>
