...
var EventDetailsContent = /** @class */ (function (_super) {
    ...
    EventDetailsContent.prototype.renderContent = function (event) {
        var _a;
        var _b = this.props, api = _b.api, organization = _b.organization, location = _b.location, eventView = _b.eventView;
          ...
          <Layout.Main fullWidth={!isSidebarVisible}>
            ...
            return (<SpanEntryContext.Provider value={{
                getViewChildTransactionTarget: function (childTransactionProps) {
                  ...
                  <BorderlessEventEntries api={api} organization={organization} event={event} project={projects[0]} location={location} showExampleCommit={false} showTagSummary={false}/>
    ...
    EventDetailsContent.prototype.renderComponent = function () {
        ...
        var event = this.state.event;
        var title = generateTitle({ eventView: eventView, event: event });
