...
var TraceView = /** @class */ (function (_super) {
    ...
    TraceView.prototype.render = function () {
        ...
        var _b = this.props, orgId = _b.orgId, organization = _b.organization, spansWithErrors = _b.spansWithErrors;
        ...
        {function (dragProps) { return (<CursorGuideHandler.Provider interactiveLayerRef={_this.minimapInteractiveRef} dragProps={dragProps} trace={parsedTrace}>
            ...
            <SpanTree event={event} trace={parsedTrace} dragProps={dragProps} filterSpans={_this.state.filterSpans} orgId={orgId} organization={organization} spansWithErrors={spansWithErrors}/>
