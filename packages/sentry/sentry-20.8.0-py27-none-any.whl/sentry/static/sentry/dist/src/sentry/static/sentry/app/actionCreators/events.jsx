...
function getBaseUrl(org, keyTransactions) {
    if (keyTransactions) {
...
export var doEventsRequest = function (api, _a) {
    var organization = _a.organization, project = _a.project, environment = _a.environment, period = _a.period, start = _a.start, end = _a.end, interval = _a.interval, includePrevious = _a.includePrevious, query = _a.query, yAxis = _a.yAxis, field = _a.field, referenceEvent = _a.referenceEvent, keyTransactions = _a.keyTransactions, topEvents = _a.topEvents, orderby = _a.orderby;
