...
var MatchedSpanDetailsContent = function (props) {
    ...
    return (<div>
      ...
      <Row baselineTitle={t('Baseline Span ID')} regressionTitle={t('Regressive Span ID')} renderBaselineContent={function () { return baselineSpan.span_id; }} renderRegressionContent={function () { return regressionSpan.span_id; }}/>
    ...
    return (<RowSplitter>
      <RowContainer>
        ...
        height: '16px',
            ...
            <DurationPill durationDisplay={baselineDurationDisplay} fontColors={{ right: theme.gray700, inset: theme.white }}>
      ...
      <RowContainer>
        ...
        height: '16px',
            ...
            <DurationPill durationDisplay={regressionDurationDisplay} fontColors={{ right: theme.gray700, inset: theme.gray700 }}>
