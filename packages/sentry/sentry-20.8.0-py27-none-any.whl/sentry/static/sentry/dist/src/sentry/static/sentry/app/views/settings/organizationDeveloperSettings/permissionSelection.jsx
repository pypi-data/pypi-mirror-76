...
var PermissionSelection = /** @class */ (function (_super) {
    ...
    PermissionSelection.prototype.permissionStateToList = function () {
        ...
        return flatMap(Object.entries(permissions), function (_a) {
            var _b = __read(_a, 2), r = _b[0], p = _b[1];
            var _c, _d, _e;
            return (_e = (_d = (_c = findResource(r)) === null || _c === void 0 ? void 0 : _c.choices) === null || _d === void 0 ? void 0 : _d[p]) === null || _e === void 0 ? void 0 : _e.scopes;
        });
    };
