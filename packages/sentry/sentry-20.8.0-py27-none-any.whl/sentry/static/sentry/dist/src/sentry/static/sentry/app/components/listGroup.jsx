...
var ListGroupItem = styled('li')(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  position: relative;\n  display: block;\n  min-height: 36px;\n  border: 1px solid ", ";\n\n  padding: ", " ", ";\n\n  margin-bottom: -1px;\n  ", "\n\n  &:first-child {\n    border-top-left-radius: ", ";\n    border-top-right-radius: ", ";\n  }\n  &:last-child {\n    border-bottom-left-radius: ", ";\n    border-bottom-right-radius: ", ";\n  }\n"], ["\n  position: relative;\n  display: block;\n  min-height: 36px;\n  border: 1px solid ", ";\n\n  padding: ", " ", ";\n\n  margin-bottom: -1px;\n  ", "\n\n  &:first-child {\n    border-top-left-radius: ", ";\n    border-top-right-radius: ", ";\n  }\n  &:last-child {\n    border-bottom-left-radius: ", ";\n    border-bottom-right-radius: ", ";\n  }\n"])), function (p) { return p.theme.borderLight; }, space(0.5), space(1.5), function (p) { return (p.centered ? 'text-align: center;' : ''); }, function (p) { return p.theme.borderRadius; }, function (p) { return p.theme.borderRadius; }, function (p) { return p.theme.borderRadius; }, function (p) { return p.theme.borderRadius; });
