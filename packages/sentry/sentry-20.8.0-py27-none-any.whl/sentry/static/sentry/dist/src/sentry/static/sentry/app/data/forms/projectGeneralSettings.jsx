...
export var fields = {
    ...
    storeCrashReports: {
        ...
        help: t('Store native crash reports such as Minidumps for improved processing and download in issue details. Overrides organization settings.'),
        visible: function (_a) {
            var features = _a.features;
            return features.has('event-attachments');
        },
        formatLabel: function (value) { return formatStoreCrashReports(value, { inProjectSettings: true }); },
