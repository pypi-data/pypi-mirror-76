...
var Spinner = styled('div')(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  animation: ", " 0.4s linear infinite;\n  width: 18px;\n  height: 18px;\n  border-radius: 18px;\n  border-top: 2px solid ", ";\n  border-right: 2px solid ", ";\n  border-bottom: 2px solid ", ";\n  border-left: 2px solid ", ";\n  margin-left: auto;\n"], ["\n  animation: ", " 0.4s linear infinite;\n  width: 18px;\n  height: 18px;\n  border-radius: 18px;\n  border-top: 2px solid ", ";\n  border-right: 2px solid ", ";\n  border-bottom: 2px solid ", ";\n  border-left: 2px solid ", ";\n  margin-left: auto;\n"])), spin, function (p) { return p.theme.borderLight; }, function (p) { return p.theme.borderLight; }, function (p) { return p.theme.borderLight; }, function (p) { return p.theme.purple400; });
