...
var ActivityContainer = /** @class */ (function (_super) {
                    ...
                    case 3:
                        ...
                        this.setState(function (state) {
                            ...
                            return {
                                ...
                                createBusy: false,
                                createError: true,
                                createErrorJSON: error_1.responseJSON || makeDefaultErrorJson(),
                            };
                        });
                        return [3 /*break*/, 4];
    ...
    ActivityContainer.prototype.render = function () {
        ...
        return (<Activity noteInputId={this.state.noteInputId} alertId={alertId} me={me} api={api} {...this.state} loading={this.state.loading || !incident} incident={incident} onCreateNote={this.handleCreateNote} onUpdateNote={this.handleUpdateNote} onDeleteNote={this.handleDeleteNote} {...props}/>);
    };
