...
var OpenInContainer = styled('div')(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  position: relative;\n  z-index: 1;\n  display: grid;\n  grid-template-columns: repeat(", ", max-content);\n  grid-gap: ", ";\n  color: ", ";\n  background-color: ", ";\n  font-family: ", ";\n  border-bottom: 1px solid ", ";\n  padding: ", " ", ";\n  box-shadow: ", ";\n  text-indent: initial;\n  overflow: auto;\n  white-space: nowrap;\n"], ["\n  position: relative;\n  z-index: 1;\n  display: grid;\n  grid-template-columns: repeat(", ", max-content);\n  grid-gap: ", ";\n  color: ", ";\n  background-color: ", ";\n  font-family: ", ";\n  border-bottom: 1px solid ", ";\n  padding: ", " ", ";\n  box-shadow: ", ";\n  text-indent: initial;\n  overflow: auto;\n  white-space: nowrap;\n"])), function (p) { return p.columnQuantity; }, space(1), function (p) { return p.theme.gray600; }, function (p) { return p.theme.white; }, function (p) { return p.theme.text.family; }, function (p) { return p.theme.borderLight; }, space(0.25), space(3), function (p) { return p.theme.dropShadowLightest; });
var OpenInLink = styled(ExternalLink)(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  display: inline-grid;\n  align-items: center;\n  grid-template-columns: max-content auto;\n  grid-gap: ", ";\n  color: ", ";\n"], ["\n  display: inline-grid;\n  align-items: center;\n  grid-template-columns: max-content auto;\n  grid-gap: ", ";\n  color: ", ";\n"])), space(0.75), function (p) { return p.theme.gray500; });
