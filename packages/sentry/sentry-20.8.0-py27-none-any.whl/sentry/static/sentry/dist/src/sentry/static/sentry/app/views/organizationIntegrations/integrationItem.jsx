...
// integration list.
var DomainName = styled('div')(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  color: ", ";\n  margin-left: ", ";\n  margin-top: ", ";\n  font-size: 1.4rem;\n  line-height: 1.2;\n  overflow: hidden;\n  text-overflow: ellipsis;\n"], ["\n  color: ", ";\n  margin-left: ", ";\n  margin-top: ", ";\n  font-size: 1.4rem;\n  line-height: 1.2;\n  overflow: hidden;\n  text-overflow: ellipsis;\n"])), function (p) { return (p.compact ? p.theme.gray400 : p.theme.gray600); }, function (p) { return (p.compact ? space(1) : 'inherit'); }, function (p) { return (!p.compact ? space(0.25) : 'inherit'); });
