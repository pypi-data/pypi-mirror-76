            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    expect(wrapper
                        ...
                        .at(1)
                        .prop('value')).toEqual(MethodType.REPLACE);
                    updatedMethodGroup = wrapper
                        .find('FieldGroup')
                        .at(0)
                        .find('Field');
                    ...
                    expect(wrapper
                        .find('[data-test-id="method-field"] input')
                        .at(1)
                        .prop('value')).toBe(MethodType.HASH);
                    expect(wrapper
                        .find('FieldGroup')
                        .at(0)
                        .find('Field')).toHaveLength(1);
                    return [2 /*return*/];
            }
        });
    }); });
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    expect(wrapper
                        ...
                        .at(1)
                        .prop('value')).toEqual(RuleType.PATTERN);
                    updatedTypeGroup = wrapper
                        .find('FieldGroup')
                        .at(1)
                        .find('Field');
                    ...
                    expect(wrapper
                        .find('[data-test-id="type-field"] input')
                        .at(1)
                        .prop('value')).toBe(RuleType.CREDITCARD);
                    expect(wrapper
                        .find('FieldGroup')
                        .at(1)
                        .find('Field')).toHaveLength(1);
