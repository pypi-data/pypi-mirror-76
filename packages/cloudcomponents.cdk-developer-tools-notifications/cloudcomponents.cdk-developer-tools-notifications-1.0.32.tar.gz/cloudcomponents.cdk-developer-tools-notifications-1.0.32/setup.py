    ...
    """
{
    ...
    "package_data": {
        "cloudcomponents.cdk_developer_tools_notifications._jsii": [
            "cdk-developer-tools-notifications@1.0.32.jsii.tgz"
        ],
        "cloudcomponents.cdk_developer_tools_notifications": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-codedeploy>=1.59.0, <2.0.0",
        "aws-cdk.aws-codepipeline>=1.59.0, <2.0.0",
        "aws-cdk.aws-codestarnotifications>=1.59.0, <2.0.0",
        "aws-cdk.aws-iam>=1.59.0, <2.0.0",
        "aws-cdk.aws-lambda>=1.59.0, <2.0.0",
        "aws-cdk.aws-lambda-event-sources>=1.59.0, <2.0.0",
        "aws-cdk.aws-sns>=1.59.0, <2.0.0",
        "aws-cdk.core>=1.59.0, <2.0.0",
        "cloudcomponents.cdk-chatops>=1.0.29, <2.0.0",
