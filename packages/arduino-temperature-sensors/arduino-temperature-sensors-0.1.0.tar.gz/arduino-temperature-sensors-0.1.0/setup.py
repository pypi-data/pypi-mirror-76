...
sys_path.append(abspath('arduino_temperature_sensors'))
...
setup(
    ...
    packages=['arduino_temperature_sensors'],
    entry_points={
        'console_scripts': [
            'arduino_temperature_sensors = arduino_temperature_sensors.__main__:main'
        ]
    },
    classifiers=[
