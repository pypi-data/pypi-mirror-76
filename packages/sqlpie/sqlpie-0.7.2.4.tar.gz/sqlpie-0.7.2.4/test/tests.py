...
class TestClient(unittest.TestCase):
  ...
  def test_dag_index_structure(self):
    ...
    self.assertEqual(sorted(all_models.api_data['models']['example_model']['dag_index'].items()), sorted(itterable_object.items()))
  ...
  def test_table_index_output(self):
    table_index = {'custom_staging_schema.example_1': {'source_name': 'model_with_custom_staging_schema', 'schema': 'custom_staging_schema', 'table_name': 'custom_staging_schema.example_1', 'table_short_name': 'example_1', 'update_method': 'append', 'source_type': 'staging', 'included_in': ['model_with_custom_staging_schema']}, 'model_with_custom_staging_schema.example_1': {'source_name': 'model_with_custom_staging_schema', 'schema': 'model_with_custom_staging_schema', 'table_name': 'model_with_custom_staging_schema.example_1', 'table_short_name': 'example_1', 'update_method': 'append', 'source_type': 'model'}, 'example_model_staging.example_1': {'source_name': 'example_model', 'schema': 'example_model_staging', 'table_name': 'example_model_staging.example_1', 'table_short_name': 'example_1', 'update_method': 'append', 'description': 'reads data from sources and performs some processing and enrichment', 'source_type': 'staging', 'included_in': ['example_model']}, 'example_model.example_3': {'source_name': 'example_model', 'schema': 'example_model', 'table_name': 'example_model.example_3', 'table_short_name': 'example_3', 'update_method': 'append', 'description': 'monthly aggregation view', 'source_type': 'model', 'included_in': ['model_with_custom_staging_schema']}, 'example_model.example_2': {'source_name': 'example_model', 'schema': 'example_model', 'table_name': 'example_model.example_2', 'table_short_name': 'example_2', 'update_method': 'append', 'description': 'daily aggregation view', 'source_type': 'model'}, 'example_source_schema.table_3': {'source_type': 'source', 'source_name': 'example_source_schema', 'schema': 'example_source_schema_public', 'table_name': 'example_source_schema.table_3', 'table_short_name': 'table_3', 'destination_table': 'custom_staging_schema.example_1', 'description': 'bing ads daily aggregated metrics', 'included_in': ['model_with_custom_staging_schema', 'example_model']}, 'example_source_schema.table_1': {'source_type': 'source', 'source_name': 'example_source_schema', 'schema': 'example_source_schema_public', 'table_name': 'example_source_schema.table_1', 'table_short_name': 'table_1', 'destination_table': 'example_model_staging.example_1', 'description': 'facebook advertsing daily aggregated metrics', 'included_in': ['example_model']}, 'example_source_schema.table_2': {'source_type': 'source', 'source_name': 'example_source_schema', 'schema': 'example_source_schema_public', 'table_name': 'example_source_schema.table_2', 'table_short_name': 'table_2', 'destination_table': 'example_model_staging.example_1', 'description': 'google adwords daily aggregated metrics', 'included_in': ['example_model']}}
