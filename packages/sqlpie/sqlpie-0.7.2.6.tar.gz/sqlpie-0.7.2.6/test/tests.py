...
class TestClient(unittest.TestCase):
  ...
  def test_model_names_extraction(self):
    self.assertEqual(example_model.all_models, ['model_with_custom_staging_schema', 'model_with_empty_config', 'example_model'])
