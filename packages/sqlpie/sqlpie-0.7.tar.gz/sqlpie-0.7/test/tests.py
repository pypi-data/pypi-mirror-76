...
class TestClient(unittest.TestCase):
  ...
  def test_model_api_data_keys(self):
    ...
    self.assertEqual( list(all_models.api_data['all_models']['example_model'].keys()) , keys)
  ...
  def test_dag_itterable_object_structure(self):
    ...
    self.assertEqual(sorted(all_models.api_data['all_models']['example_model']['dag_itterable_object'].items()), sorted(itterable_object.items()))
