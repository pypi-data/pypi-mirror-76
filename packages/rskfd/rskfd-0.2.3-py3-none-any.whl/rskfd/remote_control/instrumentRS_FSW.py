...
class instrumentRS_FSW(instrumentRS):      
    ...
    def MakeScreenshot( self, localfile):
        self.Write("HCOP:CONT HCOP")
        self.Write("HCOP:DEST 'MMEM'")
        self.Write("HCOP:DEV:LANG PNG")
        self.Write("HCOP:TDST:STAT OFF")
        self.Write("MMEM:NAME 'C:\\temp\\temp.png'")
        self.Write("HCOP:IMM")
        self.FileDownload( "C:\\temp\\temp.png", localfile)
...
def main():
    ...
    #import time
    vse=instrumentRS_FSW("169.254.161.24",PersistentChannels =False)
