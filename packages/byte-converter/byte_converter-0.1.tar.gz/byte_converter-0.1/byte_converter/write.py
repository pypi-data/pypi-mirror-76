...
def obj_to_dict(obj):
    dictionary = {}
    ignoring_attributes = ["__ctb_ignore_attributes", "__ctb_whitelisted_attributes"]
    if not hasattr(obj, "__ctb_ignore_attributes"):
        ignoring_attributes = [r"\_.*"]
    else:
        ignoring_attributes.extend(obj.__ctb_ignore_attributes)
    whitelisting = None
    if hasattr(obj, "__ctb_whitelisted_attributes"):
        whitelisting = obj.__ctb_whitelisted_attributes
    for k in dir(obj):
        ignoring = False
