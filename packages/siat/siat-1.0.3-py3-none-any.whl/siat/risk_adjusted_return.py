...
def print_rar_ratio(regdf,portfolio,ret_mean,ratio_name,ratio):
    ...
    print("Market & index:",scope,mktidx)
    print("investment stock(s):",stocklist1)
    print("stock proportion(s):",portionlist)
    print("time period available:",date_start,"to",date_end)
    print("average return(%):",round(ret_mean,4))
    print(ratio_name,"ratio(%):",round(ratio,4))
