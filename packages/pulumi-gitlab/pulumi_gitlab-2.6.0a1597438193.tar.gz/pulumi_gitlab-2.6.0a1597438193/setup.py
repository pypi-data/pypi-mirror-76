...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gitlab', '2.6.0-alpha.1597438193+da5365b7'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gitlab 2.6.0-alpha.1597438193+da5365b7`
                """)
            else:
                raise
