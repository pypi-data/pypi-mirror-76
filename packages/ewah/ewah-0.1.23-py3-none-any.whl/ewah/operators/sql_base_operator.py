...
class EWAHSQLBaseOperator(EWAHBaseOperator):
    ...
    def __init__(self,
        ...
        where_clause='1 = 1',
#        tunnel_conn_id=None, # conn_id containing SSH tunnel information
#        tunnel_pk_conn_id=None, # conn_id containing private key data for SSH
    *args, **kwargs):
        ...
        #self.tunnel_pk_conn_id = tunnel_pk_conn_id

    def execute(self, context):
        # create SSH tunnel first, if applicable
        ...
        #    }
        #    return self.ewah_execute(context=context)
