...
cd whisper-evaluate
pip install dist/whisper_evaluate-1.2.5-py3-none-any.whl
```
...
rep.save()  # 保存检查文件及评估结果
 ...
 # 单独计算语心结果
result = rep.whisper_report(stand_file="test_data/test-data-standard-latest.csv",
                            xd_file="test_data/test-data-standard-latest-whisper1.1-res.txt")
pprint.pprint(result)
...
ns = NetEaseStatistics("test_data/test-data-standard-latest.csv", "test_data/test_antispam_0727.txt")
