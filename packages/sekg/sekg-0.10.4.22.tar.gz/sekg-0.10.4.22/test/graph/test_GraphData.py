...
class TestGraphData(TestCase):
    ...
    def test_find_nodes_by_properties(self):
        ...
        graph_data.add_node({"method"}, {"qualified_name": "ArrayList.add", "c": "0", "info_from": ["x", "a"]},
                            primary_property_name="qualified_name", merge_key="info_from")
        graph_data.add_node({"method"}, {"qualified_name": "ArrayList.add", "t": "1", "info_from": ["a", "b"]},
                            primary_property_name="qualified_name", merge_key="info_from")
        t = graph_data.find_nodes_by_property("qualified_name", "ArrayList.add")
        print(t)
        graph_data.add_node({"method"}, {"qualified_name": "ArrayList.add"})
        graph_data.add_node({"override method"}, {"qualified_name": "ArrayList.pop"})
        graph_data.add_node({"method"}, {"qualified_name": "ArrayList.remove"})
