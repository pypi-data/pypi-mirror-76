...
@LastEditTime: 2020-07-08 18:05:29
...
class PayOrderListHandler(SevenBaseHandler):
    ...
    def get_async(self):
        ...
        page_list, total = PayOrderModel().get_dict_page_list(field, page_index, page_size, condition, order_by="id desc", params=params)
...
class PrizeOrderExportHandler(SevenBaseHandler):
    ...
    def get_async(self):
        ...
        data_columns = ["小程序订单号", "淘宝名", "盒子名称", "盒子价格", "奖品名称", "商家编码", "姓名", "手机号", "省份", "城市", "区县", "街道", "收货地址", "物流单号", "物流公司", "淘宝子订单号", "发货时间", "订单状态", "奖品价值", "奖品规格", "备注"]
