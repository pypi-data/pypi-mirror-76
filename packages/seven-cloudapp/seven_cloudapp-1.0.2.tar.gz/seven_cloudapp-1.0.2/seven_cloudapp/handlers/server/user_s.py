...
@LastEditTime: 2020-08-07 11:50:29
...
class LoginHandler(SevenBaseHandler):
    ...
    def get_async(self):
        ...
        """
        # return self.reponse_json_success(self.request.uri)
...
class UserStatusHandler(SevenBaseHandler):
    ...
    def get_async(self):
        ...
        UserInfoModel().update_table("user_state=%s,relieve_date=%s", "id=%s", [user_state, relieve_date, user_id])
