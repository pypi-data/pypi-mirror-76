...
@LastEditTime: 2020-08-07 14:52:07
...
class PrizeHandler(SevenBaseHandler):
    ...
    def post_async(self):
        ...
        # app_id = config.get_value("server_template_id")
        ...
        act_prize.prize_detail = prize_detail
        ...
        if prize_id > 0:
            ...
            if goods_id > 0:
                resp = TopModel().items_seller_list_get_request(str(goods_id), self.get_taobao_param().access_token)
