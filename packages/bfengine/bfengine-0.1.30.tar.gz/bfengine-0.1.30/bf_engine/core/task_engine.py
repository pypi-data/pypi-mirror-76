...
class TaskEngine(Module):
    ...
    def __init__(self, app_id,set):
        ...
        self.te_editor_port = Config.te_editor_port
        ...
        self.editor_url = '{}:{}/?appid={}#/task-engine-scenario-v2'.format(
            self.api_server, self.te_editor_port,self.app_id)
        # 获取scenario详细信息
    ...
    #         driver = webdriver.Chrome(self.chrome_path_bin+"/win/chromedriver.exe")
    #     elif sys_platform== 'Linux':
    #         driver = webdriver.Chrome(self.chrome_path_bin+"/linux/chromedriver")
    #     elif sys_platform=='Darwin':
    #         driver = webdriver.Chrome(self.chrome_path_bin+"/mac/chromedriver")
    #     if driver:
