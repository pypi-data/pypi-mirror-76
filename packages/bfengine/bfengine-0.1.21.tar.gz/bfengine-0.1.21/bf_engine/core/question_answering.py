...
class QuestionAnswering(Module):
    ...
    def qa_tag_list(self):
        ...
        获取标签列表
        """
        return json.dumps(self.caller.qa_tag_list())
    ...
    def qa_list(self) -> str:
        ...
        :return: 标准问列表
        """
        return json.dumps(self.caller.qa_list(QuestionField.ALL))
    def question_list(self) -> str:
        """
        : 查询标准问列表
        :return: 标准问列表
        """
        return json.dumps(self.caller.sq_list(QuestionField.ALL))
    ...
    def add_question(self, question_data: dict):
        ...
        :return:
        """
        return self.caller.upload_json_sq(question_data)
