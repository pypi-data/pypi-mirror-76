...
class QACaller(CallerBase):
    ...
    def __init__(self, app_id):
        ...
        self.upload_faq_json_answer_url = self.dac_url + "/ssm/dac/answer"
    ...
    def upload_json_sq(self, tag: SetConfig = {}, data: dict = {}) -> str:
        """
        上传标准问（新增标准问）
        :param data: 上传数据
        :return id
        ...
        if "answers" in data.keys():
            for answer in data["answers"]:
                if "time_tag" not in answer.keys():
                    continue
    ...
    def update_question(self, data: dict) -> str:
        ...
        return self.upload_json_sq(data=data)
