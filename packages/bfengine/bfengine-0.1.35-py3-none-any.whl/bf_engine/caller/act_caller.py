...
class DialogueActCaller(CallerBase):
    ...
    def __init__(self, app_id):
        ...
        self.app_id = app_id
        self.module = 'ner'
        self.act_predict_all_url = self.base_url + ":10525/dialogActClassify/customClassifier/detectSystemActs"
        self.act_predict_url = self.base_url + ":10999/tde/custtagger/ud_sys_dialog_act"
        self.sys_act_get_url = self.base_url + ":10999/tde/custtagger/sys_dialog_acts"
