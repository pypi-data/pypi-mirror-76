...
class KnowledgeGraphCaller(CallerBase):
    ...
    def __init__(self, app_id):
        ...
        self.new_file_load_url = '{}:2077/xeonKgDal/{}/import/all/v1'.format(base_url, app_id)
        # 检查实体是否重复
        ...
        # 查询特殊属性
        self.load_extra_property_url = '{}:18811/xeonKgDal/extraPropertyManager/{}/getAll?page=1&keyword={}&limit=10'
        # 更新特殊属性
        self.update_extra_property_url = '{}:18811/xeonKgDal/extraPropertyManager/{}/update'.format(base_url, app_id)
    ...
    def load_file(self, file_path: str, is_new):
        """
        加载文件格式训练数据
