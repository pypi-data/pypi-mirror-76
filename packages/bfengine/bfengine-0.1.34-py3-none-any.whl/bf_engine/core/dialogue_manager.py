...
class DialogueManager(Module):
    ...
    def __init__(self, app_id, set):
        ...
        self.predict_url = '{}:{}'.format(Config.base_url, Config.predict_port)
        self.predict_intent_url = self.predict_url + "/predict"
    ...
    def _config_generate(self, data):
        ...
        # 现在只有预置模型服务
        models = ConfigGenerator.get_init_models(self.app_id, self.predict_intent_url)
