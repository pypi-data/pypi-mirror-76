from src.ncei_cruise_schema.orm.entity import Entity, Column
from src.ncei_cruise_schema.orm.column_consts import DATE_PLACEHOLDER, date_select_name, WKT_PLACEHOLDER, wkt_select_name
