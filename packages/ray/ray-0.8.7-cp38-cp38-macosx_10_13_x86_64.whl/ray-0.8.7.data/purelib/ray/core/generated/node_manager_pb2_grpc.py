...
class NodeManagerServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.RequestResourceReserve = channel.unary_unary(
        '/ray.rpc.NodeManagerService/RequestResourceReserve',
        request_serializer=src_dot_ray_dot_protobuf_dot_node__manager__pb2.RequestResourceReserveRequest.SerializeToString,
        response_deserializer=src_dot_ray_dot_protobuf_dot_node__manager__pb2.RequestResourceReserveReply.FromString,
        )
...
class NodeManagerServiceServicer(object):
  ...
  def RequestResourceReserve(self, request, context):
    # missing associated documentation comment in .proto file
    pass
    context.set_code(grpc.StatusCode.UNIMPLEMENTED)
    context.set_details('Method not implemented!')
...
def add_NodeManagerServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'RequestResourceReserve': grpc.unary_unary_rpc_method_handler(
          servicer.RequestResourceReserve,
          request_deserializer=src_dot_ray_dot_protobuf_dot_node__manager__pb2.RequestResourceReserveRequest.FromString,
          response_serializer=src_dot_ray_dot_protobuf_dot_node__manager__pb2.RequestResourceReserveReply.SerializeToString,
      ),
