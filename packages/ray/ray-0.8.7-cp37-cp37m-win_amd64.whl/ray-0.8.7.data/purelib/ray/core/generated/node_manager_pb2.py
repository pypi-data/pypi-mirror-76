...
_REQUESTRESOURCERESERVEREQUEST = _descriptor.Descriptor(
  name='RequestResourceReserveRequest',
  full_name='ray.rpc.RequestResourceReserveRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='bundle_spec', full_name='ray.rpc.RequestResourceReserveRequest.bundle_spec', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_REQUESTRESOURCERESERVEREPLY = _descriptor.Descriptor(
  name='RequestResourceReserveReply',
  full_name='ray.rpc.RequestResourceReserveReply',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='success', full_name='ray.rpc.RequestResourceReserveReply.success', index=0,
...
_REQUESTRESOURCERESERVEREQUEST.fields_by_name['bundle_spec'].message_type = src_dot_ray_dot_protobuf_dot_common__pb2._BUNDLE
...
DESCRIPTOR.message_types_by_name['RequestResourceReserveRequest'] = _REQUESTRESOURCERESERVEREQUEST
DESCRIPTOR.message_types_by_name['RequestResourceReserveReply'] = _REQUESTRESOURCERESERVEREPLY
...
RequestResourceReserveRequest = _reflection.GeneratedProtocolMessageType('RequestResourceReserveRequest', (_message.Message,), {
  'DESCRIPTOR' : _REQUESTRESOURCERESERVEREQUEST,
  '__module__' : 'src.ray.protobuf.node_manager_pb2'
  # @@protoc_insertion_point(class_scope:ray.rpc.RequestResourceReserveRequest)
  })
_sym_db.RegisterMessage(RequestResourceReserveRequest)

RequestResourceReserveReply = _reflection.GeneratedProtocolMessageType('RequestResourceReserveReply', (_message.Message,), {
  'DESCRIPTOR' : _REQUESTRESOURCERESERVEREPLY,
  '__module__' : 'src.ray.protobuf.node_manager_pb2'
  # @@protoc_insertion_point(class_scope:ray.rpc.RequestResourceReserveReply)
  })
_sym_db.RegisterMessage(RequestResourceReserveReply)
...
_NODEMANAGERSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='RequestResourceReserve',
    full_name='ray.rpc.NodeManagerService.RequestResourceReserve',
    index=3,
    containing_service=None,
    input_type=_REQUESTRESOURCERESERVEREQUEST,
    output_type=_REQUESTRESOURCERESERVEREPLY,
    serialized_options=None,
  ),
  _descriptor.MethodDescriptor(
