...
class TaskManager(object):
    ...
    def load_modules(self, path, filter=None):
        ...
        for f in os.listdir(path):
            ...
            if len(f) > 3 and f[-3:] == '.py':
                ...
                modules_list = [x.lower() for x in list(self.tasks.keys())]
                ...
                for attrname in dir(mod):
                    ...
                    if inspect.isclass(attr) and isModule(attr) and attr != basemodule.Module and attr != system.Module:
                        # Get class name
    ...
    def init_module(self, cls):
        ...
        try:
            # Initialize Module
            module = cls(**self.instLance_details)
            # Log
    ...
    def schedule_module(self, c, module):
        ...
        # Get Module schedule
        for name, schedule in list(c.get_schedule().items()):
            # Get scheduler args
