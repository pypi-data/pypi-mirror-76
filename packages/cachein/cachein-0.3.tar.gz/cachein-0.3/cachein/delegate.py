...
class Delegate(Cached):
    ...
    ...
    ...     greet = recipient = Delegate('greeter')
    ...
    ...     greet = Delegate(greeter)
    ...     who = Delegate(greeter, 'recipient')
    ...
    >>> @Delegate.compose('greeter', 'greet', who='recipient')
    ...
    >>> anyGreeter = Delegate.composer('greet', who='recipient')
