...
def forum_code_submit(assignment=None, email = False, websubmit=False): #TODO: Code websubmit
    """
    ...
    xhttp.send("rand="""+str(rand_code)+'&url=".concat(btoa(notebook_url),"&data=",notebook_url,"&email=",btoa("'+author+'")));'
    ...
    if (str(r.content, 'utf-8', 'ignore')[0] == "Y"):
        ...
        print("Submission Failed, Please try again in a few seconds!")
        return False
    return True
