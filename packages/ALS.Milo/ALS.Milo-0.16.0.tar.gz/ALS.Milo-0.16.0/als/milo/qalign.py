...
__copyright__ = "Copyright (c) 2018-2020, Padraic Shafer"
...
#   	print hk_offset_from_sphere_center_q
    ...
    print("hk_offset_from_sphere_center_q (#2)", end=' ')
    print(hk_offset_from_sphere_center_q.shape, end=' ')
    print(hk_offset_from_sphere_center_q)
    hk_circle_center_q =								\
...
#   	print hk_circle_center_q
    ...
    print("hk_circle_center_q (#2)", end=' ')
    print(hk_circle_center_q.shape, end=' ')
    print(hk_circle_center_q)
...
#  	print hk_linsolve_vector
    ...
    print("linsolve_vector", end=' ')
    print(linsolve_vector.shape, end=' ')
...
#  	print hk_plane_intersection_vector
    ...
    print("hk_plane_intersection_vector", end=' ')
    print(hk_plane_intersection_vector.shape, end=' ')
    print(hk_plane_intersection_vector)
...
# 		return()	# Return array of complex-valued pairs [INVALID]
    ...
    if   hk_plane_intersection_vector[0] != 0 :		# vector has component along room-X
        ...
        print("hk_plane_intersection_origin", end=' ')
        print(hk_plane_intersection_origin.shape, end=' ')
        ...
        print("ccd_hk_pairs_pixels", end=' ')
        print(ccd_hk_pairs_pixels.shape, end=' ')
    ...
    print(b)
    print("a.dot(a)", end=' ')
    print((a.dot(a)).shape, end=' ')
    print(a.dot(a))
    print("a.dot(b)", end=' ')
    # print (a.dot(b)).shape,
    # print a.dot(b)
    print(sum(a * b, axis=-1).shape, end=' ')
    print(sum(a * b, axis=-1))
    print("b.dot(b)", end=' ')
    # print (b.dot(b)).shape,
    # print b.dot(b)
    print(sum(b * b, axis=-1).shape, end=' ')
    print(sum(b * b, axis=-1))
    print("-B / 2A", end=' ')
    print((-2 * sum(a * b, axis=-1) / (2 * a.dot(a))).shape, end=' ')
    print(-2 * sum(a * b, axis=-1) / (2 * a.dot(a)))
    print("SQRT(B^2 - 4AC) / 2A", end=' ')
    ...
    print(intersections.shape, end=' ')
    print(intersections)
    exit_vectors = intersections - sphere_center_q[newaxis, newaxis, :]
    print("exit_vectors", end=' ')
    print(exit_vectors.shape, end=' ')
    print(exit_vectors)
...
# 	print ccd_center_room
    ...
    print("linsolve_matrix (#3)", end=' ')
    print(linsolve_matrix.shape, end=' ')
    ...
    print("ccd_hk_pairs_room", end=' ')
    print(ccd_hk_pairs_room.shape, end=' ')
...
# 		])
    ...
    print("ccd_hk_pairs_room (#2)", end=' ')
    print(ccd_hk_pairs_room.shape, end=' ')
    print(ccd_hk_pairs_room)
    # exit()
    ccd_hk_pairs_room -= ccd_center_room
    print("ccd_hk_pairs_room (#3)", end=' ')
    print(ccd_hk_pairs_room.shape, end=' ')
    print(ccd_hk_pairs_room)
    ...
    ccd_coords_pairs_shape[-1] = 2
    ccd_hk_pairs_pixels = ccd_hk_pairs_pixels.reshape(*ccd_coords_pairs_shape)
    print("ccd_hk_pairs_pixels (#4)", end=' ')
    print(ccd_hk_pairs_pixels.shape, end=' ')
    print(ccd_hk_pairs_pixels)
