...
[boto3.MarketplaceEntitlementService 1.14.40](https://boto3.amazonaws.com/v1/documentation/api/1.14.40/reference/services/marketplace-entitlement.html#MarketplaceEntitlementService) service
