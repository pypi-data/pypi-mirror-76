...
class Component:
    def __init__(self, json_data):
        ...
        self.position = json.loads(json_data['position'])
...
class LyricComp(Component):
    ...
    def get_clip(self):
        ...
        self.lyric = Lyric(json_data['lyric_sync'], self.font_url, self.font_size, self.color,
...
json_str="{\"index\":1,\"backgroundColor\":\"rgba(0, 50, 0,1)\",\"color\":\"rgba(255, 0, 255,1)\",\"fontFamily\":\"http://automusic.win/rs/font/title/Helena.otf\",\"fontSize\":35,\"id\":\"7c8b0400-a773-4ebc-b422-8727e158be24\",\"position\":\"{    \\\"height\\\": 300,    \\\"width\\\": 500,    \\\"x\\\": 100,    \\\"y\\\": 100,    \\\"rotation\\\": 30}\",\"text\":\"Sample text\",\"type\":\"text\",\"startTime\":0,\"duration\":10,\"stroke_color\":null,\"stroke_width\":null}"
json_data=json.loads(json_str)
txt=TextComp(json_data)
txt.setup()
x=txt.make()
x.subclip(0,3).write_videofile('xz2.avi',fps=24,codec='libx264')