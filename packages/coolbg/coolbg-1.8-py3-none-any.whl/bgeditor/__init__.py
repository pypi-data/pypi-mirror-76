...
class BGEditor():
    ...
    def create_video_json(self, list_comp_data):
        path_vid = self.root_dir.name + "/" + str(uuid.uuid4()) + ".avi"
        create_video(list_comp_data, path_vid, root_dir_name=self.root_dir.name )
        return path_vid
