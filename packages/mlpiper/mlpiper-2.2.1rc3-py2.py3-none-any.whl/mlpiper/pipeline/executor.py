...
class Executor(Base):
    ...
    def _init_pipeline(self):
        self._vp.print("Start initializing pipeline")
        ...
        self._vp.print("Finish initializing pipeline")
