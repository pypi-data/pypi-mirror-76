...
class ApiObject(constructs.Construct, metaclass=jsii.JSIIMeta, jsii_type="cdk8s.ApiObject"):
    ...
    """
    def __init__(self, scope: constructs.Construct, ns: str, *, api_version: str, kind: str, metadata: typing.Optional["ApiObjectMetadata"]=None) -> None:
        ...
        :stability: experimental
        """
        options = ApiObjectOptions(api_version=api_version, kind=kind, metadata=metadata)
...
@jsii.data_type(jsii_type="cdk8s.ApiObjectMetadata", jsii_struct_bases=[], name_mapping={'annotations': 'annotations', 'labels': 'labels', 'name': 'name', 'namespace': 'namespace'})
...
class ApiObjectMetadataDefinition(metaclass=jsii.JSIIMeta, jsii_type="cdk8s.ApiObjectMetadataDefinition"):
    """Object metadata.
    ...
    def __init__(self, *, annotations: typing.Optional[typing.Mapping[str, str]]=None, labels: typing.Optional[typing.Mapping[str, str]]=None, name: typing.Optional[str]=None, namespace: typing.Optional[str]=None) -> None:
        ...
        :stability: experimental
        """
        options = ApiObjectMetadata(annotations=annotations, labels=labels, name=name, namespace=namespace)
...
@jsii.data_type(jsii_type="cdk8s.ApiObjectOptions", jsii_struct_bases=[], name_mapping={'api_version': 'apiVersion', 'kind': 'kind', 'metadata': 'metadata'})
class ApiObjectOptions():
    def __init__(self, *, api_version: str, kind: str, metadata: typing.Optional["ApiObjectMetadata"]=None) -> None:
