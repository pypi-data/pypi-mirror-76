...
class MetricIterator(Iterator):
    ...
    """
    def __init__(self, data=None, minibatch_size=8):
    ...
    def __getitem__(self, index: int):
        ...
        try:
            ...
            anchor = self.data.image_transform(anchor)
            positive = self.data.image_transform(positive)
            negative = self.data.image_transform(negative)
