class oceanlyz:
    ...
    .. code:: python
        ...
        #Assume OCEANLYZ files are in 'C:\\oceanlyz_python' folder
        os.chdir('C:\\oceanlyz_python')
        ...
        os.chdir('.\\Sample_Data')       #Change current path to Sample_Data folder
