...
class CreateCases:
    ...
    def set_discount_rate(self, equity, debt, market_index,
        ...
        for region in market_index:
            ...
            print("ARR", annualised_returns[region])
            ...
            print("CoPE", cost_of_preference_equity[region])
            # Calculates WACC
            WACC[region] = (
                cost_of_equity[region] *
                (equity[region] /
