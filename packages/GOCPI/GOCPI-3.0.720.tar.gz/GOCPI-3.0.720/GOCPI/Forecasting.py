...
class Forecasting:
    ...
    def energy_balance_base(self, root, IEA_World_Energy_Balances_1,
        ...
        Args:
            ...
            create_excel_spreadsheet (boolean): True/false on whether to create a spreadsheet or not
            output_file (str): Name of output file to create

        Returns:
            (dataframe): Filtered Dataframe of the chosen energy balances
        """
