...
class Forecasting:
    ...
    def energy_balance_base(self, root, IEA_World_Energy_Balances_1,
        ...
        Returns:
            (various): Unique lists and filtered dataframe of the chosen energy balances and unique lists (fuel, geography, technology, EBPTG) 
        """
        ...
        return unique_fuel, unique_geography, unique_technology, EBPTG