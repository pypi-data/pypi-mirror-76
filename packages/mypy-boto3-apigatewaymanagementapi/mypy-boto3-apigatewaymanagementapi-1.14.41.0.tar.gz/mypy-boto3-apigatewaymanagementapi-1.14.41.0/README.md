...
[boto3.ApiGatewayManagementApi 1.14.41](https://boto3.amazonaws.com/v1/documentation/api/1.14.41/reference/services/apigatewaymanagementapi.html#ApiGatewayManagementApi) service
