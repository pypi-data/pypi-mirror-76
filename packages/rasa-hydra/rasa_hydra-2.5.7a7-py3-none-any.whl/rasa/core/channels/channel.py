...
class InputChannel(object):
    ...
    async def startTracking(self, usg_msg, csi, channel, sid):
        ...
        host = environ.get("IDENTITY_PROVIDER_HOST", "localhost")
        port = environ.get("IDENTITY_PROVIDER_PORT", "8080")
        tenantId = environ.get("TENANT_ID", "")

        headers = {"Conversation-Id": sid, "Tenant-Id": tenantId}
        params = {
            "CSI": csi,
            "channel": channel
        }
