...
class Session(object):
    ...
    @_utilities.wrap_async_call_exceptions
    def async_alter_table(self, path, add_columns=None, drop_columns=None, settings=None, alter_attributes=None, add_indexes=None, drop_indexes=None):
        return self._driver.future(
            _session_impl.alter_table_request_factory(self._state, path, add_columns, drop_columns, alter_attributes, add_indexes),
            _apis.TableService.Stub,
    ...
    def alter_table(self, path, add_columns=None, drop_columns=None, settings=None, alter_attributes=None, add_indexes=None, drop_indexes=None):
        return self._driver(
            _session_impl.alter_table_request_factory(self._state, path, add_columns, drop_columns, alter_attributes, add_indexes, drop_indexes),
            _apis.TableService.Stub,
            _apis.TableService.AlterTable,
            _session_impl.AlterTableOperation,
            settings,
