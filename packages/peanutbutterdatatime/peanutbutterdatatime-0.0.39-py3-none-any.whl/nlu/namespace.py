class NameSpace():
    ...
    default_pretrained_component_references = {  # references for SparkNLPAnnotators without pretrained models.
        ...
        # Auto generated sentence embeddings
        'embed_sentence.bert': ('bert', 'model'),
        'embed_sentence.albert': ('albert', 'model'),
        'embed_sentence.xlnet': ('xlnet', 'model'),
        'embed_sentence.elmo': ('elmo', 'model'),
        'embed_sentence.glove': ('glove', 'model'),
