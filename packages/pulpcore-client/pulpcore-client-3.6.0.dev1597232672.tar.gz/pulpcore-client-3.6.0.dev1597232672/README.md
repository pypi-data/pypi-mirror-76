...
- API version: v3
- Package version: 3.6.0.dev01597232672
...
*GroupsApi* | [**permissions**](docs/GroupsApi.md#permissions) | **GET** {auth_group_href}permissions/ | 
...
*GroupsApi* | [**users**](docs/GroupsApi.md#users) | **GET** {auth_group_href}users/ | 
...
## Documentation For Models
 ...
 - [ObjectPermissionResponse](docs/ObjectPermissionResponse.md)
