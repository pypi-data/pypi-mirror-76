        ...
        while True:
            try:
                ...
                if time_start.hour < 9 or time_start.hour == 12 or time_start.hour > 15:
                    ...
                    # Sleep when time_start is in range [9:00, 9:30]
                    ...
                    if USE_SINA_DATA:
                        stock_minute_df = sina.sina_stock_minute()
                    else:
        ...
        while True:
            try:
                ...
                if time_start.hour < 9 or time_start.hour == 12 or time_start.hour > 15:
                    ...
                    last_time_start = time_start
                    realtime_index_price_df = em.em_realtime_index(realtime_index_price_processor.index_ids, data_start_time)
