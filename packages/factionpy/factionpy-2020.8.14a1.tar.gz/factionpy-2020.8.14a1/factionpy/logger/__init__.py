import inspect
import logging
from factionpy.config import FACTION_LOGGING_LEVEL
...
if FACTION_LOGGING_LEVEL == "warning":
    logging_level = logging.WARNING
elif FACTION_LOGGING_LEVEL == "error":
    logging_level = logging.ERROR
elif FACTION_LOGGING_LEVEL == "critical":
    logging_level = logging.CRITICAL
elif FACTION_LOGGING_LEVEL == "debug":
