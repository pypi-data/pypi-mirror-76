...
class MagicBoxApi(object):
    ...
    def set_oleddisplay(self, port_name):
    ...
    def get_servo_angle(self, port_name, index: int):
    ...
    def get_iodo(self, port_name, port):
        return self.__dobotlink.MagicBox.GetIODO(portName=port_name, port=port)
    ...
    def get_iodi(self, port_name, port):
        return self.__dobotlink.MagicBox.GetIODI(portName=port_name, port=port)
