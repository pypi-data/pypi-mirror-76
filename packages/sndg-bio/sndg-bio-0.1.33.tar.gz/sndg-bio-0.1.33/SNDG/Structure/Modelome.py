...
class Modelome(object):
    ...
    def process_file(params):
        ...
        if hsps:
            ...
            models_result = Modelome.model_hsps(seq_id, os.path.abspath(output_dir), hsps, refinement=REFINEMENT,
                                                models_to_generate=MODELS_TO_GENERATE,
                                                assessments=ASSESMENTS, entries={},
                                                tmp_dir=tmp_dir, max_models=templates2use)
