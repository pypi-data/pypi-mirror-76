...
class ListCertificatesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListCertificates.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.38/reference/services/acm.html#ACM.Paginator.ListCertificates.paginate)
        """
