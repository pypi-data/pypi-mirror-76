"""
image_match_tso is a simple package for finding approximate image matches from a
...
setup(
    name='image_match_tso',
    version=find_version('image_match_tso', '__init__.py'),
    description='image_match_tso is a simple package for finding approximate '\
                'image matches from a corpus.',
    long_description=__doc__,
    url='https://github.com/ascribe/image-match-tso/',
    author='Ryan Henderson, Tae-Sun Oh',
    author_email='ktokw5@gmail.com',
