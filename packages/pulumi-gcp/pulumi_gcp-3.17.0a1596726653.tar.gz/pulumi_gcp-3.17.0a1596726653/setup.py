...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', '3.17.0-alpha.1596726653+f1a2e8ac'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp 3.17.0-alpha.1596726653+f1a2e8ac`
                """)
            else:
                raise
