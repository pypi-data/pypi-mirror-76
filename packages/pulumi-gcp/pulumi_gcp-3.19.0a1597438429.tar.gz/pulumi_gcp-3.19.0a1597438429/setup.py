...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', '3.19.0-alpha.1597438429+304cbbf6'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp 3.19.0-alpha.1597438429+304cbbf6`
                """)
            else:
                raise
