...
def der_incremental(lifelong_list, ref_mdtm_dir, ref_uem_dir, hyp_mdtm_dir):
    ...
    print("\nFinal DER: %6.2f%%  Total time: %.2fs" % (total_error / total_time, total_time))
...
#
#    if len(sys.argv) != 6:
#        print("Computes the DER a series of reference/hypothesis and output the final mapping file.\nUsage:\n  %s dev.lst ref-mdtm-dir ref-uem-dir hyp-mdtm-dir output-map.txt\n" % sys.argv[0])
#        sys.exit(0)
#    der_incremental(sys.argv[1], sys.argv[2], sys.argv[3], sys.argv[4])
