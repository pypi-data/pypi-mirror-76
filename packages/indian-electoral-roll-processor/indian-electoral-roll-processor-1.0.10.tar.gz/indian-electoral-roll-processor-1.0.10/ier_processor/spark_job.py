...
class PDFBatch:
    ...
    def make_records(self, global_spark_context):
        ...
        image_records = page_image_names.repartition(30).flatMap(lambda pdf_page: PDFSlicingMachine().split_pdf_page_image_into_record_images(pdf_page, self.record_images))
    ...
    def make_text_records(self, global_spark_context):
        ...
        text_records = record_image_names.map(lambda record_image: ImageProcessor().process_image(record_image)).cache()
