...
class FacebookScraper(Scraper):
    ...
    def query_posts(self, account):
        return get_posts(account=account,page_limit=20, options=['reactions'])

    def query_company_infos(self, account):
        r = requests.get('https://m.facebook.com/axa/?locale2=fr_FR', headers={
        ...
        # Extract community
        r2 = requests.get('https://m.facebook.com/axa/community/', headers={
