...
function GetOciCommandsToLongParams_compute() {
    $ociCommandsToLongParams = @{
        ...
        'compute instance update' = 'agent-config defined-tags display-name extended-metadata fault-domain force freeform-tags from-json help if-match instance-id launch-options max-wait-seconds metadata shape shape-config wait-for-state wait-interval-seconds'
