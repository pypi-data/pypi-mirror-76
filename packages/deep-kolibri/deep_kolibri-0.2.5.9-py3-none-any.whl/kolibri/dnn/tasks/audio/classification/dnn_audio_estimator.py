...
from kolibri.log import get_logger
...
#        print(self.clf.tf_model.summary())
    ...
    def fit(self, X, y, X_val=None, y_val=None):
        ...
        self.clf.fit(X, y, x_validate=X_val, y_validate=y_val, epochs=self.component_config["epochs"], batch_size=self.component_config["batch-size"],
