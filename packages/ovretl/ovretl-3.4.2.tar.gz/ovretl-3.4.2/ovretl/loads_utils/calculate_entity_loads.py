...
def calculate_entity_loads(loads_df: pd.DataFrame, key: str):
    ...
    entity_loads = (
        ...
        .agg(
            ...
            hazardous=("hazardous", lambda load_hazardous: load_hazardous.any()),
            lithium=("lithium", lambda load_lithium: load_lithium.any()),
            refrigerated=("refrigerated", lambda load_refrigerated: load_refrigerated.any()),
            magnetic=("magnetic", lambda load_magnetic: load_magnetic.any()),
            non_stackable=("non_stackable", lambda load_non_stackable: load_non_stackable.any()),
        )
        .reset_index()
