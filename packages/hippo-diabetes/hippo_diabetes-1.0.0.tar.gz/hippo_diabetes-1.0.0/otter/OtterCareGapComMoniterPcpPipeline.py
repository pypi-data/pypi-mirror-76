...
class OtterCareGapComMoniterPcpPipeline:
    ...
    # apply pipe function
    def addPipe(self):
        commericalMoniterPipeline = Pipeline(steps=[
            ('OtterFeatureSelector', OtterFeatureSelector(featureNames=[self.comMedCol] + [self.screenCol])),
            ('OtterCareGapComMoniterPcpTransformer', OtterCareGapComMoniterPcpTransformer(careGapName=self.careGapNameValue,
        ...
        # return pipeline
        return commericalMoniterPipeline