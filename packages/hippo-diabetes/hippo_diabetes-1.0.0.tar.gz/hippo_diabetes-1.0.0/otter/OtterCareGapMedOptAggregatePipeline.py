...
class OtterCareGapMedOptAggregatePipeline:
    ...
    def addPipe(self,X):
        ...
        for key in self.modelParamsDict.keys():
            ...
            X = pd.concat([X, OtterCareGapMedOptPipeline(careGapNameValue=key,
                                                                    comMedCol='insure_med',
                                                                    a1cValueCol = 'lab_a1c_12mo',
                                                                    a1cCriteriaValue = self.modelParamsDict[key][0],
                                                                    conditionStatusValue=self.modelParamsDict[key][1],
                                                                    conditionValueCol = self.modelParamsDict[key][2],
