...
class OtterCareGapComComorbidityPipeline:
    ...
    :param comorbidityValue: column from dataframe that determines if the person has the comorbidity
    :type drug: string
    ...
    def __init__(self, careGapNameValue, comorbidityCol, comMedOutcomeValue,comMedCol=None):
        """constructor method
        """
        if comMedCol == None:
        ...
        self.comorbidityCol = comorbidityCol
        self.comMedOutcomeValue = comMedOutcomeValue

    # apply pipe function
    def addPipe(self):
        medcareComorbidityPipeline = Pipeline(steps=[
            ('OtterFeatureSelector', OtterFeatureSelector(featureNames=[self.comMedCol] + [self.comorbidityCol])),
            ('OtterCareGapComComorbidityTransformer', OtterCareGapComComorbidityTransformer(careGapName=self.careGapNameValue,
                                                                                  comMedCol=self.comMedCol,
                                                                                  comorbidity=self.comorbidityCol)),
        ...
        # return pipeline
        return medcareComorbidityPipeline