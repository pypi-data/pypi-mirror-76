...
class OtterCareConsiderationComAggregatePipeline:
    """Aggregate care considerations 
...
#             print('Start coding {}'.format(key))
            ...
            X = pd.concat([X, OtterCareConsiderationPipeline(careGapNameValue=key,
                                                                    comMedCol='insure_med',
                                                                    monitorEventCol=self.modelParamsDict[key],
