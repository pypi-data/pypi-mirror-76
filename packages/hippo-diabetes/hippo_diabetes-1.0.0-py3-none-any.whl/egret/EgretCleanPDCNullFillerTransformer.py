...
#class
class EgretCleanPDCNullFillerTransformer(BaseEstimator, TransformerMixin):
    ...
    def transform(self, X, y=None):
        ...
        X = X[modelParam['egret_anti_diabetic_pdc_drug_columns']] = X[modelParam['egret_anti_diabetic_pdc_drug_columns']].fillna(-1)
        return X