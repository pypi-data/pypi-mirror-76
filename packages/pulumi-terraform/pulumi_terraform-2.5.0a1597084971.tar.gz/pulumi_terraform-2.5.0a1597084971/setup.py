...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'terraform', 'v2.5.0-alpha.1597084971+g0a71b01'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource terraform v2.5.0-alpha.1597084971+g0a71b01`
                """)
