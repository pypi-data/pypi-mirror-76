...
def verify_pcap_dscp_bits(pcap_location, expected_bits, position=0, expected_protocol=None, expected_dst_port_number=None):
    ...
    if expected_protocol and expected_protocol.lower() == 'udp' and UDP in packet:
