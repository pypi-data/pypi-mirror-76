...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'consul', '2.4.0-alpha.1597438161+2d2168ba'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource consul 2.4.0-alpha.1597438161+2d2168ba`
                """)
            else:
                raise
