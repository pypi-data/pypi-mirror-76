...
class HealthcheckApi(object):
    ...
    def create_healthcheck_evaluation_with_http_info(self, healthcheck_evaluation, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/3/healthcheck/evaluations', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def delete_healthcheck_evaluation_with_http_info(self, healthcheck_evaluation_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/3/healthcheck/evaluations/{HealthcheckEvaluationId}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_healthcheck_checklist_with_http_info(self, healthcheck_checklist_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/3/healthcheck/checklists/{HealthcheckChecklistId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_healthcheck_checklists_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/3/healthcheck/checklists', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_healthcheck_evaluation_with_http_info(self, healthcheck_evaluation_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/3/healthcheck/evaluations/{HealthcheckEvaluationId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_healthcheck_evaluations_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['detailed', 'limit', 'resume']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        return self.api_client.call_api(
            '/platform/3/healthcheck/evaluations', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_healthcheck_evaluation_with_http_info(self, healthcheck_evaluation, healthcheck_evaluation_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/3/healthcheck/evaluations/{HealthcheckEvaluationId}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
