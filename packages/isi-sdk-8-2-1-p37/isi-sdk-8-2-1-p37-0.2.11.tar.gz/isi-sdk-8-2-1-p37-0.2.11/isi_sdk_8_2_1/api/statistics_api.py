...
class StatisticsApi(object):
    ...
    def get_summary_workload(self, **kwargs):  # noqa: E501
        ...
        :param str totalby: A comma separated list specifying what should be unique. (node | system_name | user_id | user_sid | username | zone_id | zone_name | local_addr | local_name | remote_addr | remote_name | group_id | group_sid | groupname | domain_id | path | protocol | share_name | job_type). Aggregation is performed over all the fields not specified in the list.
        ...
        :param str nodes: A comma separated list. Specify node(s) for which statistics should be reported. Default is all. Zero (0) should be passed in as the sole argument to indicate local.
        :param str protocols: A comma separated list. Default is all. (smb1 and smb2 only at this time.)
    ...
    def get_summary_workload_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['group_sids', 'numeric', 'dataset', 'degraded', 'share_names', 'paths', 'usernames', 'remote_addresses', 'job_types', 'zone_ids', 'groupnames', 'user_sids', 'sort', 'domain_ids', 'zone_names', 'local_names', 'user_ids', 'totalby', 'local_addresses', 'remote_names', 'nodes', 'protocols', 'group_ids', 'timeout', 'system_names']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
