...
class EventApi(object):
    ...
    def get_event_eventgroup_occurrences_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['resolved', 'sort', 'begin', 'end', 'severity', 'event_count', 'devid', 'resume', 'ignore', 'last_event_end', 'limit', 'partial_cause_long', 'resolver', 'partial_eventgroup_id', 'partial_event_type', 'cause', 'dir', 'last_event_begin']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_event_eventlists_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['event_instance', 'limit', 'eventgroup_id', 'resume']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
