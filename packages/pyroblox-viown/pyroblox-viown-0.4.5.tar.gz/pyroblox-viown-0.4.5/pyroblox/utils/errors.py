...
class LoginFailure(Exception):
    """
    Raised when a direct login fails
    """
    pass

class AssetNotOwned(Exception):
    """
    Raised when the user does not own the asset.  
    This is usually raised when you try to wear an item you do not own.
    """
    pass

class AssetNotWorn(Exception):
    """
    Raised when the user is not wearing the asset.  
    This is usually raised when you try to take off an item you're not wearing.
    """
    pass