...
class Game:
    def __init__(self, requests, gameId):
        ...
        """
        from .gamepass import Gamepass # To prevent circular imports
    ...
    def gamepasses(self):
        ...
        for gamepass in r.json()["data"]:
            ...
            gamepasses.append(self.Gamepass(self.requests, gamepass["id"], "None", gamepass["name"], gamepass["productId"], gamepass["price"], extraInfo["Creator"]["Id"]))
        return gamepasses
