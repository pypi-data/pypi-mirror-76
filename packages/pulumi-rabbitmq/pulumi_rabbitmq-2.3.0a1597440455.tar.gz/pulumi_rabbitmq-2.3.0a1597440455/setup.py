...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'rabbitmq', '2.3.0-alpha.1597440455+c9721683'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource rabbitmq 2.3.0-alpha.1597440455+c9721683`
                """)
            else:
                raise
