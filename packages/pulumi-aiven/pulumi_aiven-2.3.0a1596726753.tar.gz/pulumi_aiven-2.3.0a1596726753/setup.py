...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'aiven', '2.3.0-alpha.1596726753+44bc8839'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource aiven 2.3.0-alpha.1596726753+44bc8839`
                """)
            else:
                raise
