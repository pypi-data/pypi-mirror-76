...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'aiven', '2.3.0-alpha.1597442653+d9c8b830'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource aiven 2.3.0-alpha.1597442653+d9c8b830`
                """)
            else:
                raise
