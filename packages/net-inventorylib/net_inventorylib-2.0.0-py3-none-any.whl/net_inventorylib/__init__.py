...
class NetInventory:
    ...
    def read_file(self, this_filepath):
        ...
        deepmerge(self._inventory, this_file)
    ...
    def templates_merge_all(self, debug=False):
        ...
        for type_name in self._inventory:
            ...
            instances = self._inventory[type_name]
    ...
    def templates_merge(self, type_name, instance_name, debug=False):
        ...
        item = self._inventory[type_name][instance_name]
        ...
        if template_type_name not in self._inventory:
    ...
    def _templates_merge(self, template_type_name, item, path, debug=False):
        ...
        * it does not check if an item has a 'templates' entry and
        ...
        for template_name in item["templates"]:
            ...
            if template_name not in self._inventory[template_type_name]:
                raise KeyError(
            ...
            sub_template = self._inventory[template_type_name][template_name]
