...
@jsii.data_type(
    jsii_type="aws-cdk-dynamodb-seeder.Item", jsii_struct_bases=[], name_mapping={}
)
class Item:
...
@jsii.data_type(
    jsii_type="aws-cdk-dynamodb-seeder.ItemKey", jsii_struct_bases=[], name_mapping={}
)
class ItemKey:
    def __init__(self) -> None:
        """
    ...
    def __repr__(self) -> str:
        return "ItemKey(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


@jsii.data_type(
    jsii_type="aws-cdk-dynamodb-seeder.Props",
    jsii_struct_bases=[],
    name_mapping={
        "setup": "setup",
        "table": "table",
        "refresh_on_update": "refreshOnUpdate",
        "teardown": "teardown",
    },
)
class Props:
    def __init__(
        self,
        *,
        setup: typing.List["Item"],
        table: aws_cdk.aws_dynamodb.Table,
        refresh_on_update: typing.Optional[bool] = None,
        teardown: typing.Optional[typing.List["ItemKey"]] = None,
    ) -> None:
        """
        :param setup: 
        :param table: 
        ...
        if refresh_on_update is not None:
            self._values["refresh_on_update"] = refresh_on_update
        if teardown is not None:
            self._values["teardown"] = teardown
...
class Seeder(
    ...
    jsii_type="aws-cdk-dynamodb-seeder.Seeder",
):
    """
    stability
    :stability: experimental
    ...
    @_props.setter
    def _props(self, value: "Props") -> None:
