...
class MyWhatify:
    ...
    @classmethod
    def get_credentials(cls, api_key: str = None, renew: bool = False):
        return my_toolkit.Connector.get_credentials(user_token=api_key, renew=renew)
    ...
    @classmethod
    def write_pandas_df_to_s3(cls, df, file_name: str, user_token: str = None, **kwargs):  # s3_client, bucket, path, df):
