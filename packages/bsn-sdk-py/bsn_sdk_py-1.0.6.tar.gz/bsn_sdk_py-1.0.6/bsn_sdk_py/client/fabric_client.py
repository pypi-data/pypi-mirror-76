...
class FabricClient(object):
    ...
    def enroll_user(self, name, secret):
        ...
        :return:
        """
        assert self.config.app_info["caType"] == AppCaType.AppCaType_NoTrust.value, "only allow to register cert under Key-No-Trust Mode"
    ...
    def get_block_info(self, blockNumber=0, blockHash='', txId=''):
        ...
        :return:
        """
        assert any((blockNumber, blockHash, txId,)), "blockNumber or blockHash or txId cannot be empty at the same time"
