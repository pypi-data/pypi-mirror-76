...
class PCA(BaseMethod):
    ...
    def make_(self, input_data: DataFrame) -> MethodOutput:
        numeric_part, other_part = DataFrameUtils.decompose_into_parts(input_data)

        n_components = self.options['components']
        ...
        data = DataFrameUtils.concatenate_parts([data, numeric_part, other_part])
