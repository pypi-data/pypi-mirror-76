...
class RunHistoryDateType(object):
    STORAGE = 0
...
class RungHistoryDate(object):
    ...
    def __init__(self, timestamp=None, type=None,):
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('RungHistoryDate')
...
all_structs.append(RungHistoryDate)
RungHistoryDate.thrift_spec = (
    None,  # 0
