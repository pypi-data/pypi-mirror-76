...
class Iface(object):
    ...
    def getRunHistoryTagCounts(self, runIds, reportFilter, cmpData, limit, offset, date):
        """
        Parameters:
         - runIds
         - reportFilter
...
class Client(Iface):
    ...
    def getRunHistoryTagCounts(self, runIds, reportFilter, cmpData, limit, offset, date):
        ...
        Parameters:
         ...
         - date
        """
        self.send_getRunHistoryTagCounts(runIds, reportFilter, cmpData, limit, offset, date)
        return self.recv_getRunHistoryTagCounts()

    def send_getRunHistoryTagCounts(self, runIds, reportFilter, cmpData, limit, offset, date):
...
class Processor(Iface, TProcessor):
    ...
    def process_getRunHistoryTagCounts(self, seqid, iprot, oprot):
        ...
        result = getRunHistoryTagCounts_result()
        try:
            result.success = self._handler.getRunHistoryTagCounts(args.runIds, args.reportFilter, args.cmpData, args.limit, args.offset, args.date)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except codechecker_api_shared.ttypes.RequestFailed as requestError:
...
class getRunHistoryTagCounts_args(object):
    ...
    def __init__(self, runIds=None, reportFilter=None, cmpData=None, limit=None, offset=None, date=None,):
        self.runIds = runIds
        self.reportFilter = reportFilter
        self.cmpData = cmpData
        self.limit = limit
...
getRunHistoryTagCounts_args.thrift_spec = (
    ...
    (4, TType.I64, 'limit', None, None, ),  # 4
    (5, TType.I64, 'offset', None, None, ),  # 5
    (6, TType.STRUCT, 'date', [RungHistoryDate, None], None, ),  # 6
)
