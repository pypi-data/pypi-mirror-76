...
class EncodingCircuit(ParameterisedCircuit, ABC):
    ...
    A parametrised quantum circuit for encoding classical data into a quantum state by embedding the
    data in the parameters of gate operations on the circuit qubits using a suitable encoding function
    '''
