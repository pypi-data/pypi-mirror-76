...
import labelme.breeze_resources
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(
        ...
        help = action(self.tr('&About'), self.tutorial, icon='help',
        ...
        darkMode = action(self.tr('&Toggle dark theme'), self.darkModeToggle, icon='edit',
    ...
    def preference(self):
        if platform.system() == 'Darwin':       # macOS
            ...
            os.startfile(os.path.join(os.path.expanduser('~'), 'labelconfig'))
        else:                                   # linux variants
    ...
    def tutorial(self):
        ...
        return QtWidgets.QMessageBox.about(
            self, 'About', '\n<Version 0.4>%s'%(f01 + f02 + f03 + f04 + f05 + f06 + f07 + f08))
    ...
    def darkModeToggle(self):
        ...
        if self.actions.darkMode.isChecked():
            dfile = QtCore.QFile(":/dark.qss")
            dfile.open(QtCore.QFile.ReadOnly | QtCore.QFile.Text)
            stream = QtCore.QTextStream(dfile)
            # Breeze Theme
