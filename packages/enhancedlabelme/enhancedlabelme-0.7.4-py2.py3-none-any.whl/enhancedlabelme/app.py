...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def preference(self):
        if platform.system() == 'Darwin':       # macOS
            subprocess.call(('open', os.path.join(os.path.expanduser('~'), 'labelconfig')))
        elif platform.system() == 'Windows':    # Windows
            subprocess.call(('notepad.exe', os.path.join(os.path.expanduser('~'), 'labelconfig')))
            #tempwindow = 'notepad.exe ' + os.path.join(os.path.expanduser('~'), 'labelconfig')
            #os.startfile(tempwindow)
        else:                                   # linux variants
            subprocess.call(('xdg-open', os.path.join(os.path.expanduser('~'), 'labelconfig')))

    def about(self):
        f01 = '\n- Added time keys to json data'
        ...
        f05 = '\n- Added indication in the Main window title (# of images/# of jsons)'
