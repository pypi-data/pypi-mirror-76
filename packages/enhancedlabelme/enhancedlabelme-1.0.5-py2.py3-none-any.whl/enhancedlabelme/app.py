...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(
        ...
        crossHair = action(self.tr('&Toggle cross hair(+)'), self.crossHairToggle,
                           shortcuts['cross_hair'], 'cross_hair',
        ...
        #self.menus.file.aboutToShow.connect(self.updateDirectoryMenu)
    ...
    def loadRecentDirectory(self,dirpath):
        if self.mayContinue():
    ...
    def loadDir(self, dirpath):
        if not self.mayContinue():
            return
        self.addRecentDirectory(dirpath)
