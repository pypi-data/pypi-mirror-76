...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def preference(self):
        if platform.system() == 'Darwin':       # macOS
            subprocess.call(('open', os.path.join(os.path.expanduser('~'), 'labelme+config')))
        elif platform.system() == 'Windows':    # Windows
            subprocess.call(('notepad.exe', os.path.join(os.path.expanduser('~'), 'labelme+config')))
            #tempwindow = 'notepad.exe ' + os.path.join(os.path.expanduser('~'), 'labelme+config')
            #os.startfile(tempwindow)
        else:                                   # linux variants
            subprocess.call(('xdg-open', os.path.join(os.path.expanduser('~'), 'labelme+config')))
