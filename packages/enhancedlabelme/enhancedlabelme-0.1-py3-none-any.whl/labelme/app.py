...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def tutorial(self):
        f01 = '\n1. Added time keys to json data'
        f02 = '\n2. Removed double click function when creating polygon'
        f03 = '\n3. Dump jsons in utf-8 encoding'
        f04 = '\n4. Automatically check "Save Automatically"'
        return QtWidgets.QMessageBox.about(
            self, 'About', 'Modified by Louis Kim\n<Version 0.2>%s%s%s%s'%(f01, f02, f03, f04))
