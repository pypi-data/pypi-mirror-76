...
class Brand(object):
    ...
    def __init__(self,
        ...
        """
        Create brand details instance

        :param id: Brand ID
        :type id: int
        :param name: Brand name
        :type name: str
        :param image: Brand image
        :type image: str
        :param public_description: Public description
...
class BrandSchema(Schema):
    ...
    public_description = fields.String(required=False, allow_none=True)
...
class PaymentOptionBase(object):
    ...
    """
    def __init__(self, id: int=None, name: str=None, visible_name: str=None,
                 img: str=None, path: str=None, state: int=None, min_amount: int=None,
                 max_amount: int=None, brand: Brand=None):
        """
...
class PaymentSubOptionSchema(Schema):
    ...
    state = fields.Integer(required=True)
    min_amount = fields.Integer(required=False, allow_none=True)
    max_amount = fields.Integer(required=False, allow_none=True)
    #state = fields.Integer(required=False)

    @pre_load
    def postprocess(self, data):
        # Because img and image really is the same... SIGH
        if 'image' in data:
            data['img'] = data['image']
            del data['image']
        return data
...
class PaymentOptionSchema(Schema):
    ...
    brand = fields.Nested(BrandSchema, required=False, allow_none=True)
