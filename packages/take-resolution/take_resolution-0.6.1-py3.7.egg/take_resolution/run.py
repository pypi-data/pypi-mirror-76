...
def run(sql_context: CONTEXT, bot_identity: str, min_date: str, max_date: str) -> tp.Dict[str, tp.Any]:
    ...
    bot_events_identity_column = params['bot_events_identity_column']
    sp_df_events_filtered = filter_rows(sp_df_events_date, (bot_events_identity_column, bot_identity))
    
    bot_events_col_list = params['bot_events_col_list']
    sp_df_events_selected = select_columns(sp_df_events_filtered, bot_events_col_list)
