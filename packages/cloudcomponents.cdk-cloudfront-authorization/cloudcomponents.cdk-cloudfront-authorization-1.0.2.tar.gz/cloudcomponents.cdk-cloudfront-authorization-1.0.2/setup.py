    ...
    """
{
    ...
    "package_data": {
        "cloudcomponents.cdk_cloudfront_authorization._jsii": [
            "cdk-cloudfront-authorization@1.0.2.jsii.tgz"
        ],
        "cloudcomponents.cdk_cloudfront_authorization": [
            "py.typed"
        ]
    ...
    "install_requires": [
        "jsii>=1.10.0, <2.0.0",
        "publication>=0.0.3",
        "aws-cdk.aws-certificatemanager>=1.57.0, <2.0.0",
        "aws-cdk.aws-cloudfront>=1.57.0, <2.0.0",
        "aws-cdk.aws-cloudfront-origins>=1.57.0, <2.0.0",
        "aws-cdk.aws-cognito>=1.57.0, <2.0.0",
        ...
        "cloudcomponents.cdk-deletable-bucket>=1.0.22, <2.0.0",
        "cloudcomponents.cdk-lambda-at-edge-pattern>=1.0.5, <2.0.0"
    ],
    "classifiers": [
