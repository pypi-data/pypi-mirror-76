...
def generate_pair_trading_shifted_correlation(look_backs, correlation_ranges, keep_same_position_periods_list, suffixes_list):
    parameters = []
    for look_back in look_backs:
...
def pair_trading_shifted_correlation_with_cointegration(look_backs, correlation_ranges, keep_same_position_periods_list, risk_list, alpha_list, suffixes_list):
    parameters = []
    for look_back in look_backs:
        for correlation_range in correlation_ranges:
            for suffixes in suffixes_list:
