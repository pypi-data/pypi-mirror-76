...
def fetch_all_necessary_data(public_key = None, private_key= None, start_time= None, end_time= None, save_to_dropbox = False, dropbox_token = None, local_root_directory = './'):
    ...
    try:
        initial_bnb_balance = initial_balances[initial_balances['asset'] == 'BNB']['walletBalance'][0]
    except Exception as e:
        print(e)
    try:
        initial_usdt_balance = initial_balances[initial_balances['asset'] == 'USDT']['walletBalance'][0]
    except Exception as e:
        print(e)

    initial_usd_balance = initial_usdt_balance + initial_bnb_balance * ohlc_bnb_min_binance.iloc[start_time]
    print(initial_usd_balance)
