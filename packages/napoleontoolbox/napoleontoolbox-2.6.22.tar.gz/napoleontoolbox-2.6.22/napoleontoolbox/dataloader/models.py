...
from napoleontoolbox.authentication import PasswordCredentials, ClientCredentials
...
class Service(AbsctractRessource):
    def __init__(self):
        self.__credentials = ClientCredentials()
        self.__id = None
        self.__secret = None
        self.__type = None
        self.__user = None
    ...
    def get_credentials(self):
        return ClientCredentials(self._id, self._secret)
