...
class NaPoleonBinanceFutureBot(object):
    ...
    def get_balance_snapshot(self, request_date):
        ...
        concatenated_df = concatenated_df[concatenated_df['date'] == request_date]

        return concatenated_df


    def get_balance_history(self, start_time, end_time):
