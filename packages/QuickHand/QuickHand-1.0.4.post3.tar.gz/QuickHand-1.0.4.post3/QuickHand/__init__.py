...
from QuickHand.moduels.SystemTray import SystemTray # 引入托盘栏
from QuickHand.moduels.HandRightTab import HandRightTab
from QuickHand.moduels.ConfigTab import ConfigTab
from QuickHand.moduels.HelpTab import HelpTab
