...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'okta', '2.2.0-alpha.1596719554+2c72bdaa'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource okta 2.2.0-alpha.1596719554+2c72bdaa`
                """)
            else:
                raise
