...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'okta', '2.3.0-alpha.1597440424+dbe63158'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource okta 2.3.0-alpha.1597440424+dbe63158`
                """)
            else:
                raise
