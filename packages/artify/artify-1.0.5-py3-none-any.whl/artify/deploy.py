...
def deploy_app_awx():
    headers = {'Content-Type': 'application/json', 'X-Baaskit-Deploy-Token': os.environ.get('DEPLOY_TOKEN')}
    ...
    data = {"commit_ref_name": __main__.os.environ.get('CI_COMMIT_REF_NAME'),
        ...
        "manifest": __main__.manifest_dat,
    ...
    if __main__.debug == 1:
        print("Manifest B64: ", encoded_string.decode(encoding="utf-8"))
