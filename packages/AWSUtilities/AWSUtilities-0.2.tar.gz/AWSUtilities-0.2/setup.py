...
setup(
  ...
  description = 'Basic S3 helper functions used for various projects',   # Give a short description about your library
  ...
  download_url = 'https://github.com/MarkRuse/AWSUtilities/archive/v_02.tar.gz',    # I explain this later on
