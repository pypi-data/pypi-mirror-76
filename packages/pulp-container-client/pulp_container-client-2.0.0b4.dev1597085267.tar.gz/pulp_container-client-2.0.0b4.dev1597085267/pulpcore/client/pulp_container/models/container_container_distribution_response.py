...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, repository=None, content_guard=None, repository_version=None, name=None, base_path=None, pulp_created=None, pulp_href=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
