...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, pulp_created=None, base_path=None, repository=None, repository_version=None, content_guard=None, pulp_href=None, name=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
