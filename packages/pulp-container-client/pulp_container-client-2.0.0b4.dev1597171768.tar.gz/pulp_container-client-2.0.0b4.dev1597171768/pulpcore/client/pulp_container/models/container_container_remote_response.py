...
class ContainerContainerRemoteResponse(object):
    ...
    def __init__(self, pulp_href=None, pulp_created=None, name=None, url=None, ca_cert=None, client_cert=None, client_key=None, tls_validation=None, proxy_url=None, username=None, password=None, pulp_last_updated=None, download_concurrency=None, policy=None, upstream_name=None, whitelist_tags=None, local_vars_configuration=None):  # noqa: E501
    ...
    def whitelist_tags(self):
        """Gets the whitelist_tags of this ContainerContainerRemoteResponse.  # noqa: E501

        A list of whitelisted tags to sync  # noqa: E501

        :return: The whitelist_tags of this ContainerContainerRemoteResponse.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def whitelist_tags(self, whitelist_tags):
        """Sets the whitelist_tags of this ContainerContainerRemoteResponse.

        A list of whitelisted tags to sync  # noqa: E501

        :param whitelist_tags: The whitelist_tags of this ContainerContainerRemoteResponse.  # noqa: E501
        :type: list[str]
        """
