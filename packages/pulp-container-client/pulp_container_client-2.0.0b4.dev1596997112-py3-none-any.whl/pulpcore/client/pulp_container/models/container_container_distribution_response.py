...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, content_guard=None, base_path=None, pulp_created=None, name=None, pulp_href=None, repository=None, repository_version=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
