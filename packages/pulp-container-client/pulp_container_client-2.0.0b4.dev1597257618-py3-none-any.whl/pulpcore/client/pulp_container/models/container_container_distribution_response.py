...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, name=None, pulp_created=None, content_guard=None, repository=None, pulp_href=None, repository_version=None, base_path=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
