...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, name=None, content_guard=None, pulp_href=None, pulp_created=None, repository=None, base_path=None, repository_version=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
