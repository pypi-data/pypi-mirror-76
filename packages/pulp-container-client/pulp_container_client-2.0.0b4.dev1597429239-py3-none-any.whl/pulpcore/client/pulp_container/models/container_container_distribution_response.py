...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, base_path=None, name=None, pulp_href=None, pulp_created=None, content_guard=None, repository_version=None, repository=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
