...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, name=None, repository=None, content_guard=None, base_path=None, pulp_href=None, pulp_created=None, repository_version=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
