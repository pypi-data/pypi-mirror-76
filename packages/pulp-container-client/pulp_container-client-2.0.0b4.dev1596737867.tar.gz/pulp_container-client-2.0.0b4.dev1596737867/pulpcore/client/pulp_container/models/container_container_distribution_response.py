...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, content_guard=None, base_path=None, repository_version=None, pulp_created=None, pulp_href=None, repository=None, name=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
