...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, pulp_href=None, name=None, repository=None, pulp_created=None, repository_version=None, content_guard=None, base_path=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
