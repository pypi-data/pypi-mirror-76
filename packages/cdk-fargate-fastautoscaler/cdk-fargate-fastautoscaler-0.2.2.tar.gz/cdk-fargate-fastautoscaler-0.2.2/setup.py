    ...
    """
{
    ...
    "package_data": {
        "cdk_fargate_fastautoscaler._jsii": [
            "cdk-fargate-fastautoscaler@0.2.2.jsii.tgz"
        ],
        "cdk_fargate_fastautoscaler": [
            "py.typed"
        ]
    ...
    "install_requires": [
        "jsii>=1.10.0, <2.0.0",
        "publication>=0.0.3",
        "aws-cdk.aws-ec2>=1.58.0, <2.0.0",
        "aws-cdk.aws-ecs>=1.58.0, <2.0.0",
        "aws-cdk.aws-elasticloadbalancingv2>=1.58.0, <2.0.0",
        "aws-cdk.aws-iam>=1.58.0, <2.0.0",
        "aws-cdk.aws-lambda>=1.58.0, <2.0.0",
        "aws-cdk.aws-sns>=1.58.0, <2.0.0",
        "aws-cdk.aws-stepfunctions>=1.58.0, <2.0.0",
        "aws-cdk.aws-stepfunctions-tasks>=1.58.0, <2.0.0",
