...
def save(workbooks, folder_or_zipfile=None, *, datasource_map_folder=None, render_topic_documents=False):
    """
    ...
    render_topic_documents : bool, default False
        If True, creates a folder for each Topic Document that includes the embedded content
        such that you can load it in an offline browser. You are required to have pulled the
    ...
    _common.validate_argument_types([
        ...
        (render_topic_documents, 'render_topic_documents', bool)
    ])
    ...
    try:
        ...
        try:
            ...
            for workbook in workbooks:  # type: Workbook
                ...
                workbook.save(workbook_folder, render_topic_documents=render_topic_documents)
