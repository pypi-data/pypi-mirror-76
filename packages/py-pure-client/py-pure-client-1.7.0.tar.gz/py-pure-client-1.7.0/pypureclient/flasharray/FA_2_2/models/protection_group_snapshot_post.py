...
class ProtectionGroupSnapshotPost(object):
    ...
    def __init__(
        ...
        Keyword args:
            ...
            destroyed (bool)
            pod (FixedReference2): The pod in which the protection group of the protection group snapshot resides.
            source (FixedReference2): The original protection group from which this snapshot was taken.
            space (Space2): Returns provisioned (virtual) size and physical storage consumption data for each protection group.
