...
class ConnectionPost(object):
    ...
    def __init__(
        self,
        lun=None,  # type: int
        protocol_endpoint=None,  # type: models.Reference2
    ):
        """
        Keyword args:
