...
class Connection(object):
    ...
    def __init__(
        ...
        Keyword args:
            ...
            volume (FixedReference2): A container that manages the storage space on the array.
        """
        if host is not None:
            self.host = host
