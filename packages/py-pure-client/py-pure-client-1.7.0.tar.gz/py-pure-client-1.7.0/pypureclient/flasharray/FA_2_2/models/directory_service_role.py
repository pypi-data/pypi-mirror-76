...
class DirectoryServiceRole(object):
    ...
    def __init__(
        ...
        role=None,  # type: models.FixedReferenceNoId2
    ):
        """
        Keyword args:
            ...
            role (FixedReferenceNoId2): A reference to the role&#59; can be any role that exists on the system.
        """
