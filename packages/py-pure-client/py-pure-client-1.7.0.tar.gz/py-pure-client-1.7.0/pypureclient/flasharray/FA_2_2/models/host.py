...
class Host(object):
    ...
    def __init__(
        ...
        host_group=None,  # type: models.ReferenceNoId2
        ...
        Keyword args:
            ...
            host_group (ReferenceNoId2): The host group to which the host should be associated.
            ...
            space (Space2): Displays provisioned (virtual) size and physical storage consumption information for the sum of all volumes connected to the specified host.
