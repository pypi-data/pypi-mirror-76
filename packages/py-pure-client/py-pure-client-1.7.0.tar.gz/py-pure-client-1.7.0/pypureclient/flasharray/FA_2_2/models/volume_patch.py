...
class VolumePatch(object):
    ...
    def __init__(
        ...
        qos=None,  # type: models.TmpFA20Qos
        ...
        Keyword args:
            ...
            pod (TmpFA20Reference): Moves the volume into the specified pod.
            provisioned (int): Updates the virtual size of the volume. Measured in bytes.
            qos (TmpFA20Qos): Sets QoS limits.
            volume_group (TmpFA20Reference): Adds the volume to the specified volume group.
