...
class Subnet(object):
    ...
    swagger_types = {
        ...
        'prefix': 'str',
        'vlan': 'int',
        'interfaces': 'list[FixedReferenceNoId2]',
        'services': 'list[str]'
    }
    ...
    def __init__(
        ...
        vlan=None,  # type: int
        interfaces=None,  # type: List[models.FixedReferenceNoId2]
        ...
        Keyword args:
            ...
            interfaces (list[FixedReferenceNoId2]): List of network interfaces associated with this subnet.
