...
class Volume(object):
    ...
    swagger_types = {
        ...
        'space': 'Space',
        'time_remaining': 'int',
        'pod': 'TmpFA20Reference',
        'source': 'TmpFA20FixedReference',
        'subtype': 'str',
        'volume_group': 'TmpFA20Reference',
    ...
    def __init__(
        ...
        pod=None,  # type: models.TmpFA20Reference
        source=None,  # type: models.TmpFA20FixedReference
        subtype=None,  # type: str
        volume_group=None,  # type: models.TmpFA20Reference
        ...
        Keyword args:
            ...
            pod (TmpFA20Reference): A reference to the pod.
            source (TmpFA20FixedReference): A reference to the originating volume as a result of a volume copy.
            subtype (str): The type of volume. Valid values are `protocol_endpoint` and `regular`.
            volume_group (TmpFA20Reference): A reference to the volume group.
