...
class VolumeSnapshot(object):
    ...
    swagger_types = {
        ...
        'pod': 'FixedReference2',
        'provisioned': 'int',
        'source': 'FixedReference2',
        'suffix': 'str',
        'time_remaining': 'int',
        'serial': 'str',
        'space': 'Space2',
        'volume_group': 'FixedReference2'
    }
    ...
    def __init__(
        ...
        pod=None,  # type: models.FixedReference2
        provisioned=None,  # type: int
        source=None,  # type: models.FixedReference2
        suffix=None,  # type: str
        time_remaining=None,  # type: int
        serial=None,  # type: str
        space=None,  # type: models.Space2
        volume_group=None,  # type: models.FixedReference2
    ):
        """
        Keyword args:
            ...
            pod (FixedReference2): A reference to the pod.
            provisioned (int): The provisioned space of the snapshot. Measured in bytes.
            source (FixedReference2): The volume from which this snapshot was taken.
            ...
            space (Space2): Displays size and space consumption information.
            volume_group (FixedReference2): The volume group to which the volume that is the source of this volume snapshot belongs.
        """
        if id is not None:
            self.id = id
        if name is not None:
