/*---------------------------------------------------------------------------*\
** $Author: antanas $
** $Date: 2015-11-03 18:13:49 +0200 (An, 03 lapkr. 2015) $ 
** $Revision: 4180 $
** $URL: svn+ssh://www.crystallography.net/home/coder/svn-repositories/cod-tools/tags/v3.0.1/src/externals/cexceptions/allocx.c $
\*---------------------------------------------------------------------------*/
