...
from azureml.automl.core.shared._diagnostics.automl_error_definitions import InvalidArgumentWithSupportedValues, \
    InvalidArgumentType, SnapshotLimitExceeded
...
class AzureAutoMLClient:
    ...
    def _fit_remote_core(self, run_configuration, X=None, y=None, sample_weight=None, X_valid=None, y_valid=None,
        ...
        try:
            snapshotId = self._take_snapshot()
            Contract.assert_non_empty(snapshotId, "snapshotId", reference_code="_fit_remote_core", log_safe=True)
