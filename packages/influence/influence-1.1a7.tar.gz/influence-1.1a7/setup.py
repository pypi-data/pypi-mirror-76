...
setup(
  ...
  version = '1.1a7',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/RandomKiddo/influence/archive/v1.1a7.tar.gz',    # I explain this later on
