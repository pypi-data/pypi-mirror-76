...
class V1beta1TaskRunStatusFields(object):
    ...
    def __init__(self, cloud_events=None, completion_time=None, pod_name=None, resources_result=None, retries_status=None, sidecars=None, start_time=None, steps=None, task_results=None, task_spec=None):  # noqa: E501
        """V1beta1TaskRunStatusFields - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1beta1TaskRunStatusFields, dict):
