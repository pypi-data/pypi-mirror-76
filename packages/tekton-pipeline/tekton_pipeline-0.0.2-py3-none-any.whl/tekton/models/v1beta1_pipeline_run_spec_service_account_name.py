...
class V1beta1PipelineRunSpecServiceAccountName(object):
    ...
    def __init__(self, service_account_name=None, task_name=None):  # noqa: E501
        """V1beta1PipelineRunSpecServiceAccountName - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1beta1PipelineRunSpecServiceAccountName, dict):
