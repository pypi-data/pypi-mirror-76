...
class V1beta1Pipeline(object):
    ...
    def __init__(self, api_version=None, kind=None, metadata=None, spec=None):  # noqa: E501
        """V1beta1Pipeline - a model defined in Swagger"""  # noqa: E501
    ...
    def spec(self):
        ...
        Spec holds the desired state of the Pipeline from the client  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1beta1Pipeline, dict):
