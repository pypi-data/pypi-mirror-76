...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.16.0-alpha.1597355266+8250f3f0'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.16.0-alpha.1597355266+8250f3f0`
                """)
            else:
                raise
