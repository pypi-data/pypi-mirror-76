...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.16.0-alpha.1597253827+e790a73a'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.16.0-alpha.1597253827+e790a73a`
                """)
            else:
                raise
