...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.17.0-alpha.1597438399+cada6f56'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.17.0-alpha.1597438399+cada6f56`
                """)
            else:
                raise
