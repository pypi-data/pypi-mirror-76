...
from itachi.commands.subcommand import Subcommand
from itachi.common import Params, Registrable, Lazy
from itachi.common.checks import ConfigurationError
from itachi.common.logging import prepare_global_logging
from itachi.common import util as common_util
from itachi.data import DatasetReader, Vocabulary
from itachi.models.archival import archive_model, CONFIG_NAME
from itachi.models.model import Model
from itachi.training.trainer import Trainer
from itachi.training import util as training_util
...
class TrainModel(Registrable):
    ...
    of all of the allowed top-level keys in a configuration file used with `itachi train`.
    """
