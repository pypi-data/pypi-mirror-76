...
from itachi.common.lazy import Lazy
from itachi.common.params import Params
...
def is_base_registrable(cls) -> bool:
    ...
    a class.
    """
    from itachi.common.registrable import Registrable  # import here to avoid circular imports
...
def pop_and_construct_arg(
    ...
    """
    from itachi.models.archival import load_archive  # import here to avoid circular imports
