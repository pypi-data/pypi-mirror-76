...
"""
# Make sure that itachi is running on Python 3.6.1 or later
# (to avoid running into this bug: https://bugs.python.org/issue29246)
import sys

if sys.version_info < (3, 6, 1):
    raise RuntimeError("Itachi requires Python 3.6.1 or later")
...
try:
    ...
    print(
        "Using Itachi requires the python packages, "
        "tensorflow and Numpy to be installed."
    )
    raise

from itachi.version import VERSION as __version__  # noqa