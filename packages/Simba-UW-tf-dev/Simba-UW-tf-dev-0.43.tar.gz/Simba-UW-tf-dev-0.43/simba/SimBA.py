...
from simba.SimBA_dash_app import *
...
class video_info_table:
    def __init__(self,configini):
        ...
        for i in self.filesFound:
            self.data_lists[1].append(os.path.join(str(self.config_videofolders, str(i))))
...
class loadprojectini:
    def __init__(self,configini):
        ...
        button_open_plotly_interface = Button(plotlyInterface, text='Open SimBA / Plotly dataset', command = self.open_plotly_interface,fg='black')
