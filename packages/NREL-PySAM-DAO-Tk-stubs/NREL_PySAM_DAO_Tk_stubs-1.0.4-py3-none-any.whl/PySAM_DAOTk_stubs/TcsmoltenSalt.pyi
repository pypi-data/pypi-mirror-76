...
class Outputs(object):
	...
	T_rec_out_end = tuple
	T_rec_out_max = tuple
	T_tank_cold_final = float
	T_tank_hot_final = float
	T_tes_cold = tuple
	T_tes_hot = tuple
	...
	flux_maps_out = tuple
	gen = tuple
	hot_tank_htf_percent_final = float
	htf_pump_power = tuple
	is_field_tracking_final = float
	...
	pc_op_mode_final = float
	pc_startup_energy_remain_final = float
	pc_startup_time_remain_final = float
	pparasi = tuple
	pricing_mult = tuple
	q_balance = tuple
	q_ch_tes = tuple
	...
	rec_op_mode_final = float
	rec_startup_energy_remain_final = float
	rec_startup_time_remain_final = float
	rh = tuple
