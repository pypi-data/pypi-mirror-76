...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'newrelic', '3.3.0-alpha.1597438283+b321c7c9'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource newrelic 3.3.0-alpha.1597438283+b321c7c9`
                """)
            else:
                raise
