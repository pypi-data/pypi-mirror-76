...
def get_timeslots(
    ...
    for _,row in df.iterrows():
        ...
        for eid in range(_num_emails):
            ...
            timeslot_data.append((row[cid_column], eid, best_date.strftime('%Y-%m-%d'), best_date.weekday(), best_tod))
    ...
    df_out = pd.DataFrame(timeslot_data, columns=[cid_column, 'Email_ID', 'Date', 'Day_Of_Week', 'Time_Of_Day'])
