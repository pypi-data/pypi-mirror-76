...
class ROIExtractionTab(Tab):
    ...
    def __init__(self, main_widget):
        ...
        self.off_button = QRadioButton(text="Off")
    ...
    def delete_roi(self, roi_num):
        ...
        if (self.main_widget.checkThreadRunning()):
            roi_num = roi_num - 1
            try:
                self.main_widget.console.updateText("Deleting ROI #%d"%roi_num+1)
    ...
    def modify_roi(self, roi_num, add_subtract="add", override=False):
        ...
        if (self.main_widget.checkThreadRunning()):
            ...
            if add_subtract == "add":
                ...
                num= number_connected_components(self.data_handler.shape[0]*self.data_handler.shape[1], [0]+self.data_handler.shape,temp_roi)
                if num== 2 or override:
                    ...
                    msg.setText("The pixels you selected are not connect to ROI #%d, Are you sure you want to add them?"%roi_num+1)
                    # msg.setInformativeText("This is additional information")
                    # msg.setWindowTitle("MessageBox demo")
                    # msg.setDetailedText("The details are as follows:")
                    msg.setStandardButtons(QMessageBox.Ok | QMessageBox.Cancel)
            ...
            if add_subtract=="subtract":
                self.main_widget.console.updateText("Subtracting Selection from ROI #" + str(roi_num + 1))
