...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azuredevops', '1.1.0-alpha.1597440515+a02ea1b1'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azuredevops 1.1.0-alpha.1597440515+a02ea1b1`
                """)
            else:
                raise
