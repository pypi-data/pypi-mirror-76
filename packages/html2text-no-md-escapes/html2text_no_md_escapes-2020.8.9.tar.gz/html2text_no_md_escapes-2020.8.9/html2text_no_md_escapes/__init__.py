...
from html2text_no_md_escapes.compat import urlparse, HTMLParser
from html2text_no_md_escapes import config

from html2text_no_md_escapes.utils import (
    name2cp,
    unifiable_n,
...
if __name__ == "__main__":
    from html2text_no_md_escapes.cli import main
