...
class ExtendedBooleanTest(unittest.TestCase):
    ...
    def test_txt_search_known_response(self):
        ...
        some_expected_results = [Result("./tests/static/files/d1.txt", 0.443),
                                 Result("./tests/static/files/d3.txt", 0.154),
                                 Result("./tests/static/files/d15.txt", 0.257),
                                 Result("./tests/static/files/d11.txt", 0.153)]
    ...
    def test_pdf_search_known_response(self):
        ...
        some_expected_results = [Result("./tests/static/pdf-files/d1.pdf", 0.443),
                                 Result("./tests/static/pdf-files/d3.pdf", 0.154),
                                 Result("./tests/static/pdf-files/d15.pdf", 0.257),
                                 Result("./tests/static/pdf-files/d11.pdf", 0.153)]
        for expected in some_expected_results:
            self.assertTrue(expected in response)
