...
from election_loader import __version__


REPO_URL = "https://github.com/The-Politico/politico-civic-election-loader/"
...
setup(
    ...
    license="MIT",
    description=(
        "Ingest election metadata and results from outside sources, "
        "the POLITICO way."
    ),
