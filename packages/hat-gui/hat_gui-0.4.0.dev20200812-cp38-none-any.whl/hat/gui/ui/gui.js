...
/* harmony import */ var _hat_core_util__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(10);
/* harmony import */ var _hat_core_juggler__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(11);
...
/* harmony import */ var _hat_core_util__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(10);
...
function vhFromArray(node) {
    if (!node)
        return [];
    if (_hat_core_util__WEBPACK_IMPORTED_MODULE_5__["isString"](node))
        return node;
    if (!_hat_core_util__WEBPACK_IMPORTED_MODULE_5__["isArray"](node))
        throw 'Invalid node structure';
    if (node.length < 1)
        return [];
    if (typeof node[0] != 'string')
        return node.map(vhFromArray);
    const hasData = node.length > 1 && _hat_core_util__WEBPACK_IMPORTED_MODULE_5__["isObject"](node[1]);
    const children = _hat_core_util__WEBPACK_IMPORTED_MODULE_5__["pipe"](
        _hat_core_util__WEBPACK_IMPORTED_MODULE_5__["map"](vhFromArray),
        _hat_core_util__WEBPACK_IMPORTED_MODULE_5__["flatten"],
        Array.from
...
class Renderer extends EventTarget {
    ...
    init(el, initState, vtCb, maxFps) {
        ...
        this._vtCb = vtCb;
        this._maxFps = _hat_core_util__WEBPACK_IMPORTED_MODULE_5__["isNumber"](maxFps) ? maxFps : 30;
     ...
     */
    get(...paths) {
        return _hat_core_util__WEBPACK_IMPORTED_MODULE_5__["get"](paths, this._state);
    }
    ...
    _change() {
        ...
        while (this._changes.length > 0) {
            ...
            const view = _hat_core_util__WEBPACK_IMPORTED_MODULE_5__["get"](path);
            const oldState = this._state;
            this._state = _hat_core_util__WEBPACK_IMPORTED_MODULE_5__["change"](path, cb, this._state);
            if (this._state && _hat_core_util__WEBPACK_IMPORTED_MODULE_5__["equals"](view(oldState),
                                        view(this._state)))
                continue;
            change = true;
...
/* harmony import */ var jiff__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(12);
...
/* harmony import */ var _hat_core_util__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(10);
/* harmony import */ var _hat_core_future__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(26);
...
var inverse = __webpack_require__(25);
var jsonPointer = __webpack_require__(17);
...
// Errors
exports.InvalidPatchOperationError = __webpack_require__(23);
exports.TestFailedError = __webpack_require__(22);
exports.PatchNotInvertibleError = __webpack_require__(24);
...
var patches = __webpack_require__(16);
var clone = __webpack_require__(19);
var InvalidPatchOperationError = __webpack_require__(23);
...
var jsonPointer = __webpack_require__(17);
var clone = __webpack_require__(19);
var deepEquals = __webpack_require__(20);
var commutePaths = __webpack_require__(21);

var array = __webpack_require__(14);

var TestFailedError = __webpack_require__(22);
var InvalidPatchOperationError = __webpack_require__(23);
var PatchNotInvertibleError = __webpack_require__(24);
