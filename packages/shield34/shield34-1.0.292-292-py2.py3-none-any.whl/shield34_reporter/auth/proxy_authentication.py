...
def get_authenticator(scheme):
    ...
    if scheme is not None and scheme.startswith('Kerberos'):
        return import_utils.import_module('kerberos_proxy_authentication', __name__, ['gssapi'])
    return None
