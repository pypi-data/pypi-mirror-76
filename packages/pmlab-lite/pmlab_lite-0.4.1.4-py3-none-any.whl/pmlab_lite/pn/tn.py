...
class TraceNet(AbstractPetriNet):
	...
	def __add_place(self, place_name: int, capacity: int=1):
		"""
	...
	def __add_transition(self, name: str, transition_id: int=None):
		"""
	...
	def __remove_place(self, place_name):
		pass

	def __remove_transition(self, place_name):
		pass
