...
def BarrellAndSears(l, T=288.15, p=101325, RH=0):
	'''
	...
	T = K2C(T)
	P = hPA2mmHg(p/100)
	R = (0.378125 + 0.0021414 / l**2 + 0.00001793 / l**4) * (P*(1 + (1.049 - 0.0157*T) * P * 1e-6)/(1 + 0.003661*T)) - (0.0624 - 0.000680 / l**2) * RH / (1 + 0.003661*T)
	n = R/1e6 + 1
	return n
