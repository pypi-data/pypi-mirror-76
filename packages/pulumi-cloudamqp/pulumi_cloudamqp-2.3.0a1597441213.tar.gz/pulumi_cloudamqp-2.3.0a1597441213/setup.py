...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'cloudamqp', '2.3.0-alpha.1597441213+b968c6e9'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource cloudamqp 2.3.0-alpha.1597441213+b968c6e9`
                """)
            else:
                raise
