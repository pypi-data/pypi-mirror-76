...
class PipelineApi(object):
    ...
    def get_training_pipeline_by_id_internal(self, pipeline_id, project_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_training_pipeline_by_id_internal(pipeline_id, project_id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_training_pipeline_by_id_internal_with_http_info(pipeline_id, project_id, **kwargs)  # noqa: E501

    def get_training_pipeline_by_id_internal_with_http_info(self, pipeline_id, project_id, **kwargs):  # noqa: E501
        """get_training_pipeline_by_id_internal  # noqa: E501

        Get a specific training pipeline with model id even if model is deleted  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_training_pipeline_by_id_internal_with_http_info(pipeline_id, project_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('project_id' not in local_var_params or
                local_var_params['project_id'] is None):
            raise ApiValueError("Missing the required parameter `project_id` when calling `get_training_pipeline_by_id_internal`")  # noqa: E501
