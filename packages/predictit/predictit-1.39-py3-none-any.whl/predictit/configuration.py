...
class config():
    ...
    # and return results as best result, all results, string div with plot and more. 'models_error_criterion' returns MAPE, RMSE or DWT(based on config) criterion of all models in array.
