...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', '2.4.0-alpha.1597438170+8903bea0'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault 2.4.0-alpha.1597438170+8903bea0`
                """)
            else:
                raise
