...
"""
    ...
    The version of the OpenAPI document: 2020.08.10
...
class Token(object):
    ...
    def sub_email(self, sub_email):
        ...
        if (self.local_vars_configuration.client_side_validation and
                sub_email is not None and len(sub_email) < 1):
            raise ValueError("Invalid value for `sub_email`, length must be greater than or equal to `1`")  # noqa: E501
