...
[boto3.ServerlessApplicationRepository 1.14.41](https://boto3.amazonaws.com/v1/documentation/api/1.14.41/reference/services/serverlessrepo.html#ServerlessApplicationRepository) service
