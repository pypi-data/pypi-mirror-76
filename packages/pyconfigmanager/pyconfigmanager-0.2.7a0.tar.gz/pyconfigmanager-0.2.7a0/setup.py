...
long_description = """For package details, installation and usage, See documentation at `Github
...
setup(
  ...
  download_url = 'https://github.com/HassanAzam/pyconfigmanager/archive/v0.2.7-alpha.tar.gz',
