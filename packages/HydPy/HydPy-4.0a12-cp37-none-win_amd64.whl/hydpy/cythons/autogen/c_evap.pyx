...
cdef class Model:
    ...
    cpdef inline void update_outlets(self) nogil:
        self.pass_referenceevapotranspiration_v1()
    ...
    cpdef inline void calc_referenceevapotranspiration(self)  nogil:
        self.sequences.fluxes.referenceevapotranspiration = (            (.408*self.sequences.fluxes.saturationvapourpressureslope *             (self.sequences.fluxes.netradiation-self.sequences.fluxes.soilheatflux) +             self.sequences.fluxes.psychrometricconstant*(37.5/60./60.*self.parameters.derived.seconds) /             (self.sequences.inputs.airtemperature+273.)*self.sequences.fluxes.adjustedwindspeed *             (self.sequences.fluxes.saturationvapourpressure-self.sequences.fluxes.actualvapourpressure)) /            (self.sequences.fluxes.saturationvapourpressureslope +             self.sequences.fluxes.psychrometricconstant*(1.+.34*self.sequences.fluxes.adjustedwindspeed))        )
    cpdef inline void pass_referenceevapotranspiration_v1(self)  nogil:
        self.sequences.outlets.e[0] = self.sequences.outlets.e[0] + (self.sequences.fluxes.referenceevapotranspiration)
    cpdef inline void pass_referenceevapotranspiration(self)  nogil:
        self.sequences.outlets.e[0] = self.sequences.outlets.e[0] + (self.sequences.fluxes.referenceevapotranspiration)
