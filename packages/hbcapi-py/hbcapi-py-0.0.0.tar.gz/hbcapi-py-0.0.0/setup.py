...
setup(
  name = 'hbcapi-py',         # How you named your package folder (MyLib)
  packages = ['hbcapi-py'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/hydrogen-studio/hbcapi-py/archive/0.0.0.tar.gz',    # I explain this later on
