...
class connect_api_impl_FulfillmentApiImpl(connect_Base):
    ...
    def updateRequest(self,id,request):
        return connect_api_ConnectHelper.put(connect_api_impl_FulfillmentApiImpl.REQUESTS_PATH,id,None,request)
...
class connect_api_impl_GeneralApiImpl(connect_Base):
    ...
    def listProductParameters(self,id,filters):
        return connect_api_ConnectHelper.get(connect_api_impl_GeneralApiImpl.PRODUCTS_PATH,id,"parameters",filters)

    def getProductParameter(self,id,paramId):
        return connect_api_ConnectHelper.get(connect_api_impl_GeneralApiImpl.PRODUCTS_PATH,id,("parameters/" + ("null" if paramId is None else paramId)))

    def createProductParameter(self,id,data):
        return connect_api_ConnectHelper.post(connect_api_impl_GeneralApiImpl.PRODUCTS_PATH,id,"parameters",data)

    def updateProductParameter(self,id,paramId,data):
        return connect_api_ConnectHelper.put(connect_api_impl_GeneralApiImpl.PRODUCTS_PATH,id,("parameters/" + ("null" if paramId is None else paramId)),data)

    def deleteProductParameter(self,id,paramId):
        connect_api_ConnectHelper.delete(connect_api_impl_GeneralApiImpl.PRODUCTS_PATH,id,("parameters/" + ("null" if paramId is None else paramId)))
    ...
    def updateProductMedia(self,id,mediaId,media):
        return connect_api_ConnectHelper.put(connect_api_impl_GeneralApiImpl.PRODUCTS_PATH,((("" + ("null" if id is None else id)) + "/media/") + ("null" if mediaId is None else mediaId)),None,media)
...
class connect_api_impl_MarketplaceApiImpl:
    ...
    def updateAgreement(self,id,body):
        return connect_api_ConnectHelper.put(connect_api_impl_MarketplaceApiImpl.AGREEMENTS_PATH,id,None,body)
    ...
    def putListing(self,id,body):
        return connect_api_ConnectHelper.put(connect_api_impl_MarketplaceApiImpl.LISTINGS_PATH,id,None,body)
    ...
    def updateMarketplace(self,id,body):
        return connect_api_ConnectHelper.put(connect_api_impl_MarketplaceApiImpl.MARKETPLACES_PATH,id,None,body)
...
class connect_api_impl_TierApiImpl(connect_Base):
    ...
    def updateTierConfigRequest(self,id,tcr):
        return connect_api_ConnectHelper.put(connect_api_impl_TierApiImpl.TCR_PATH,id,None,tcr)
...
class connect_api_impl_UsageApiImpl(connect_Base):
    ...
    def updateUsageFile(self,id,body):
        return connect_api_ConnectHelper.put(connect_api_impl_UsageApiImpl.USAGE_FILES_PATH,id,None,body)
    ...
    def updateUsageRecord(self,id,record):
        return connect_api_ConnectHelper.put(connect_api_impl_UsageApiImpl.USAGE_RECORDS_PATH,id,None,record)
...
class connect_models_Param(connect_models_IdModel):
    ...
    def isCheckboxChecked(self):
        if ((self.type == "checkbox") and ((self.structuredValue is not None))):
            return self.structuredValue.getBool("true")
        else:
            return False
