...
snake_case_functions = ('morphological_watershed_image_filter', 'morphological_watershed_from_markers_image_filter', 'isolated_watershed_image_filter', 'watershed_image_filter', )
