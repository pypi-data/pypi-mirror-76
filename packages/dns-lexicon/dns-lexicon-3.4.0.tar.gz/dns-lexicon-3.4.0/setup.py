...
extras_require = \
{'full': ['pynamecheap>=0.0.3,<0.0.4',
          'boto3>=1.14.28,<2.0.0',
          'transip>=2.1.2,<3.0.0',
          'xmltodict>=0.12.0,<0.13.0',
          'localzone>=0.9.6,<0.10.0',
          'softlayer>=5.8.9,<6.0.0',
          'zeep>=3.4.0,<4.0.0'],
 'gransy': ['zeep>=3.4.0,<4.0.0'],
 'localzone': ['localzone>=0.9.6,<0.10.0'],
 'namecheap': ['pynamecheap>=0.0.3,<0.0.4'],
 'plesk': ['xmltodict>=0.12.0,<0.13.0'],
 'route53': ['boto3>=1.14.28,<2.0.0'],
 'softlayer': ['softlayer>=5.8.9,<6.0.0'],
 'transip': ['transip>=2.1.2,<3.0.0']}
