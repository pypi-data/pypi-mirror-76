...
if __name__ == '__main__':
    ...
    batch_size = 4
    n_classes = 34
    input_axis_minimum_size = 300
    fixed_feature = False
    pretrained = False
    num_epochs = 30
    check_point_stride = 60
    ...
    model.to(device)
    logger.load_model(model, 'epoch_16')
    #Optimizers
    ...
    # Get result
    predict(model, r'C:\Dropbox\Dropbox\python\pytorch\docs\exam_result\input5.png',
              r'C:\Dropbox\Dropbox\python\pytorch\docs\exam_result\output5.png')
