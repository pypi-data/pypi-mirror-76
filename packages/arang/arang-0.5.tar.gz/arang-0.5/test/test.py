...
# --- 
pp.sequencialIntruder(rawPacket, to=0x110, option='upper', hexed=True, verbose=False, showContent=False, resultSaveWithFile='result.txt')
pp.sequencialIntruder(rawPacket, to=0, option='lower', verbose=True)
