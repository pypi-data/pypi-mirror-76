...
class TestPSenseParser(unittest.TestCase):
    ...
    def test_load_chinstruments(self):
        ...
        self.assertEqual(df["vout1"].iloc[0], 0.1)
        self.assertEqual(df["vout1"].iloc[-1], 0.1)
        self.assertEqual(df["vout2"].iloc[0], 0.1)
        self.assertEqual(df["vout2"].iloc[-1], 0.1)
        self.assertEqual(df["vout3"].iloc[0], 0.1)
        self.assertEqual(df["vout3"].iloc[-1], 0.1)
        self.assertEqual(df["vout4"].iloc[0], 0.1)
        self.assertEqual(df["vout4"].iloc[-1], 0.1)
