...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'digitalocean', '2.7.0-alpha.1597438224+ebb459b8'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource digitalocean 2.7.0-alpha.1597438224+ebb459b8`
                """)
            else:
                raise
