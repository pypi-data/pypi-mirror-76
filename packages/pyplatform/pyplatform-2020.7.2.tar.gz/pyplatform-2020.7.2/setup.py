...
setup(name='pyplatform',
      version='2020.7.2',
      description='Pyplatform provides wrapper functions for using Google BigQuery as datawarehouse and creating data pipelines involving Google Cloud, Microsoft Azure, O365, and Tableau Server as source and destination.',
