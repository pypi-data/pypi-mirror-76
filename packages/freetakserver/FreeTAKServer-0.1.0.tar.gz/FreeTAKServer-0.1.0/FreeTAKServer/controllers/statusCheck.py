...
class statusCheck:
    def __init__(self):
        ...
        self.recip = ['natha.paquette@gmail.com']

        self.sender = 'natha.paquette@gmail.com'
        ...
        self.smtp_acct = "natha.paquette@gmail.com"

        # Password to send email
        self.smtp_password = "ixabvxggerggbfrd"

        self.smtp_trace_level = 0  # 1 is useful trace

        # List of self.servers to monitor
        self.servers = [
            ["server", "192.168.2.74", 15777]
        ]
