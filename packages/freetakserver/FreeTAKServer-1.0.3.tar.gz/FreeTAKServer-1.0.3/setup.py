...
setup(
  ...
  packages = ['FreeTAKServer', 'FreeTAKServer.controllers', 'FreeTAKServer.controllers.configuration', 'FreeTAKServer.controllers.model', 'FreeTAKServer.controllers.logs', 'FreeTAKServer.views'],   # Chose the same as "name"
  ...
  url = 'https://github.com/FreeTAKTeam/FreeTakServer',   # Provide either the link to your github or to your website
