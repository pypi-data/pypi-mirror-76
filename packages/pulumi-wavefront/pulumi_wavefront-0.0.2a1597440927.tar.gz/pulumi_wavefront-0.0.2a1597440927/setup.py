...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'wavefront', '0.0.2-alpha.1597440927+1381a261'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource wavefront 0.0.2-alpha.1597440927+1381a261`
                """)
            else:
                raise
