...
BioSAK plot_sam_depth -r references.fasta -d 12D9.depth -i 2.10_chromosome -s 2280287 -e 2280691 -k 1 -l 2280487,2280491
...
if __name__ == '__main__':
    ...
    optional.add_argument('-l', dest='Lines', nargs='?', required=False, type=str, default=None, help='position to mark')
