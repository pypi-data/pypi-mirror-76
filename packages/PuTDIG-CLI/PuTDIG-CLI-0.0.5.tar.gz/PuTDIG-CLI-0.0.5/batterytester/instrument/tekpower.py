...
from batterytester.instrument.load import Load, LoadMode, LoadCapability, LoadChannelCapability
from batterytester.instrument.types import Instrument, InstrumentType
...
class TekPower3410A(Instrument):
    ...
    @classmethod
    def channel_capabilities(cls) -> Iterable[LoadChannelCapability]:
        """
