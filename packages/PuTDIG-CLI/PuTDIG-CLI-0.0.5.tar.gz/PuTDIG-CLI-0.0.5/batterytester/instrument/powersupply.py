...
from typing import Protocol, NamedTuple, Iterable, Optional
...
"""Classify the features of the power supply that apply to all channels."""
...
"""Classify the features of the power supply that apply to individual channels."""
