...
This version of django-openid-auth supports Django 2.2 or later.  If
you need to work with an earlier version of Django or Python, you can
fallback to the 0.15 release available on PyPI.
 ...
 1. Configure your project to use the pickle based session serializer:

        SESSION_SERIALIZER = 'django.contrib.sessions.serializers.PickleSerializer'

    For more context on why this is necessary see:
...
that server implements OpenID 2.0 identifier select mode, add the
