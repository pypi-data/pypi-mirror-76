...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', '2.14.0-alpha.1597437335+fedaa0cc'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud 2.14.0-alpha.1597437335+fedaa0cc`
                """)
            else:
                raise
